...
// Package parser implements the functionality of parsing and serializing an GLES Shading Language programs.
package parser

import (
	"android.googlesource.com/platform/tools/gpu/gfxapi/gles/glsl/ast"
	"android.googlesource.com/platform/tools/gpu/gfxapi/gles/glsl/builtins"
