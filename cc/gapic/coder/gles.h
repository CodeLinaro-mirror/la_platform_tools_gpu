...
namespace gles {
    ...
    public:
        ...
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x20, 0x36, 0xe8, 0x9e, 0x83, 0x21, 0x43, 0x3f, 0x1b, 0xe5, 0x95, 0x61, 0x8f, 0x7b, 0x78, 0xfb, 0xe4, 0xaf, 0x1b, 0xb3,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
    ...
    public:
        ...
        TextureUnit(std::unordered_map<uint32_t,uint32_t>* Bindings) :
            mBindings(Bindings) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x73, 0x66, 0xa1, 0x3d, 0x11, 0xac, 0xeb, 0x55, 0x9e, 0xde, 0xc3, 0xf9, 0xbd, 0x4b, 0xcd, 0x8e, 0xce, 0x3a, 0xbf, 0xca,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            GAPID_FATAL("C++ map encoding not supported");
    ...
    public:
        ...
        CubemapLevel(std::unordered_map<uint32_t,Image>* Faces) :
            mFaces(Faces) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x66, 0x39, 0xb7, 0xf2, 0x39, 0xca, 0x0f, 0x2a, 0xee, 0x6d, 0x29, 0x03, 0xcf, 0x01, 0x3e, 0x52, 0xcc, 0x22, 0x9c, 0x2e,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            GAPID_FATAL("C++ map encoding not supported");
    ...
    public:
        ...
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x4e, 0x13, 0x01, 0xcc, 0x2a, 0x81, 0x9c, 0x17, 0x07, 0x00, 0x63, 0xd3, 0x2f, 0x58, 0x18, 0xa2, 0x29, 0x5b, 0xcf, 0xa9,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Uint32(this->mID);
    ...
    public:
        ...
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x6b, 0x89, 0xd3, 0x8d, 0x97, 0xff, 0x20, 0xe5, 0x36, 0xcd, 0x68, 0x0d, 0x91, 0xc1, 0x16, 0x13, 0xd6, 0xd9, 0x3b, 0xf4,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            GAPID_FATAL("C++ map encoding not supported");
    ...
    public:
        ...
        Program(std::unordered_map<uint32_t,uint32_t>* Shaders, bool Linked, U8__S Binary, std::unordered_map<char*,uint32_t>* AttributeBindings, std::unordered_map<int32_t,VertexAttribute>* Attributes, std::unordered_map<int32_t,Uniform>* Uniforms, GLchar__S InfoLog) :
            ...
            mInfoLog(InfoLog) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x09, 0xe3, 0xa7, 0x7c, 0xb7, 0x90, 0x6d, 0xee, 0x3c, 0x65, 0x7f, 0xfa, 0xd9, 0x0f, 0x35, 0xc5, 0x6d, 0x43, 0xfe, 0xbc,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            GAPID_FATAL("C++ map encoding not supported");
    ...
    public:
        ...
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xb1, 0x63, 0x3c, 0x0e, 0xbc, 0xac, 0xa2, 0xea, 0x96, 0xc7, 0x2f, 0x9f, 0x9a, 0xa7, 0xee, 0x5a, 0xd1, 0x75, 0x0b, 0x72,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            GAPID_FATAL("C++ map encoding not supported");
    ...
    public:
        ...
        Objects(std::unordered_map<uint32_t,Renderbuffer*>* Renderbuffers, std::unordered_map<uint32_t,Texture*>* Textures, std::unordered_map<uint32_t,Framebuffer*>* Framebuffers, std::unordered_map<uint32_t,Buffer*>* Buffers, std::unordered_map<uint32_t,Shader*>* Shaders, std::unordered_map<uint32_t,Program*>* Programs, std::unordered_map<uint32_t,VertexArray*>* VertexArrays, std::unordered_map<uint32_t,Query*>* Queries) :
            ...
            mQueries(Queries) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x57, 0x9f, 0x65, 0xa7, 0x8d, 0x7c, 0x78, 0x63, 0xdd, 0xd7, 0x9b, 0xa3, 0x75, 0xad, 0x4d, 0xfc, 0x27, 0x08, 0xd7, 0x0e,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            GAPID_FATAL("C++ map encoding not supported");
    ...
    public:
        ...
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xcb, 0x70, 0xb0, 0xf1, 0x3f, 0x99, 0xa1, 0xa6, 0x07, 0x13, 0xe8, 0x8b, 0x6d, 0xc2, 0x33, 0xfe, 0xee, 0x0d, 0xda, 0xe6,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
    ...
    public:
        ...
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x77, 0xde, 0x5c, 0x9c, 0x26, 0xed, 0xc2, 0x12, 0xd2, 0x1e, 0xc1, 0xb0, 0xa2, 0xbe, 0x19, 0x50, 0x18, 0x62, 0x10, 0x67,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
