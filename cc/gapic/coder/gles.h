...
namespace gles {
    ...
    public:
        ...
        VertexAttributeArray(bool Enabled, int32_t Size, uint32_t Type, uint8_t Normalized, int32_t Stride, VertexPointer Pointer, uint32_t RelativeOffset, bool Integer, uint32_t Binding) :
            ...
            mBinding(Binding) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x95, 0x50, 0x82, 0x76, 0xa1, 0xed, 0x1f, 0xd6, 0x4e, 0x3d, 0xd9, 0x77, 0x05, 0x09, 0x04, 0x6b, 0x31, 0xef, 0x18, 0x8f,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
    ...
    public:
        ...
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xd0, 0x07, 0xb9, 0x1f, 0x5a, 0x29, 0xb7, 0x39, 0x2e, 0x09, 0x4d, 0xc3, 0x67, 0x6f, 0x91, 0x86, 0xae, 0x24, 0xfc, 0x8b,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            GAPID_FATAL("C++ map encoding not supported");
    ...
    public:
        ...
        GlBindBufferBase(atom::Observations observations, uint32_t Target, uint32_t Index, uint32_t Buffer) :
            ...
            mBuffer(Buffer) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x84, 0xfb, 0x90, 0xd0, 0x60, 0x3f, 0xb7, 0x64, 0x51, 0x70, 0x64, 0x7a, 0xc4, 0xaf, 0xb5, 0xaf, 0x10, 0x0c, 0xfc, 0xa9,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        GlBindBufferRange(atom::Observations observations, uint32_t Target, uint32_t Index, uint32_t Buffer, int32_t Offset, int32_t Size) :
            ...
            mSize(Size) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x1b, 0xf9, 0xe5, 0xe7, 0x12, 0x25, 0xeb, 0x3d, 0xa0, 0xfe, 0xc3, 0xd3, 0xa6, 0x50, 0x91, 0x9f, 0xab, 0x7d, 0x9a, 0x93,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        GlBindFragDataLocationEXT(atom::Observations observations, uint32_t Program, uint32_t Color, char* Name) :
            ...
            mName(Name) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xdc, 0x27, 0x13, 0xb5, 0x37, 0x29, 0xd0, 0xfa, 0xd3, 0x8b, 0x3a, 0xf1, 0x10, 0x94, 0xce, 0xa7, 0xfc, 0x0d, 0x93, 0xfd,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        GlBindFragDataLocationIndexedEXT(atom::Observations observations, uint32_t Program, uint32_t ColorNumber, uint32_t Index, char* Name) :
            ...
            mName(Name) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x3d, 0xfb, 0x8c, 0x8f, 0xfa, 0x97, 0xf9, 0xdf, 0x2a, 0x46, 0x65, 0xd9, 0xeb, 0x16, 0x39, 0x3e, 0xd1, 0x22, 0x8d, 0x98,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        GlBindVertexBuffer(atom::Observations observations, uint32_t BindingIndex, uint32_t Buffer, int32_t Offset, int32_t Stride) :
            ...
            mStride(Stride) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xb2, 0xfe, 0x81, 0xa9, 0x20, 0x7a, 0xde, 0x08, 0xa4, 0xc3, 0xe8, 0x70, 0x2a, 0xf7, 0x09, 0x32, 0xb6, 0xbc, 0x3b, 0xdb,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        GlGetActiveUniform(atom::Observations observations, uint32_t Program, uint32_t Index, int32_t BufferSize, GLsizei__P BufferBytesWritten, GLint__P VectorCount, GLenum__P Type, GLchar__P Name) :
            ...
            mName(Name) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x37, 0x75, 0x45, 0x28, 0x7c, 0xe5, 0xee, 0xda, 0x6c, 0x85, 0x9f, 0xa5, 0x31, 0xc4, 0xfc, 0x49, 0x44, 0xa4, 0x28, 0x4a,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        UniformIndex__CP(memory::Pointer Pointer) :
            mPointer(Pointer) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xf7, 0x36, 0x32, 0x86, 0xf9, 0x23, 0xfb, 0x85, 0xbb, 0x99, 0x7e, 0x98, 0xf0, 0x27, 0x0c, 0x4d, 0xa2, 0x4a, 0xff, 0x0d,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mPointer);
    ...
    public:
        ...
        GlGetActiveUniformsiv(atom::Observations observations, uint32_t Program, int32_t UniformCount, UniformIndex__CP UniformIndices, uint32_t ParameterName, GLint__P Parameters) :
            ...
            mParameters(Parameters) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x70, 0x70, 0xf3, 0xe3, 0x75, 0x48, 0x7e, 0x35, 0x9a, 0xab, 0x13, 0xc7, 0xc5, 0x1c, 0x02, 0xbe, 0x93, 0x0f, 0x39, 0xd4,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        GlGetFragDataIndexEXT(atom::Observations observations, uint32_t Program, char* Name, int32_t Result) :
            ...
            mResult(Result) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xac, 0x92, 0x79, 0xcf, 0x60, 0x5d, 0x8e, 0x33, 0x4c, 0x32, 0xd0, 0x58, 0x1b, 0x62, 0x74, 0x07, 0x6e, 0x26, 0xd4, 0x8c,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        GlGetProgramResourceLocationIndexEXT(atom::Observations observations, uint32_t Program, uint32_t ProgramInterface, char* Name, int32_t Result) :
            ...
            mResult(Result) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0x4d, 0x13, 0x07, 0x51, 0x41, 0xca, 0x6e, 0x73, 0x7c, 0x0f, 0xc4, 0x9f, 0x72, 0x88, 0x6d, 0x99, 0x79, 0xac, 0x1a, 0x6c,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        UniformIndex__P(memory::Pointer Pointer) :
            mPointer(Pointer) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xee, 0xec, 0xab, 0x66, 0xf5, 0x5b, 0x0a, 0x2b, 0x4d, 0x0b, 0x3f, 0x5c, 0xf0, 0x77, 0x3a, 0x28, 0x05, 0x0e, 0xec, 0x8b,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mPointer);
    ...
    public:
        ...
        GlGetUniformIndices(atom::Observations observations, uint32_t Program, int32_t UniformCount, GLchar__CP__CP UniformNames, UniformIndex__P UniformIndices) :
            ...
            mUniformIndices(UniformIndices) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xe9, 0xaf, 0x9e, 0x0a, 0xe8, 0x93, 0xa6, 0xe8, 0x49, 0xf4, 0xbd, 0x78, 0x1b, 0xfe, 0xc5, 0x63, 0xf4, 0x26, 0x97, 0x87,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        GlVertexAttribBinding(atom::Observations observations, uint32_t Index, uint32_t BindingIndex) :
            ...
            mBindingIndex(BindingIndex) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xb9, 0x0e, 0xde, 0x5d, 0x0f, 0x07, 0x7e, 0x9d, 0x0a, 0x90, 0x58, 0xc1, 0x7b, 0xff, 0xd0, 0x11, 0xa3, 0xd4, 0x6c, 0xfd,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        GlVertexBindingDivisor(atom::Observations observations, uint32_t BindingIndex, uint32_t Divisor) :
            ...
            mDivisor(Divisor) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xc5, 0x9c, 0xe9, 0x71, 0x73, 0x27, 0x15, 0x31, 0xa4, 0xd8, 0x09, 0x4b, 0x40, 0x1d, 0xd8, 0x7e, 0x9d, 0x9b, 0xd0, 0xa9,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mobservations);
    ...
    public:
        ...
        UniformIndex__S(SliceInfo SliceInfo) :
            mSliceInfo(SliceInfo) {}
        virtual const gapic::Id& Id() const {
            static gapic::Id ID{ { 0xb4, 0x96, 0xaf, 0x44, 0xc6, 0x7a, 0x70, 0x6c, 0x16, 0x18, 0x66, 0x62, 0x04, 0xc9, 0x8a, 0x4a, 0x72, 0xa2, 0xe7, 0x81,  } };
            return ID;
        }
        virtual void Encode(Encoder* e) const {
            e->Value(this->mSliceInfo);
