...
static const uint16_t WglSwapBuffers = 7;
static const uint16_t GlEnableClientState = 8;
static const uint16_t GlDisableClientState = 9;
static const uint16_t GlGetProgramBinaryOES = 10;
static const uint16_t GlProgramBinaryOES = 11;
static const uint16_t GlStartTilingQCOM = 12;
static const uint16_t GlEndTilingQCOM = 13;
static const uint16_t GlDiscardFramebufferEXT = 14;
static const uint16_t GlInsertEventMarkerEXT = 15;
static const uint16_t GlPushGroupMarkerEXT = 16;
static const uint16_t GlPopGroupMarkerEXT = 17;
static const uint16_t GlTexStorage1DEXT = 18;
static const uint16_t GlTexStorage2DEXT = 19;
static const uint16_t GlTexStorage3DEXT = 20;
static const uint16_t GlTextureStorage1DEXT = 21;
static const uint16_t GlTextureStorage2DEXT = 22;
static const uint16_t GlTextureStorage3DEXT = 23;
static const uint16_t GlGenVertexArraysOES = 24;
static const uint16_t GlBindVertexArrayOES = 25;
static const uint16_t GlDeleteVertexArraysOES = 26;
static const uint16_t GlIsVertexArrayOES = 27;
static const uint16_t GlEGLImageTargetTexture2DOES = 28;
static const uint16_t GlEGLImageTargetRenderbufferStorageOES = 29;
static const uint16_t GlGetGraphicsResetStatusEXT = 30;
static const uint16_t GlBindAttribLocation = 31;
static const uint16_t GlBlendFunc = 32;
static const uint16_t GlBlendFuncSeparate = 33;
static const uint16_t GlBlendEquation = 34;
static const uint16_t GlBlendEquationSeparate = 35;
static const uint16_t GlBlendColor = 36;
static const uint16_t GlEnableVertexAttribArray = 37;
static const uint16_t GlDisableVertexAttribArray = 38;
static const uint16_t GlVertexAttribPointer = 39;
static const uint16_t GlGetActiveAttrib = 40;
static const uint16_t GlGetActiveUniform = 41;
static const uint16_t GlGetError = 42;
static const uint16_t GlGetProgramiv = 43;
static const uint16_t GlGetShaderiv = 44;
static const uint16_t GlGetUniformLocation = 45;
static const uint16_t GlGetAttribLocation = 46;
static const uint16_t GlPixelStorei = 47;
static const uint16_t GlTexParameteri = 48;
static const uint16_t GlTexParameterf = 49;
static const uint16_t GlGetTexParameteriv = 50;
static const uint16_t GlGetTexParameterfv = 51;
static const uint16_t GlUniform1i = 52;
static const uint16_t GlUniform2i = 53;
static const uint16_t GlUniform3i = 54;
static const uint16_t GlUniform4i = 55;
static const uint16_t GlUniform1iv = 56;
static const uint16_t GlUniform2iv = 57;
static const uint16_t GlUniform3iv = 58;
static const uint16_t GlUniform4iv = 59;
static const uint16_t GlUniform1f = 60;
static const uint16_t GlUniform2f = 61;
static const uint16_t GlUniform3f = 62;
static const uint16_t GlUniform4f = 63;
static const uint16_t GlUniform1fv = 64;
static const uint16_t GlUniform2fv = 65;
static const uint16_t GlUniform3fv = 66;
static const uint16_t GlUniform4fv = 67;
static const uint16_t GlUniformMatrix2fv = 68;
static const uint16_t GlUniformMatrix3fv = 69;
static const uint16_t GlUniformMatrix4fv = 70;
static const uint16_t GlGetUniformfv = 71;
static const uint16_t GlGetUniformiv = 72;
static const uint16_t GlVertexAttrib1f = 73;
static const uint16_t GlVertexAttrib2f = 74;
static const uint16_t GlVertexAttrib3f = 75;
static const uint16_t GlVertexAttrib4f = 76;
static const uint16_t GlVertexAttrib1fv = 77;
static const uint16_t GlVertexAttrib2fv = 78;
static const uint16_t GlVertexAttrib3fv = 79;
static const uint16_t GlVertexAttrib4fv = 80;
static const uint16_t GlGetShaderPrecisionFormat = 81;
static const uint16_t GlDepthMask = 82;
static const uint16_t GlDepthFunc = 83;
static const uint16_t GlDepthRangef = 84;
static const uint16_t GlColorMask = 85;
static const uint16_t GlStencilMask = 86;
static const uint16_t GlStencilMaskSeparate = 87;
static const uint16_t GlStencilFuncSeparate = 88;
static const uint16_t GlStencilOpSeparate = 89;
static const uint16_t GlFrontFace = 90;
static const uint16_t GlViewport = 91;
static const uint16_t GlScissor = 92;
static const uint16_t GlActiveTexture = 93;
static const uint16_t GlGenTextures = 94;
static const uint16_t GlDeleteTextures = 95;
static const uint16_t GlIsTexture = 96;
static const uint16_t GlBindTexture = 97;
static const uint16_t GlTexImage2D = 98;
static const uint16_t GlTexSubImage2D = 99;
static const uint16_t GlCopyTexImage2D = 100;
static const uint16_t GlCopyTexSubImage2D = 101;
static const uint16_t GlCompressedTexImage2D = 102;
static const uint16_t GlCompressedTexSubImage2D = 103;
static const uint16_t GlGenerateMipmap = 104;
static const uint16_t GlReadPixels = 105;
static const uint16_t GlGenFramebuffers = 106;
static const uint16_t GlBindFramebuffer = 107;
static const uint16_t GlCheckFramebufferStatus = 108;
static const uint16_t GlDeleteFramebuffers = 109;
static const uint16_t GlIsFramebuffer = 110;
static const uint16_t GlGenRenderbuffers = 111;
static const uint16_t GlBindRenderbuffer = 112;
static const uint16_t GlRenderbufferStorage = 113;
static const uint16_t GlDeleteRenderbuffers = 114;
static const uint16_t GlIsRenderbuffer = 115;
static const uint16_t GlGetRenderbufferParameteriv = 116;
static const uint16_t GlGenBuffers = 117;
static const uint16_t GlBindBuffer = 118;
static const uint16_t GlBufferData = 119;
static const uint16_t GlBufferSubData = 120;
static const uint16_t GlDeleteBuffers = 121;
static const uint16_t GlIsBuffer = 122;
static const uint16_t GlGetBufferParameteriv = 123;
static const uint16_t GlCreateShader = 124;
static const uint16_t GlDeleteShader = 125;
static const uint16_t GlShaderSource = 126;
static const uint16_t GlShaderBinary = 127;
static const uint16_t GlGetShaderInfoLog = 128;
static const uint16_t GlGetShaderSource = 129;
static const uint16_t GlReleaseShaderCompiler = 130;
static const uint16_t GlCompileShader = 131;
static const uint16_t GlIsShader = 132;
static const uint16_t GlCreateProgram = 133;
static const uint16_t GlDeleteProgram = 134;
static const uint16_t GlAttachShader = 135;
static const uint16_t GlDetachShader = 136;
static const uint16_t GlGetAttachedShaders = 137;
static const uint16_t GlLinkProgram = 138;
static const uint16_t GlGetProgramInfoLog = 139;
static const uint16_t GlUseProgram = 140;
static const uint16_t GlIsProgram = 141;
static const uint16_t GlValidateProgram = 142;
static const uint16_t GlClearColor = 143;
static const uint16_t GlClearDepthf = 144;
static const uint16_t GlClearStencil = 145;
static const uint16_t GlClear = 146;
static const uint16_t GlCullFace = 147;
static const uint16_t GlPolygonOffset = 148;
static const uint16_t GlLineWidth = 149;
static const uint16_t GlSampleCoverage = 150;
static const uint16_t GlHint = 151;
static const uint16_t GlFramebufferRenderbuffer = 152;
static const uint16_t GlFramebufferTexture2D = 153;
static const uint16_t GlGetFramebufferAttachmentParameteriv = 154;
static const uint16_t GlDrawElements = 155;
static const uint16_t GlDrawArrays = 156;
static const uint16_t GlFlush = 157;
static const uint16_t GlFinish = 158;
static const uint16_t GlGetBooleanv = 159;
static const uint16_t GlGetFloatv = 160;
static const uint16_t GlGetIntegerv = 161;
static const uint16_t GlGetString = 162;
static const uint16_t GlEnable = 163;
static const uint16_t GlDisable = 164;
static const uint16_t GlIsEnabled = 165;
static const uint16_t GlMapBufferRange = 166;
static const uint16_t GlUnmapBuffer = 167;
static const uint16_t GlInvalidateFramebuffer = 168;
static const uint16_t GlRenderbufferStorageMultisample = 169;
static const uint16_t GlBlitFramebuffer = 170;
static const uint16_t GlGenQueries = 171;
static const uint16_t GlBeginQuery = 172;
static const uint16_t GlEndQuery = 173;
static const uint16_t GlDeleteQueries = 174;
static const uint16_t GlIsQuery = 175;
static const uint16_t GlGetQueryiv = 176;
static const uint16_t GlGetQueryObjectuiv = 177;
static const uint16_t GlGenQueriesEXT = 178;
static const uint16_t GlBeginQueryEXT = 179;
static const uint16_t GlEndQueryEXT = 180;
static const uint16_t GlDeleteQueriesEXT = 181;
static const uint16_t GlIsQueryEXT = 182;
static const uint16_t GlQueryCounterEXT = 183;
static const uint16_t GlGetQueryivEXT = 184;
static const uint16_t GlGetQueryObjectivEXT = 185;
static const uint16_t GlGetQueryObjectuivEXT = 186;
static const uint16_t GlGetQueryObjecti64vEXT = 187;
static const uint16_t GlGetQueryObjectui64vEXT = 188;
...
typedef void(STDCALL *PFNGLGETACTIVEUNIFORM)(ProgramId program, int32_t location,
                                             int32_t buffer_size, int32_t *buffer_bytes_written,
                                             int32_t *size, ShaderUniformType *type,
                                             const char *name);
...
typedef const char *(STDCALL *PFNGLGETSTRING)(StringConstant param);
