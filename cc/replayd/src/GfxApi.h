...
static const uint16_t DriverGetPropertyUint = 3;
static const uint16_t DriverGetPropertyString = 4;
static const uint16_t FlushPostBuffer = 5;
static const uint16_t EglCreateContext = 6;
static const uint16_t EglMakeCurrent = 7;
static const uint16_t EglSwapBuffers = 8;
static const uint16_t GlEnableClientState = 9;
static const uint16_t GlDisableClientState = 10;
static const uint16_t GlGetProgramBinaryOES = 11;
static const uint16_t GlProgramBinaryOES = 12;
static const uint16_t GlStartTilingQCOM = 13;
static const uint16_t GlEndTilingQCOM = 14;
static const uint16_t GlDiscardFramebufferEXT = 15;
static const uint16_t GlInsertEventMarkerEXT = 16;
static const uint16_t GlPushGroupMarkerEXT = 17;
static const uint16_t GlPopGroupMarkerEXT = 18;
static const uint16_t GlTexStorage1DEXT = 19;
static const uint16_t GlTexStorage2DEXT = 20;
static const uint16_t GlTexStorage3DEXT = 21;
static const uint16_t GlTextureStorage1DEXT = 22;
static const uint16_t GlTextureStorage2DEXT = 23;
static const uint16_t GlTextureStorage3DEXT = 24;
static const uint16_t GlGenVertexArraysOES = 25;
static const uint16_t GlBindVertexArrayOES = 26;
static const uint16_t GlDeleteVertexArraysOES = 27;
static const uint16_t GlIsVertexArrayOES = 28;
static const uint16_t GlEGLImageTargetTexture2DOES = 29;
static const uint16_t GlEGLImageTargetRenderbufferStorageOES = 30;
static const uint16_t GlGetGraphicsResetStatusEXT = 31;
static const uint16_t GlBindAttribLocation = 32;
static const uint16_t GlBlendFunc = 33;
static const uint16_t GlBlendFuncSeparate = 34;
static const uint16_t GlBlendEquation = 35;
static const uint16_t GlBlendEquationSeparate = 36;
static const uint16_t GlBlendColor = 37;
static const uint16_t GlEnableVertexAttribArray = 38;
static const uint16_t GlDisableVertexAttribArray = 39;
static const uint16_t GlVertexAttribPointer = 40;
static const uint16_t GlGetActiveAttrib = 41;
static const uint16_t GlGetActiveUniform = 42;
static const uint16_t GlGetError = 43;
static const uint16_t GlGetProgramiv = 44;
static const uint16_t GlGetShaderiv = 45;
static const uint16_t GlGetUniformLocation = 46;
static const uint16_t GlGetAttribLocation = 47;
static const uint16_t GlPixelStorei = 48;
static const uint16_t GlTexParameteri = 49;
static const uint16_t GlTexParameterf = 50;
static const uint16_t GlGetTexParameteriv = 51;
static const uint16_t GlGetTexParameterfv = 52;
static const uint16_t GlUniform1i = 53;
static const uint16_t GlUniform2i = 54;
static const uint16_t GlUniform3i = 55;
static const uint16_t GlUniform4i = 56;
static const uint16_t GlUniform1iv = 57;
static const uint16_t GlUniform2iv = 58;
static const uint16_t GlUniform3iv = 59;
static const uint16_t GlUniform4iv = 60;
static const uint16_t GlUniform1f = 61;
static const uint16_t GlUniform2f = 62;
static const uint16_t GlUniform3f = 63;
static const uint16_t GlUniform4f = 64;
static const uint16_t GlUniform1fv = 65;
static const uint16_t GlUniform2fv = 66;
static const uint16_t GlUniform3fv = 67;
static const uint16_t GlUniform4fv = 68;
static const uint16_t GlUniformMatrix2fv = 69;
static const uint16_t GlUniformMatrix3fv = 70;
static const uint16_t GlUniformMatrix4fv = 71;
static const uint16_t GlGetUniformfv = 72;
static const uint16_t GlGetUniformiv = 73;
static const uint16_t GlVertexAttrib1f = 74;
static const uint16_t GlVertexAttrib2f = 75;
static const uint16_t GlVertexAttrib3f = 76;
static const uint16_t GlVertexAttrib4f = 77;
static const uint16_t GlVertexAttrib1fv = 78;
static const uint16_t GlVertexAttrib2fv = 79;
static const uint16_t GlVertexAttrib3fv = 80;
static const uint16_t GlVertexAttrib4fv = 81;
static const uint16_t GlGetShaderPrecisionFormat = 82;
static const uint16_t GlDepthMask = 83;
static const uint16_t GlDepthFunc = 84;
static const uint16_t GlDepthRangef = 85;
static const uint16_t GlColorMask = 86;
static const uint16_t GlStencilMask = 87;
static const uint16_t GlStencilMaskSeparate = 88;
static const uint16_t GlStencilFuncSeparate = 89;
static const uint16_t GlStencilOpSeparate = 90;
static const uint16_t GlFrontFace = 91;
static const uint16_t GlViewport = 92;
static const uint16_t GlScissor = 93;
static const uint16_t GlActiveTexture = 94;
static const uint16_t GlGenTextures = 95;
static const uint16_t GlDeleteTextures = 96;
static const uint16_t GlIsTexture = 97;
static const uint16_t GlBindTexture = 98;
static const uint16_t GlTexImage2D = 99;
static const uint16_t GlTexSubImage2D = 100;
static const uint16_t GlCopyTexImage2D = 101;
static const uint16_t GlCopyTexSubImage2D = 102;
static const uint16_t GlCompressedTexImage2D = 103;
static const uint16_t GlCompressedTexSubImage2D = 104;
static const uint16_t GlGenerateMipmap = 105;
static const uint16_t GlReadPixels = 106;
static const uint16_t GlGenFramebuffers = 107;
static const uint16_t GlBindFramebuffer = 108;
static const uint16_t GlCheckFramebufferStatus = 109;
static const uint16_t GlDeleteFramebuffers = 110;
static const uint16_t GlIsFramebuffer = 111;
static const uint16_t GlGenRenderbuffers = 112;
static const uint16_t GlBindRenderbuffer = 113;
static const uint16_t GlRenderbufferStorage = 114;
static const uint16_t GlDeleteRenderbuffers = 115;
static const uint16_t GlIsRenderbuffer = 116;
static const uint16_t GlGetRenderbufferParameteriv = 117;
static const uint16_t GlGenBuffers = 118;
static const uint16_t GlBindBuffer = 119;
static const uint16_t GlBufferData = 120;
static const uint16_t GlBufferSubData = 121;
static const uint16_t GlDeleteBuffers = 122;
static const uint16_t GlIsBuffer = 123;
static const uint16_t GlGetBufferParameteriv = 124;
static const uint16_t GlCreateShader = 125;
static const uint16_t GlDeleteShader = 126;
static const uint16_t GlShaderSource = 127;
static const uint16_t GlShaderBinary = 128;
static const uint16_t GlGetShaderInfoLog = 129;
static const uint16_t GlGetShaderSource = 130;
static const uint16_t GlReleaseShaderCompiler = 131;
static const uint16_t GlCompileShader = 132;
static const uint16_t GlIsShader = 133;
static const uint16_t GlCreateProgram = 134;
static const uint16_t GlDeleteProgram = 135;
static const uint16_t GlAttachShader = 136;
static const uint16_t GlDetachShader = 137;
static const uint16_t GlGetAttachedShaders = 138;
static const uint16_t GlLinkProgram = 139;
static const uint16_t GlGetProgramInfoLog = 140;
static const uint16_t GlUseProgram = 141;
static const uint16_t GlIsProgram = 142;
static const uint16_t GlValidateProgram = 143;
static const uint16_t GlClearColor = 144;
static const uint16_t GlClearDepthf = 145;
static const uint16_t GlClearStencil = 146;
static const uint16_t GlClear = 147;
static const uint16_t GlCullFace = 148;
static const uint16_t GlPolygonOffset = 149;
static const uint16_t GlLineWidth = 150;
static const uint16_t GlSampleCoverage = 151;
static const uint16_t GlHint = 152;
static const uint16_t GlFramebufferRenderbuffer = 153;
static const uint16_t GlFramebufferTexture2D = 154;
static const uint16_t GlGetFramebufferAttachmentParameteriv = 155;
static const uint16_t GlDrawElements = 156;
static const uint16_t GlDrawArrays = 157;
static const uint16_t GlFlush = 158;
static const uint16_t GlFinish = 159;
static const uint16_t GlGetBooleanv = 160;
static const uint16_t GlGetFloatv = 161;
static const uint16_t GlGetIntegerv = 162;
static const uint16_t GlGetString = 163;
static const uint16_t GlEnable = 164;
static const uint16_t GlDisable = 165;
static const uint16_t GlIsEnabled = 166;
static const uint16_t GlMapBufferRange = 167;
static const uint16_t GlUnmapBuffer = 168;
...
};  // end of namespace DriverPropertyUint
