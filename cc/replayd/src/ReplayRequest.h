...
#ifndef ANDROID_CAZE_REPLAY_REQUETS_H
#define ANDROID_CAZE_REPLAY_REQUETS_H
...
public:
    ...
    static std::unique_ptr<ReplayRequest> create(const GazerConnection& gazer,
...
#endif  // ANDROID_CAZE_REPLAY_REQUETS_H
