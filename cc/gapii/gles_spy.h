...
public:
    ...
    inline void* eglCreateContext(void* display, void* config, void* share_context, int* attrib_list);
    ...
    inline void* glXCreateNewContext(void* display, void* fbconfig, uint32_t type, void* shared, bool direct);
    ...
    inline void glGetProgramBinaryOES(uint32_t program, int32_t buffer_size, int32_t* bytes_written, uint32_t* binary_format, void* binary);
    inline void glProgramBinaryOES(uint32_t program, uint32_t binary_format, void* binary, int32_t binary_size);
    ...
    inline void glTextureStorage1DEXT(uint32_t texture, uint32_t target, int32_t levels, uint32_t format, int32_t width);
    inline void glTextureStorage2DEXT(uint32_t texture, uint32_t target, int32_t levels, uint32_t format, int32_t width, int32_t height);
    inline void glTextureStorage3DEXT(uint32_t texture, uint32_t target, int32_t levels, uint32_t format, int32_t width, int32_t height, int32_t depth);
    ...
    inline void glVertexAttribPointer(int32_t location, int32_t size, uint32_t type, bool normalized, int32_t stride, void* data);
    inline void glGetActiveAttrib(uint32_t program, int32_t location, int32_t buffer_size, int32_t* buffer_bytes_written, int32_t* vector_count, uint32_t* type, char* name);
    inline void glGetActiveUniform(uint32_t program, int32_t location, int32_t buffer_size, int32_t* buffer_bytes_written, int32_t* vector_count, uint32_t* type, char* name);
    ...
    inline void glUniform4i(int32_t location, int32_t value0, int32_t value1, int32_t value2, int32_t value3);
    ...
    inline void glUniform4f(int32_t location, float value0, float value1, float value2, float value3);
    ...
    inline void glVertexAttrib4f(int32_t location, float value0, float value1, float value2, float value3);
    ...
    inline void glTexImage2D(uint32_t target, int32_t level, uint32_t internal_format, int32_t width, int32_t height, int32_t border, uint32_t format, uint32_t type, void* data);
    inline void glTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, uint32_t type, void* data);
    ...
    inline void glCompressedTexImage2D(uint32_t target, int32_t level, uint32_t format, int32_t width, int32_t height, int32_t border, int32_t image_size, void* data);
    inline void glCompressedTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, int32_t image_size, void* data);
    ...
    inline void glShaderBinary(int32_t count, uint32_t* shaders, uint32_t binary_format, void* binary, int32_t binary_size);
    inline void glGetShaderInfoLog(uint32_t shader, int32_t buffer_length, int32_t* string_length_written, char* info);
    inline void glGetShaderSource(uint32_t shader, int32_t buffer_length, int32_t* string_length_written, char* source);
    ...
    inline void glGetAttachedShaders(uint32_t program, int32_t buffer_length, int32_t* shaders_length_written, uint32_t* shaders);
    inline void glLinkProgram(uint32_t program);
    inline void glGetProgramInfoLog(uint32_t program, int32_t buffer_length, int32_t* string_length_written, char* info);
    ...
    inline void glFramebufferRenderbuffer(uint32_t framebuffer_target, uint32_t framebuffer_attachment, uint32_t renderbuffer_target, uint32_t renderbuffer);
    inline void glFramebufferTexture2D(uint32_t framebuffer_target, uint32_t framebuffer_attachment, uint32_t texture_target, uint32_t texture, int32_t level);
    ...
    inline void glDrawElements(uint32_t draw_mode, int32_t element_count, uint32_t indices_type, void* indices);
    ...
    inline void glGetActiveUniformBlockName(uint32_t program, uint32_t uniform_block_index, int32_t buffer_size, int32_t* buffer_bytes_written, char* name);
    inline void glGetActiveUniformBlockiv(uint32_t program, uint32_t uniform_block_index, uint32_t parameter_name, int32_t* parameters);
    inline void glUniformBlockBinding(uint32_t program, uint32_t uniform_block_index, uint32_t uniform_block_binding);
    inline void glGetActiveUniformsiv(uint32_t program, uint32_t uniform_count, uint32_t* uniform_indices, uint32_t parameter_name, int32_t* parameters);
    ...
    inline void architecture(uint32_t pointer_alignment, uint32_t pointer_size, uint32_t integer_size, bool little_endian);
    inline void replayCreateRenderer(uint32_t id);
    inline void replayBindRenderer(uint32_t id);
    inline void backbufferInfo(int32_t width, int32_t height, uint32_t color_fmt, uint32_t depth_fmt, uint32_t stencil_fmt, bool resetViewportScissor);
...
inline int GlesSpy::eglInitialize(void* dpy, int* major, int* minor) {
    ...
    gapic::coder::gles::EglInitialize coder(observations , gapic::coder::gles::EGLDisplay(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(dpy), 0)), gapic::coder::gles::EGLint__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(major), 0)), gapic::coder::gles::EGLint__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(minor), 0)), result);
    mEncoder->Object(&coder);

    return result;
}

inline void* GlesSpy::eglCreateContext(void* display, void* config, void* share_context, int* attrib_list) {
    ...
    do {
        ...
        l_ctx->mInstances.mRenderbuffers[(RenderbufferId)(0)] = std::shared_ptr<Renderbuffer>((new Renderbuffer()));
        ...
        l_ctx->mInstances.mRenderbuffers[l_color_id] = std::shared_ptr<Renderbuffer>((new Renderbuffer()));
        l_ctx->mInstances.mRenderbuffers[l_depth_id] = std::shared_ptr<Renderbuffer>((new Renderbuffer()));
        l_ctx->mInstances.mRenderbuffers[l_stencil_id] = std::shared_ptr<Renderbuffer>((new Renderbuffer()));
        std::shared_ptr<Framebuffer> l_backbuffer = std::shared_ptr<Framebuffer>((new Framebuffer()));
        l_backbuffer->mAttachments[FramebufferAttachment::GL_COLOR_ATTACHMENT0] = FramebufferAttachmentInfo().SetObject((uint32_t)(l_color_id)).SetType(FramebufferAttachmentType::GL_RENDERBUFFER).SetCubeMapFace(CubeMapImageTarget::GL_TEXTURE_CUBE_MAP_POSITIVE_X);
        l_backbuffer->mAttachments[FramebufferAttachment::GL_DEPTH_ATTACHMENT] = FramebufferAttachmentInfo().SetObject((uint32_t)(l_depth_id)).SetType(FramebufferAttachmentType::GL_RENDERBUFFER).SetCubeMapFace(CubeMapImageTarget::GL_TEXTURE_CUBE_MAP_POSITIVE_X);
        l_backbuffer->mAttachments[FramebufferAttachment::GL_STENCIL_ATTACHMENT] = FramebufferAttachmentInfo().SetObject((uint32_t)(l_stencil_id)).SetType(FramebufferAttachmentType::GL_RENDERBUFFER).SetCubeMapFace(CubeMapImageTarget::GL_TEXTURE_CUBE_MAP_POSITIVE_X);
        ...
        for (int32_t l_i = 0; l_i < 64; ++l_i) {
            l_ctx->mVertexAttributeArrays[(AttributeLocation)(l_i)] = std::shared_ptr<VertexAttributeArray>((new VertexAttributeArray()));
        }
    ...
    gapic::coder::gles::EglCreateContext coder(observations , gapic::coder::gles::EGLDisplay(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(display), 0)), gapic::coder::gles::EGLConfig(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(config), 0)), gapic::coder::gles::EGLContext(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(share_context), 0)), gapic::coder::gles::EGLint__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(attrib_list), 0)), gapic::coder::gles::EGLContext(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(result), 0)));
    mEncoder->Object(&coder);
...
inline int GlesSpy::eglMakeCurrent(void* display, void* draw, void* read, void* context) {
    ...
    gapic::coder::gles::EglMakeCurrent coder(observations , gapic::coder::gles::EGLDisplay(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(display), 0)), gapic::coder::gles::EGLSurface(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(draw), 0)), gapic::coder::gles::EGLSurface(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(read), 0)), gapic::coder::gles::EGLContext(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(context), 0)), result);
    mEncoder->Object(&coder);
...
inline int GlesSpy::eglSwapBuffers(void* display, void* surface) {
    ...
    gapic::coder::gles::EglSwapBuffers coder(observations , gapic::coder::gles::EGLDisplay(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(display), 0)), gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(surface), 0)), result);
    mEncoder->Object(&coder);
...
inline int GlesSpy::eglQuerySurface(void* display, void* surface, int attribute, int* value) {
    ...
    gapic::coder::gles::EglQuerySurface coder(observations , gapic::coder::gles::EGLDisplay(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(display), 0)), gapic::coder::gles::EGLSurface(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(surface), 0)), attribute, gapic::coder::gles::EGLint__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)), result);
    mEncoder->Object(&coder);
...
inline void* GlesSpy::glXCreateContext(void* dpy, void* vis, void* shareList, bool direct) {
    ...
    gapic::coder::gles::GlXCreateContext coder(observations , gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(dpy), 0)), gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(vis), 0)), gapic::coder::gles::GLXContext(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(shareList), 0)), direct, gapic::coder::gles::GLXContext(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(result), 0)));
    mEncoder->Object(&coder);

    return result;
}

inline void* GlesSpy::glXCreateNewContext(void* display, void* fbconfig, uint32_t type, void* shared, bool direct) {
    ...
    gapic::coder::gles::GlXCreateNewContext coder(observations , gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(display), 0)), gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(fbconfig), 0)), type, gapic::coder::gles::GLXContext(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(shared), 0)), direct, gapic::coder::gles::GLXContext(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(result), 0)));
    mEncoder->Object(&coder);
...
inline int GlesSpy::glXMakeContextCurrent(void* display, void* draw, void* read, void* ctx) {
    ...
    gapic::coder::gles::GlXMakeContextCurrent coder(observations , gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(display), 0)), gapic::coder::gles::GLXDrawable(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(draw), 0)), gapic::coder::gles::GLXDrawable(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(read), 0)), gapic::coder::gles::GLXContext(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(ctx), 0)), result);
    mEncoder->Object(&coder);
...
inline int GlesSpy::glXMakeCurrent(void* display, void* drawable, void* ctx) {
    ...
    gapic::coder::gles::GlXMakeCurrent coder(observations , gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(display), 0)), gapic::coder::gles::GLXDrawable(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(drawable), 0)), gapic::coder::gles::GLXContext(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(ctx), 0)), result);
    mEncoder->Object(&coder);
...
inline void GlesSpy::glXSwapBuffers(void* display, void* drawable) {
    ...
    gapic::coder::gles::GlXSwapBuffers coder(observations , gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(display), 0)), gapic::coder::gles::GLXDrawable(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(drawable), 0)));
    mEncoder->Object(&coder);
}
...
inline int GlesSpy::glXQueryDrawable(void* display, void* draw, int attribute, int* value) {
    ...
    gapic::coder::gles::GlXQueryDrawable coder(observations , gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(display), 0)), gapic::coder::gles::GLXDrawable(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(draw), 0)), attribute, gapic::coder::gles::Int__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)), result);
    mEncoder->Object(&coder);
...
inline void* GlesSpy::wglCreateContext(void* hdc) {
    ...
    gapic::coder::gles::WglCreateContext coder(observations , gapic::coder::gles::HDC(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(hdc), 0)), gapic::coder::gles::HGLRC(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(result), 0)));
    mEncoder->Object(&coder);
...
inline void* GlesSpy::wglCreateContextAttribsARB(void* hdc, void* hShareContext, int* attribList) {
    ...
    gapic::coder::gles::WglCreateContextAttribsARB coder(observations , gapic::coder::gles::HDC(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(hdc), 0)), gapic::coder::gles::HGLRC(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(hShareContext), 0)), gapic::coder::gles::Int__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(attribList), 0)), gapic::coder::gles::HGLRC(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(result), 0)));
    mEncoder->Object(&coder);
...
inline int GlesSpy::wglMakeCurrent(void* hdc, void* hglrc) {
    ...
    gapic::coder::gles::WglMakeCurrent coder(observations , gapic::coder::gles::HDC(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(hdc), 0)), gapic::coder::gles::HGLRC(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(hglrc), 0)), result);
    mEncoder->Object(&coder);
...
inline void GlesSpy::wglSwapBuffers(void* hdc) {
    ...
    gapic::coder::gles::WglSwapBuffers coder(observations , gapic::coder::gles::HDC(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(hdc), 0)));
    mEncoder->Object(&coder);
}
...
inline int GlesSpy::CGLCreateContext(void* pix, void* share, void** ctx) {
    ...
    gapic::coder::gles::CGLCreateContext coder(observations , gapic::coder::gles::CGLPixelFormatObj(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(pix), 0)), gapic::coder::gles::CGLContextObj(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(share), 0)), gapic::coder::gles::CGLContextObj__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(ctx), 0)), result);
    mEncoder->Object(&coder);
...
inline int GlesSpy::CGLSetCurrentContext(void* ctx) {
    ...
    gapic::coder::gles::CGLSetCurrentContext coder(observations , gapic::coder::gles::CGLContextObj(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(ctx), 0)), result);
    mEncoder->Object(&coder);
...
inline int GlesSpy::CGLGetSurface(void* ctx, void** cid, int32_t* wid, int32_t* sid) {
    ...
    gapic::coder::gles::CGLGetSurface coder(observations , gapic::coder::gles::CGLContextObj(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(ctx), 0)), gapic::coder::gles::CGSConnectionID__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(cid), 0)), gapic::coder::gles::CGSWindowID__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(wid), 0)), gapic::coder::gles::CGSSurfaceID__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(sid), 0)), result);
    mEncoder->Object(&coder);
...
inline int GlesSpy::CGSGetSurfaceBounds(void* cid, int32_t wid, int32_t sid, double* bounds) {
    ...
    gapic::coder::gles::CGSGetSurfaceBounds coder(observations , gapic::coder::gles::CGSConnectionID(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(cid), 0)), wid, sid, gapic::coder::gles::F64__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(bounds), 0)), result);
    mEncoder->Object(&coder);
...
inline int GlesSpy::CGLFlushDrawable(void* ctx) {
    ...
    gapic::coder::gles::CGLFlushDrawable coder(observations , gapic::coder::gles::CGLContextObj(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(ctx), 0)), result);
    mEncoder->Object(&coder);
...
inline void GlesSpy::glGetProgramBinaryOES(uint32_t program, int32_t buffer_size, int32_t* bytes_written, uint32_t* binary_format, void* binary) {
    ...
    gapic::coder::gles::GlGetProgramBinaryOES coder(observations , program, buffer_size, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(bytes_written), 0)), gapic::coder::gles::U32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(binary_format), 0)), gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(binary), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glProgramBinaryOES(uint32_t program, uint32_t binary_format, void* binary, int32_t binary_size) {
    ...
    gapic::coder::gles::GlProgramBinaryOES coder(observations , program, binary_format, gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(binary), 0)), binary_size);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glStartTilingQCOM(int32_t x, int32_t y, int32_t width, int32_t height, uint32_t preserveMask) {
...
inline void GlesSpy::glDiscardFramebufferEXT(uint32_t target, int32_t numAttachments, uint32_t* attachments) {
    ...
    gapic::coder::gles::GlDiscardFramebufferEXT coder(observations , target, numAttachments, gapic::coder::gles::DiscardFramebufferAttachment__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(attachments), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glInsertEventMarkerEXT(int32_t length, char* marker) {
    ...
    gapic::coder::gles::GlInsertEventMarkerEXT coder(observations , length, gapic::coder::gles::Char__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(marker), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glPushGroupMarkerEXT(int32_t length, char* marker) {
    ...
    gapic::coder::gles::GlPushGroupMarkerEXT coder(observations , length, gapic::coder::gles::Char__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(marker), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glTexStorage1DEXT(uint32_t target, int32_t levels, uint32_t format, int32_t width) {
...
inline void GlesSpy::glTexStorage2DEXT(uint32_t target, int32_t levels, uint32_t format, int32_t width, int32_t height) {
    ...
    gapic::coder::gles::GlTexStorage2DEXT coder(observations , target, levels, format, width, height);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glTexStorage3DEXT(uint32_t target, int32_t levels, uint32_t format, int32_t width, int32_t height, int32_t depth) {
    ...
    gapic::coder::gles::GlTexStorage3DEXT coder(observations , target, levels, format, width, height, depth);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glTextureStorage1DEXT(uint32_t texture, uint32_t target, int32_t levels, uint32_t format, int32_t width) {
    ...
    gapic::coder::gles::GlTextureStorage1DEXT coder(observations , texture, target, levels, format, width);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glTextureStorage2DEXT(uint32_t texture, uint32_t target, int32_t levels, uint32_t format, int32_t width, int32_t height) {
    ...
    gapic::coder::gles::GlTextureStorage2DEXT coder(observations , texture, target, levels, format, width, height);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glTextureStorage3DEXT(uint32_t texture, uint32_t target, int32_t levels, uint32_t format, int32_t width, int32_t height, int32_t depth) {
    ...
    gapic::coder::gles::GlTextureStorage3DEXT coder(observations , texture, target, levels, format, width, height, depth);
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGenVertexArraysOES(int32_t count, uint32_t* arrays) {
    ...
    do {
        ...
        for (int32_t l_i = 0; l_i < count; ++l_i) {
            VertexArrayId l_id = (VertexArrayId)(slice(arrays, (uint64_t)(0), (uint64_t)(count))[(uint64_t)(l_i)]);
    ...
    gapic::coder::gles::GlGenVertexArraysOES coder(observations , count, gapic::coder::gles::VertexArrayId__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(arrays), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glDeleteVertexArraysOES(int32_t count, uint32_t* arrays) {
    ...
    do {
        ...
        Slice<VertexArrayId> l_a = slice(arrays, (uint64_t)(0), (uint64_t)(count));
        for (int32_t l_i = 0; l_i < count; ++l_i) {
            l_ctx->mInstances.mVertexArrays[read(l_a, (uint64_t)(l_i))] = std::shared_ptr<VertexArray>();
        }
        observe(observations.mReads);
    ...
    gapic::coder::gles::GlDeleteVertexArraysOES coder(observations , count, gapic::coder::gles::VertexArrayId__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(arrays), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glEGLImageTargetTexture2DOES(uint32_t target, void* image) {
    ...
    gapic::coder::gles::GlEGLImageTargetTexture2DOES coder(observations , target, gapic::coder::gles::ImageOES(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(image), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glEGLImageTargetRenderbufferStorageOES(uint32_t target, void* image) {
    ...
    gapic::coder::gles::GlEGLImageTargetRenderbufferStorageOES coder(observations , target, gapic::coder::gles::TexturePointer(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(image), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glBlendFuncSeparate(uint32_t src_factor_rgb, uint32_t dst_factor_rgb, uint32_t src_factor_alpha, uint32_t dst_factor_alpha) {
    ...
    gapic::coder::gles::GlBlendFuncSeparate coder(observations , src_factor_rgb, dst_factor_rgb, src_factor_alpha, dst_factor_alpha);
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glBlendColor(float red, float green, float blue, float alpha) {
    ...
    do {
        ...
        l_ctx->mBlending.mBlendColor = Color().SetRed(red).SetGreen(green).SetBlue(blue).SetAlpha(alpha);
        observe(observations.mReads);
...
inline void GlesSpy::glVertexAttribPointer(int32_t location, int32_t size, uint32_t type, bool normalized, int32_t stride, void* data) {
    ...
    gapic::coder::gles::GlVertexAttribPointer coder(observations , location, size, type, normalized, stride, gapic::coder::gles::VertexPointer(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(data), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glGetActiveAttrib(uint32_t program, int32_t location, int32_t buffer_size, int32_t* buffer_bytes_written, int32_t* vector_count, uint32_t* type, char* name) {
    ...
    do {
        observe(observations.mReads);
        mImports.glGetActiveAttrib(program, location, buffer_size, buffer_bytes_written, vector_count, type, name);
    ...
    gapic::coder::gles::GlGetActiveAttrib coder(observations , program, location, buffer_size, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(buffer_bytes_written), 0)), gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(vector_count), 0)), gapic::coder::gles::ShaderAttribType__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(type), 0)), gapic::coder::gles::Char__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(name), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glGetActiveUniform(uint32_t program, int32_t location, int32_t buffer_size, int32_t* buffer_bytes_written, int32_t* vector_count, uint32_t* type, char* name) {
    ...
    do {
        observe(observations.mReads);
        mImports.glGetActiveUniform(program, location, buffer_size, buffer_bytes_written, vector_count, type, name);
        if (buffer_bytes_written != nullptr) {
            int32_t l_l = (int32_t)(slice(buffer_bytes_written, 0, 1)[0]);
            write(slice(buffer_bytes_written, 0, 1), 0, l_l);
            write(slice(name, (uint64_t)(0), (uint64_t)(l_l)));
    ...
    gapic::coder::gles::GlGetActiveUniform coder(observations , program, location, buffer_size, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(buffer_bytes_written), 0)), gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(vector_count), 0)), gapic::coder::gles::ShaderUniformType__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(type), 0)), gapic::coder::gles::Char__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(name), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetProgramiv(uint32_t program, uint32_t parameter, int32_t* value) {
    ...
    gapic::coder::gles::GlGetProgramiv coder(observations , program, parameter, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetShaderiv(uint32_t shader, uint32_t parameter, int32_t* value) {
    ...
    do {
        ...
        /* switch(parameter) */
            ...
            /* case ShaderParameter::GL_COMPILE_STATUS: */(((parameter) == (ShaderParameter::GL_COMPILE_STATUS))) ? (/* clang-format off */
            /* switch(l_s->mCompiled) */
                /* case true: */(((l_s->mCompiled) == (true))) ? (1) :
                /* case false: */(((l_s->mCompiled) == (false))) ? (0) :
                /* default: */ 0 /* clang-format on */) :
            /* case ShaderParameter::GL_INFO_LOG_LENGTH: */(((parameter) == (ShaderParameter::GL_INFO_LOG_LENGTH))) ? (int32_t((l_s->mInfoLog.count()))) :
            /* case ShaderParameter::GL_SHADER_SOURCE_LENGTH: */(((parameter) == (ShaderParameter::GL_SHADER_SOURCE_LENGTH))) ? (int32_t((l_s->mSource.size()))) :
            /* default: */ 0 /* clang-format on */);
    } while(false);
    observe(observations.mWrites);

    gapic::coder::gles::GlGetShaderiv coder(observations , shader, parameter, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetTexParameteriv(uint32_t target, uint32_t parameter, int32_t* values) {
    ...
    gapic::coder::gles::GlGetTexParameteriv coder(observations , target, parameter, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetTexParameterfv(uint32_t target, uint32_t parameter, float* values) {
    ...
    gapic::coder::gles::GlGetTexParameterfv coder(observations , target, parameter, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glUniform4i(int32_t location, int32_t value0, int32_t value1, int32_t value2, int32_t value3) {
...
inline void GlesSpy::glUniform1iv(int32_t location, int32_t count, int32_t* values) {
    ...
    gapic::coder::gles::GlUniform1iv coder(observations , location, count, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glUniform2iv(int32_t location, int32_t count, int32_t* values) {
    ...
    gapic::coder::gles::GlUniform2iv coder(observations , location, count, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glUniform3iv(int32_t location, int32_t count, int32_t* values) {
    ...
    gapic::coder::gles::GlUniform3iv coder(observations , location, count, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glUniform4iv(int32_t location, int32_t count, int32_t* values) {
    ...
    gapic::coder::gles::GlUniform4iv coder(observations , location, count, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glUniform4f(int32_t location, float value0, float value1, float value2, float value3) {
...
inline void GlesSpy::glUniform1fv(int32_t location, int32_t count, float* values) {
    ...
    gapic::coder::gles::GlUniform1fv coder(observations , location, count, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glUniform2fv(int32_t location, int32_t count, float* values) {
    ...
    gapic::coder::gles::GlUniform2fv coder(observations , location, count, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glUniform3fv(int32_t location, int32_t count, float* values) {
    ...
    gapic::coder::gles::GlUniform3fv coder(observations , location, count, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glUniform4fv(int32_t location, int32_t count, float* values) {
    ...
    gapic::coder::gles::GlUniform4fv coder(observations , location, count, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glUniformMatrix2fv(int32_t location, int32_t count, bool transpose, float* values) {
    ...
    gapic::coder::gles::GlUniformMatrix2fv coder(observations , location, count, transpose, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glUniformMatrix3fv(int32_t location, int32_t count, bool transpose, float* values) {
    ...
    gapic::coder::gles::GlUniformMatrix3fv coder(observations , location, count, transpose, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glUniformMatrix4fv(int32_t location, int32_t count, bool transpose, float* values) {
    ...
    gapic::coder::gles::GlUniformMatrix4fv coder(observations , location, count, transpose, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetUniformfv(uint32_t program, int32_t location, float* values) {
    ...
    gapic::coder::gles::GlGetUniformfv coder(observations , program, location, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetUniformiv(uint32_t program, int32_t location, int32_t* values) {
    ...
    gapic::coder::gles::GlGetUniformiv coder(observations , program, location, gapic::coder::gles::S32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glVertexAttrib4f(int32_t location, float value0, float value1, float value2, float value3) {
    ...
    gapic::coder::gles::GlVertexAttrib4f coder(observations , location, value0, value1, value2, value3);
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glVertexAttrib1fv(int32_t location, float* value) {
    ...
    gapic::coder::gles::GlVertexAttrib1fv coder(observations , location, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glVertexAttrib2fv(int32_t location, float* value) {
    ...
    gapic::coder::gles::GlVertexAttrib2fv coder(observations , location, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glVertexAttrib3fv(int32_t location, float* value) {
    ...
    gapic::coder::gles::GlVertexAttrib3fv coder(observations , location, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glVertexAttrib4fv(int32_t location, float* value) {
    ...
    gapic::coder::gles::GlVertexAttrib4fv coder(observations , location, gapic::coder::gles::F32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glGetShaderPrecisionFormat(uint32_t shader_type, uint32_t precision_type, int32_t* range, int32_t* precision) {
    ...
    gapic::coder::gles::GlGetShaderPrecisionFormat coder(observations , shader_type, precision_type, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(range), 0)), gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(precision), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glStencilFuncSeparate(uint32_t face, uint32_t function, int32_t reference_value, int32_t mask) {
    ...
    gapic::coder::gles::GlStencilFuncSeparate coder(observations , face, function, reference_value, mask);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glStencilOpSeparate(uint32_t face, uint32_t stencil_fail, uint32_t stencil_pass_depth_fail, uint32_t stencil_pass_depth_pass) {
    ...
    gapic::coder::gles::GlStencilOpSeparate coder(observations , face, stencil_fail, stencil_pass_depth_fail, stencil_pass_depth_pass);
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGenTextures(int32_t count, uint32_t* textures) {
    ...
    do {
        ...
        for (int32_t l_i = 0; l_i < count; ++l_i) {
            TextureId l_id = (TextureId)(slice(textures, (uint64_t)(0), (uint64_t)(count))[(uint64_t)(l_i)]);
    ...
    gapic::coder::gles::GlGenTextures coder(observations , count, gapic::coder::gles::TextureId__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(textures), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glDeleteTextures(int32_t count, uint32_t* textures) {
    ...
    gapic::coder::gles::GlDeleteTextures coder(observations , count, gapic::coder::gles::TextureId__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(textures), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glTexImage2D(uint32_t target, int32_t level, uint32_t internal_format, int32_t width, int32_t height, int32_t border, uint32_t format, uint32_t type, void* data) {
    ...
    do {
        ...
        switch (target) {
            case TextureImageTarget::GL_TEXTURE_2D: {
                TextureId l_id = l_ctx->mTextureUnits[l_ctx->mActiveTextureUnit][TextureTarget::GL_TEXTURE_2D];
                std::shared_ptr<Texture> l_t = l_ctx->mInstances.mTextures[l_id];
                Image l_l = Image().SetWidth(width).SetHeight(height).SetSize(imageSize((uint32_t)(width), (uint32_t)(height), format, type)).SetFormat((uint32_t)(format));
                if (data != nullptr) {
            ...
            case TextureImageTarget::GL_TEXTURE_CUBE_MAP_NEGATIVE_Z: {
                TextureId l_id = l_ctx->mTextureUnits[l_ctx->mActiveTextureUnit][TextureTarget::GL_TEXTURE_CUBE_MAP];
                std::shared_ptr<Texture> l_t = l_ctx->mInstances.mTextures[l_id];
                Image l_l = Image().SetWidth(width).SetHeight(height).SetSize(imageSize((uint32_t)(width), (uint32_t)(height), format, type)).SetFormat((uint32_t)(format));
                if (data != nullptr) {
                    if (l_ctx->mBoundBuffers[BufferTarget::GL_PIXEL_UNPACK_BUFFER] == (BufferId)(0)) {
        ...
        observe(observations.mReads);
        mImports.glTexImage2D(target, level, internal_format, width, height, border, format, type, data);
    } while(false);
    observe(observations.mWrites);

    gapic::coder::gles::GlTexImage2D coder(observations , target, level, internal_format, width, height, border, format, type, gapic::coder::gles::TexturePointer(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(data), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, uint32_t type, void* data) {
    ...
    do {
        ...
        switch (target) {
            case TextureImageTarget::GL_TEXTURE_2D: {
                ...
                std::shared_ptr<Texture> l_t = l_ctx->mInstances.mTextures[l_id];
                Image l_l = Image().SetWidth(width).SetHeight(height).SetSize(imageSize((uint32_t)(width), (uint32_t)(height), format, type)).SetFormat((uint32_t)(format));
                if (l_ctx->mBoundBuffers[BufferTarget::GL_PIXEL_UNPACK_BUFFER] == (BufferId)(0) && data != nullptr) {
                    l_l.mData = clone(slice((uint8_t*)(data), (uint64_t)(0), (uint64_t)(l_l.mSize)));
                }
                l_t->mTexture2D[level] = l_l;
                l_t->mKind = TextureKind::TEXTURE2D;
    ...
    gapic::coder::gles::GlTexSubImage2D coder(observations , target, level, xoffset, yoffset, width, height, format, type, gapic::coder::gles::TexturePointer(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(data), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glCopyTexImage2D(uint32_t target, int32_t level, uint32_t format, int32_t x, int32_t y, int32_t width, int32_t height, int32_t border) {
    ...
    gapic::coder::gles::GlCopyTexImage2D coder(observations , target, level, format, x, y, width, height, border);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glCopyTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t x, int32_t y, int32_t width, int32_t height) {
    ...
    gapic::coder::gles::GlCopyTexSubImage2D coder(observations , target, level, xoffset, yoffset, x, y, width, height);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glCompressedTexImage2D(uint32_t target, int32_t level, uint32_t format, int32_t width, int32_t height, int32_t border, int32_t image_size, void* data) {
    ...
    do {
        ...
        switch (target) {
            case TextureImageTarget::GL_TEXTURE_2D: {
                TextureId l_id = l_ctx->mTextureUnits[l_ctx->mActiveTextureUnit][TextureTarget::GL_TEXTURE_2D];
                std::shared_ptr<Texture> l_t = l_ctx->mInstances.mTextures[l_id];
                Image l_l = Image().SetWidth(width).SetHeight(height).SetSize((uint32_t)(image_size)).SetFormat((uint32_t)(format));
                if (l_ctx->mBoundBuffers[BufferTarget::GL_PIXEL_UNPACK_BUFFER] == (BufferId)(0) && data != nullptr) {
                    l_l.mData = clone(slice((uint8_t*)(data), (uint64_t)(0), (uint64_t)(l_l.mSize)));
                }
                l_t->mTexture2D[level] = l_l;
    ...
    gapic::coder::gles::GlCompressedTexImage2D coder(observations , target, level, format, width, height, border, image_size, gapic::coder::gles::TexturePointer(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(data), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glCompressedTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, int32_t image_size, void* data) {
    ...
    gapic::coder::gles::GlCompressedTexSubImage2D coder(observations , target, level, xoffset, yoffset, width, height, format, image_size, gapic::coder::gles::TexturePointer(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(data), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glReadPixels(int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format, uint32_t type, void* data) {
    ...
    do {
        ...
        write(slice(data, (uint64_t)(0), (uint64_t)(imageSize((uint32_t)(width), (uint32_t)(height), (uint32_t)(format), type))));
    } while(false);
    observe(observations.mWrites);

    gapic::coder::gles::GlReadPixels coder(observations , x, y, width, height, format, type, gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(data), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGenFramebuffers(int32_t count, uint32_t* framebuffers) {
    ...
    do {
        ...
        for (int32_t l_i = 0; l_i < count; ++l_i) {
            FramebufferId l_id = (FramebufferId)(slice(framebuffers, (uint64_t)(0), (uint64_t)(count))[(uint64_t)(l_i)]);
    ...
    gapic::coder::gles::GlGenFramebuffers coder(observations , count, gapic::coder::gles::FramebufferId__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(framebuffers), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glBindFramebuffer(uint32_t target, uint32_t framebuffer) {
    ...
    do {
        ...
        if (!(l_ctx->mInstances.mFramebuffers.count(framebuffer) > 0)) {
            l_ctx->mInstances.mFramebuffers[framebuffer] = std::shared_ptr<Framebuffer>((new Framebuffer()));
        }
...
inline void GlesSpy::glDeleteFramebuffers(int32_t count, uint32_t* framebuffers) {
    ...
    do {
        ...
        for (int32_t l_i = 0; l_i < count; ++l_i) {
            l_ctx->mInstances.mFramebuffers[read(l_f, (uint64_t)(l_i))] = std::shared_ptr<Framebuffer>();
        }
        observe(observations.mReads);
    ...
    gapic::coder::gles::GlDeleteFramebuffers coder(observations , count, gapic::coder::gles::FramebufferId__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(framebuffers), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGenRenderbuffers(int32_t count, uint32_t* renderbuffers) {
    ...
    do {
        ...
        for (int32_t l_i = 0; l_i < count; ++l_i) {
            RenderbufferId l_id = (RenderbufferId)(slice(renderbuffers, (uint64_t)(0), (uint64_t)(count))[(uint64_t)(l_i)]);
    ...
    gapic::coder::gles::GlGenRenderbuffers coder(observations , count, gapic::coder::gles::RenderbufferId__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(renderbuffers), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glBindRenderbuffer(uint32_t target, uint32_t renderbuffer) {
    ...
    do {
        ...
        if (!(l_ctx->mInstances.mRenderbuffers.count(renderbuffer) > 0)) {
            l_ctx->mInstances.mRenderbuffers[renderbuffer] = std::shared_ptr<Renderbuffer>((new Renderbuffer()));
        }
...
inline void GlesSpy::glRenderbufferStorage(uint32_t target, uint32_t format, int32_t width, int32_t height) {
...
inline void GlesSpy::glDeleteRenderbuffers(int32_t count, uint32_t* renderbuffers) {
    ...
    do {
        ...
        for (int32_t l_i = 0; l_i < count; ++l_i) {
            l_ctx->mInstances.mRenderbuffers[read(l_r, (uint64_t)(l_i))] = std::shared_ptr<Renderbuffer>();
        }
        observe(observations.mReads);
    ...
    gapic::coder::gles::GlDeleteRenderbuffers coder(observations , count, gapic::coder::gles::RenderbufferId__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(renderbuffers), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetRenderbufferParameteriv(uint32_t target, uint32_t parameter, int32_t* values) {
    ...
    gapic::coder::gles::GlGetRenderbufferParameteriv coder(observations , target, parameter, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGenBuffers(int32_t count, uint32_t* buffers) {
    ...
    do {
        ...
        for (int32_t l_i = 0; l_i < count; ++l_i) {
            BufferId l_id = (BufferId)(slice(buffers, (uint64_t)(0), (uint64_t)(count))[(uint64_t)(l_i)]);
    ...
    gapic::coder::gles::GlGenBuffers coder(observations , count, gapic::coder::gles::BufferId__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(buffers), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glBufferData(uint32_t target, int32_t size, void* data, uint32_t usage) {
    ...
    gapic::coder::gles::GlBufferData coder(observations , target, size, gapic::coder::gles::BufferDataPointer(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(data), 0)), usage);
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glBufferSubData(uint32_t target, int32_t offset, int32_t size, void* data) {
    ...
    gapic::coder::gles::GlBufferSubData coder(observations , target, offset, size, gapic::coder::gles::BufferDataPointer(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(data), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glDeleteBuffers(int32_t count, uint32_t* buffers) {
    ...
    gapic::coder::gles::GlDeleteBuffers coder(observations , count, gapic::coder::gles::BufferId__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(buffers), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetBufferParameteriv(uint32_t target, uint32_t parameter, int32_t* value) {
    ...
    gapic::coder::gles::GlGetBufferParameteriv coder(observations , target, parameter, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glShaderSource(uint32_t shader, int32_t count, char** source, int32_t* length) {
    ...
    gapic::coder::gles::GlShaderSource coder(observations , shader, count, gapic::coder::gles::Char__CP__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(source), 0)), gapic::coder::gles::S32__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(length), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glShaderBinary(int32_t count, uint32_t* shaders, uint32_t binary_format, void* binary, int32_t binary_size) {
    ...
    gapic::coder::gles::GlShaderBinary coder(observations , count, gapic::coder::gles::ShaderId__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(shaders), 0)), binary_format, gapic::coder::gles::Void__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(binary), 0)), binary_size);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glGetShaderInfoLog(uint32_t shader, int32_t buffer_length, int32_t* string_length_written, char* info) {
    ...
    do {
        ...
        Slice<char> copy__dst__ = copy(slice(info, (uint64_t)(0), (uint64_t)(l_l)), slice(l_s->mInfoLog, (uint64_t)(0), (uint64_t)(l_l)));
        observe(observations.mReads);
    ...
    gapic::coder::gles::GlGetShaderInfoLog coder(observations , shader, buffer_length, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(string_length_written), 0)), gapic::coder::gles::Char__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(info), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glGetShaderSource(uint32_t shader, int32_t buffer_length, int32_t* string_length_written, char* source) {
    ...
    do {
        ...
        Slice<char> copy__dst__ = copy(slice(source, (uint64_t)(0), (uint64_t)(l_l)), slice(slice(l_s->mSource), (uint64_t)(0), (uint64_t)(l_l)));
        observe(observations.mReads);
    ...
    gapic::coder::gles::GlGetShaderSource coder(observations , shader, buffer_length, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(string_length_written), 0)), gapic::coder::gles::Char__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(source), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetAttachedShaders(uint32_t program, int32_t buffer_length, int32_t* shaders_length_written, uint32_t* shaders) {
    ...
    gapic::coder::gles::GlGetAttachedShaders coder(observations , program, buffer_length, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(shaders_length_written), 0)), gapic::coder::gles::ShaderId__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(shaders), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetProgramInfoLog(uint32_t program, int32_t buffer_length, int32_t* string_length_written, char* info) {
    ...
    do {
        ...
        Slice<char> copy__dst__ = copy(slice(info, (uint64_t)(0), (uint64_t)(l_l)), slice(l_p->mInfoLog, (uint64_t)(0), (uint64_t)(l_l)));
        observe(observations.mReads);
    ...
    gapic::coder::gles::GlGetProgramInfoLog coder(observations , program, buffer_length, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(string_length_written), 0)), gapic::coder::gles::Char__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(info), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glFramebufferRenderbuffer(uint32_t framebuffer_target, uint32_t framebuffer_attachment, uint32_t renderbuffer_target, uint32_t renderbuffer) {
    ...
    gapic::coder::gles::GlFramebufferRenderbuffer coder(observations , framebuffer_target, framebuffer_attachment, renderbuffer_target, renderbuffer);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glFramebufferTexture2D(uint32_t framebuffer_target, uint32_t framebuffer_attachment, uint32_t texture_target, uint32_t texture, int32_t level) {
    ...
    gapic::coder::gles::GlFramebufferTexture2D coder(observations , framebuffer_target, framebuffer_attachment, texture_target, texture, level);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glGetFramebufferAttachmentParameteriv(uint32_t framebuffer_target, uint32_t attachment, uint32_t parameter, int32_t* value) {
    ...
    gapic::coder::gles::GlGetFramebufferAttachmentParameteriv coder(observations , framebuffer_target, attachment, parameter, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glDrawElements(uint32_t draw_mode, int32_t element_count, uint32_t indices_type, void* indices) {
    ...
    do {
        ...
        if (l_id != (BufferId)(0)) {
            ...
            for (int32_t l_i = 0; l_i < int32_t((l_ReadVertexArrays_114_ctx->mVertexAttributeArrays.size())); ++l_i) {
                std::shared_ptr<VertexAttributeArray> l_arr = l_ReadVertexArrays_114_ctx->mVertexAttributeArrays[(AttributeLocation)(l_i)];
                if (l_arr->mEnabled && l_arr->mBuffer == (BufferId)(0)) {
                    ...
                    /* switch(l_arr->mStride == 0) */
                        ...
                        /* default: */ 0 /* clang-format on */;
                    for (uint32_t l_v = l_ReadVertexArrays_114_first_index; l_v < l_ReadVertexArrays_114_last_index + 1; ++l_v) {
            ...
            for (int32_t l_i = 0; l_i < int32_t((l_ReadVertexArrays_116_ctx->mVertexAttributeArrays.size())); ++l_i) {
                std::shared_ptr<VertexAttributeArray> l_arr = l_ReadVertexArrays_116_ctx->mVertexAttributeArrays[(AttributeLocation)(l_i)];
                if (l_arr->mEnabled && l_arr->mBuffer == (BufferId)(0)) {
                    ...
                    /* switch(l_arr->mStride == 0) */
                        ...
                        /* case false: */(((l_arr->mStride == 0) == (false))) ? ((uint32_t)(l_arr->mStride)) :
                        /* default: */ 0 /* clang-format on */;
                    for (uint32_t l_v = l_ReadVertexArrays_116_first_index; l_v < l_ReadVertexArrays_116_last_index + 1; ++l_v) {
                        uint32_t l_offset = l_elstride * l_v;
                        read(slice(l_arr->mPointer, (uint64_t)(l_offset), (uint64_t)(l_offset + l_elsize)));
                    }
                }
            ...
            /* switch(l_IndexSize_118_indices_type) */
                ...
                /* default: */ 0 /* clang-format on */;
            read(slice(l_index_data, (uint64_t)(0), (uint64_t)((uint32_t)(element_count) * l_IndexSize_118_result)));
        }
        observe(observations.mReads);
    ...
    gapic::coder::gles::GlDrawElements coder(observations , draw_mode, element_count, indices_type, gapic::coder::gles::IndicesPointer(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(indices), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glDrawArrays(uint32_t draw_mode, int32_t first_index, int32_t index_count) {
    ...
    do {
        ...
        for (int32_t l_i = 0; l_i < int32_t((l_ReadVertexArrays_120_ctx->mVertexAttributeArrays.size())); ++l_i) {
            std::shared_ptr<VertexAttributeArray> l_arr = l_ReadVertexArrays_120_ctx->mVertexAttributeArrays[(AttributeLocation)(l_i)];
            if (l_arr->mEnabled && l_arr->mBuffer == (BufferId)(0)) {
                ...
                /* switch(l_arr->mStride == 0) */
                    ...
                    /* case false: */(((l_arr->mStride == 0) == (false))) ? ((uint32_t)(l_arr->mStride)) :
                    /* default: */ 0 /* clang-format on */;
                for (uint32_t l_v = l_ReadVertexArrays_120_first_index; l_v < l_ReadVertexArrays_120_last_index + 1; ++l_v) {
                    uint32_t l_offset = l_elstride * l_v;
                    read(slice(l_arr->mPointer, (uint64_t)(l_offset), (uint64_t)(l_offset + l_elsize)));
                }
            }
...
inline void GlesSpy::glGetBooleanv(uint32_t param, bool* values) {
    ...
    do {
        ...
        switch (param) {
            ...
            case StateVariable::GL_SHADER_COMPILER: {
                write(l_v, 0, slice(values, (uint64_t)(0), (uint64_t)(stateVariableSize(param)))[0]);
                break;
            }
    ...
    gapic::coder::gles::GlGetBooleanv coder(observations , param, gapic::coder::gles::Bool__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetFloatv(uint32_t param, float* values) {
    ...
    do {
        ...
        switch (param) {
            ...
            case StateVariable::GL_ALIASED_LINE_WIDTH_RANGE: {
                write(l_v, 0, slice(values, (uint64_t)(0), (uint64_t)(stateVariableSize(param)))[0]);
                write(l_v, 1, slice(values, (uint64_t)(0), (uint64_t)(stateVariableSize(param)))[1]);
                break;
            }
    ...
    gapic::coder::gles::GlGetFloatv coder(observations , param, gapic::coder::gles::F32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetIntegerv(uint32_t param, int32_t* values) {
    ...
    do {
        ...
        switch (param) {
            ...
            case StateVariable::GL_ELEMENT_ARRAY_BUFFER_BINDING: {
                write(l_v, 0, (int32_t)(l_ctx->mBoundBuffers[BufferTarget::GL_ELEMENT_ARRAY_BUFFER]));
                break;
            }
            ...
            case StateVariable::GL_FRAMEBUFFER_BINDING: {
                write(l_v, 0, (int32_t)(l_ctx->mBoundFramebuffers[FramebufferTarget::GL_FRAMEBUFFER]));
                break;
            }
            case StateVariable::GL_READ_FRAMEBUFFER_BINDING: {
                write(l_v, 0, (int32_t)(l_ctx->mBoundFramebuffers[FramebufferTarget::GL_READ_FRAMEBUFFER]));
                break;
            }
            case StateVariable::GL_RENDERBUFFER_BINDING: {
                write(l_v, 0, (int32_t)(l_ctx->mBoundRenderbuffers[RenderbufferTarget::GL_RENDERBUFFER]));
                break;
            }
            ...
            case StateVariable::GL_TEXTURE_BINDING_2D: {
                write(l_v, 0, (int32_t)(l_ctx->mTextureUnits[l_ctx->mActiveTextureUnit][TextureTarget::GL_TEXTURE_2D]));
                break;
            }
            case StateVariable::GL_TEXTURE_BINDING_CUBE_MAP: {
                write(l_v, 0, (int32_t)(l_ctx->mTextureUnits[l_ctx->mActiveTextureUnit][TextureTarget::GL_TEXTURE_CUBE_MAP]));
                break;
            }
            ...
            case StateVariable::GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS: {
                auto l_result = slice(values, (uint64_t)(0), (uint64_t)(stateVariableSize(param)))[0];
            ...
            case StateVariable::GL_MAX_VIEWPORT_DIMS: {
                auto l_max_width = slice(values, (uint64_t)(0), (uint64_t)(stateVariableSize(param)))[0];
                auto l_max_height = slice(values, (uint64_t)(0), (uint64_t)(stateVariableSize(param)))[1];
    ...
    gapic::coder::gles::GlGetIntegerv coder(observations , param, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(values), 0)));
    mEncoder->Object(&coder);
}
...
inline char* GlesSpy::glGetString(uint32_t param) {
    ...
    gapic::coder::gles::GlGetString coder(observations , param, gapic::coder::gles::Char__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(result), 0)));
    mEncoder->Object(&coder);
...
inline void* GlesSpy::glMapBufferRange(uint32_t target, int32_t offset, int32_t length, uint32_t access) {
    ...
    gapic::coder::gles::GlMapBufferRange coder(observations , target, offset, length, access, gapic::coder::gles::Void__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(result), 0)));
    mEncoder->Object(&coder);
...
inline void GlesSpy::glInvalidateFramebuffer(uint32_t target, int32_t count, uint32_t* attachments) {
    ...
    gapic::coder::gles::GlInvalidateFramebuffer coder(observations , target, count, gapic::coder::gles::FramebufferAttachment__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(attachments), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glRenderbufferStorageMultisample(uint32_t target, int32_t samples, uint32_t format, int32_t width, int32_t height) {
    ...
    gapic::coder::gles::GlRenderbufferStorageMultisample coder(observations , target, samples, format, width, height);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glBlitFramebuffer(int32_t srcX0, int32_t srcY0, int32_t srcX1, int32_t srcY1, int32_t dstX0, int32_t dstY0, int32_t dstX1, int32_t dstY1, uint32_t mask, uint32_t filter) {
    ...
    gapic::coder::gles::GlBlitFramebuffer coder(observations , srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGenQueries(int32_t count, uint32_t* queries) {
    ...
    gapic::coder::gles::GlGenQueries coder(observations , count, gapic::coder::gles::QueryId__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(queries), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glDeleteQueries(int32_t count, uint32_t* queries) {
    ...
    gapic::coder::gles::GlDeleteQueries coder(observations , count, gapic::coder::gles::QueryId__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(queries), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetQueryiv(uint32_t target, uint32_t parameter, int32_t* value) {
    ...
    gapic::coder::gles::GlGetQueryiv coder(observations , target, parameter, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetQueryObjectuiv(uint32_t query, uint32_t parameter, uint32_t* value) {
    ...
    gapic::coder::gles::GlGetQueryObjectuiv coder(observations , query, parameter, gapic::coder::gles::U32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glGetActiveUniformBlockName(uint32_t program, uint32_t uniform_block_index, int32_t buffer_size, int32_t* buffer_bytes_written, char* name) {
    ...
    gapic::coder::gles::GlGetActiveUniformBlockName coder(observations , program, uniform_block_index, buffer_size, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(buffer_bytes_written), 0)), gapic::coder::gles::Char__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(name), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glGetActiveUniformBlockiv(uint32_t program, uint32_t uniform_block_index, uint32_t parameter_name, int32_t* parameters) {
    ...
    gapic::coder::gles::GlGetActiveUniformBlockiv coder(observations , program, uniform_block_index, parameter_name, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(parameters), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::glUniformBlockBinding(uint32_t program, uint32_t uniform_block_index, uint32_t uniform_block_binding) {
    ...
    gapic::coder::gles::GlUniformBlockBinding coder(observations , program, uniform_block_index, uniform_block_binding);
    mEncoder->Object(&coder);
}

inline void GlesSpy::glGetActiveUniformsiv(uint32_t program, uint32_t uniform_count, uint32_t* uniform_indices, uint32_t parameter_name, int32_t* parameters) {
    ...
    do {
        ...
        observe(observations.mReads);
        mImports.glGetActiveUniformsiv(program, uniform_count, uniform_indices, parameter_name, parameters);
        write(slice(parameters, (uint64_t)(0), (uint64_t)(uniform_count)));
    } while(false);
    observe(observations.mWrites);

    gapic::coder::gles::GlGetActiveUniformsiv coder(observations , program, uniform_count, gapic::coder::gles::U32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(uniform_indices), 0)), parameter_name, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(parameters), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGenVertexArrays(int32_t count, uint32_t* arrays) {
    ...
    gapic::coder::gles::GlGenVertexArrays coder(observations , count, gapic::coder::gles::VertexArrayId__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(arrays), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glDeleteVertexArrays(uint32_t count, uint32_t* arrays) {
    ...
    gapic::coder::gles::GlDeleteVertexArrays coder(observations , count, gapic::coder::gles::VertexArrayId__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(arrays), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetQueryObjecti64v(uint32_t query, uint32_t parameter, int64_t* value) {
    ...
    gapic::coder::gles::GlGetQueryObjecti64v coder(observations , query, parameter, gapic::coder::gles::S64__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetQueryObjectui64v(uint32_t query, uint32_t parameter, uint64_t* value) {
    ...
    gapic::coder::gles::GlGetQueryObjectui64v coder(observations , query, parameter, gapic::coder::gles::U64__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGenQueriesEXT(int32_t count, uint32_t* queries) {
    ...
    gapic::coder::gles::GlGenQueriesEXT coder(observations , count, gapic::coder::gles::QueryId__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(queries), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glDeleteQueriesEXT(int32_t count, uint32_t* queries) {
    ...
    gapic::coder::gles::GlDeleteQueriesEXT coder(observations , count, gapic::coder::gles::QueryId__CP(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(queries), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetQueryivEXT(uint32_t target, uint32_t parameter, int32_t* value) {
    ...
    gapic::coder::gles::GlGetQueryivEXT coder(observations , target, parameter, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetQueryObjectivEXT(uint32_t query, uint32_t parameter, int32_t* value) {
    ...
    gapic::coder::gles::GlGetQueryObjectivEXT coder(observations , query, parameter, gapic::coder::gles::S32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetQueryObjectuivEXT(uint32_t query, uint32_t parameter, uint32_t* value) {
    ...
    gapic::coder::gles::GlGetQueryObjectuivEXT coder(observations , query, parameter, gapic::coder::gles::U32__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetQueryObjecti64vEXT(uint32_t query, uint32_t parameter, int64_t* value) {
    ...
    gapic::coder::gles::GlGetQueryObjecti64vEXT coder(observations , query, parameter, gapic::coder::gles::S64__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::glGetQueryObjectui64vEXT(uint32_t query, uint32_t parameter, uint64_t* value) {
    ...
    gapic::coder::gles::GlGetQueryObjectui64vEXT coder(observations , query, parameter, gapic::coder::gles::U64__P(gapic::coder::memory::Pointer(reinterpret_cast<uintptr_t>(value), 0)));
    mEncoder->Object(&coder);
}

inline void GlesSpy::architecture(uint32_t pointer_alignment, uint32_t pointer_size, uint32_t integer_size, bool little_endian) {
    GAPID_INFO("architecture(%u, %u, %u, %d)\n"
    , pointer_alignment, pointer_size, integer_size, little_endian);
    ...
    gapic::coder::gles::Architecture coder(observations , pointer_alignment, pointer_size, integer_size, little_endian);
    mEncoder->Object(&coder);
}
...
inline void GlesSpy::backbufferInfo(int32_t width, int32_t height, uint32_t color_fmt, uint32_t depth_fmt, uint32_t stencil_fmt, bool resetViewportScissor) {
    GAPID_INFO("backbufferInfo(%d, %d, %u, %u, %u, %d)\n"
    , width, height, color_fmt, depth_fmt, stencil_fmt, resetViewportScissor);
    ...
    do {
        ...
        RenderbufferId l_color_id = (RenderbufferId)(l_backbuffer->mAttachments[FramebufferAttachment::GL_COLOR_ATTACHMENT0].mObject);
        std::shared_ptr<Renderbuffer> l_color_buffer = l_ctx->mInstances.mRenderbuffers[l_color_id];
        RenderbufferId l_depth_id = (RenderbufferId)(l_backbuffer->mAttachments[FramebufferAttachment::GL_DEPTH_ATTACHMENT].mObject);
        std::shared_ptr<Renderbuffer> l_depth_buffer = l_ctx->mInstances.mRenderbuffers[l_depth_id];
        RenderbufferId l_stencil_id = (RenderbufferId)(l_backbuffer->mAttachments[FramebufferAttachment::GL_STENCIL_ATTACHMENT].mObject);
    ...
    gapic::coder::gles::BackbufferInfo coder(observations , width, height, color_fmt, depth_fmt, stencil_fmt, resetViewportScissor);
    mEncoder->Object(&coder);
}
