...
static const uint16_t GlXSwapBuffers = 8;
static const uint16_t WglCreateContext = 9;
static const uint16_t WglCreateContextAttribsARB = 10;
static const uint16_t WglMakeCurrent = 11;
static const uint16_t WglSwapBuffers = 12;
static const uint16_t CGLCreateContext = 13;
static const uint16_t CGLSetCurrentContext = 14;
static const uint16_t GlEnableClientState = 15;
static const uint16_t GlDisableClientState = 16;
static const uint16_t GlGetProgramBinaryOES = 17;
static const uint16_t GlProgramBinaryOES = 18;
static const uint16_t GlStartTilingQCOM = 19;
static const uint16_t GlEndTilingQCOM = 20;
static const uint16_t GlDiscardFramebufferEXT = 21;
static const uint16_t GlInsertEventMarkerEXT = 22;
static const uint16_t GlPushGroupMarkerEXT = 23;
static const uint16_t GlPopGroupMarkerEXT = 24;
static const uint16_t GlTexStorage1DEXT = 25;
static const uint16_t GlTexStorage2DEXT = 26;
static const uint16_t GlTexStorage3DEXT = 27;
static const uint16_t GlTextureStorage1DEXT = 28;
static const uint16_t GlTextureStorage2DEXT = 29;
static const uint16_t GlTextureStorage3DEXT = 30;
static const uint16_t GlGenVertexArraysOES = 31;
static const uint16_t GlBindVertexArrayOES = 32;
static const uint16_t GlDeleteVertexArraysOES = 33;
static const uint16_t GlIsVertexArrayOES = 34;
static const uint16_t GlEGLImageTargetTexture2DOES = 35;
static const uint16_t GlEGLImageTargetRenderbufferStorageOES = 36;
static const uint16_t GlGetGraphicsResetStatusEXT = 37;
static const uint16_t GlBindAttribLocation = 38;
static const uint16_t GlBlendFunc = 39;
static const uint16_t GlBlendFuncSeparate = 40;
static const uint16_t GlBlendEquation = 41;
static const uint16_t GlBlendEquationSeparate = 42;
static const uint16_t GlBlendColor = 43;
static const uint16_t GlEnableVertexAttribArray = 44;
static const uint16_t GlDisableVertexAttribArray = 45;
static const uint16_t GlVertexAttribPointer = 46;
static const uint16_t GlGetActiveAttrib = 47;
static const uint16_t GlGetActiveUniform = 48;
static const uint16_t GlGetError = 49;
static const uint16_t GlGetProgramiv = 50;
static const uint16_t GlGetShaderiv = 51;
static const uint16_t GlGetUniformLocation = 52;
static const uint16_t GlGetAttribLocation = 53;
static const uint16_t GlPixelStorei = 54;
static const uint16_t GlTexParameteri = 55;
static const uint16_t GlTexParameterf = 56;
static const uint16_t GlGetTexParameteriv = 57;
static const uint16_t GlGetTexParameterfv = 58;
static const uint16_t GlUniform1i = 59;
static const uint16_t GlUniform2i = 60;
static const uint16_t GlUniform3i = 61;
static const uint16_t GlUniform4i = 62;
static const uint16_t GlUniform1iv = 63;
static const uint16_t GlUniform2iv = 64;
static const uint16_t GlUniform3iv = 65;
static const uint16_t GlUniform4iv = 66;
static const uint16_t GlUniform1f = 67;
static const uint16_t GlUniform2f = 68;
static const uint16_t GlUniform3f = 69;
static const uint16_t GlUniform4f = 70;
static const uint16_t GlUniform1fv = 71;
static const uint16_t GlUniform2fv = 72;
static const uint16_t GlUniform3fv = 73;
static const uint16_t GlUniform4fv = 74;
static const uint16_t GlUniformMatrix2fv = 75;
static const uint16_t GlUniformMatrix3fv = 76;
static const uint16_t GlUniformMatrix4fv = 77;
static const uint16_t GlGetUniformfv = 78;
static const uint16_t GlGetUniformiv = 79;
static const uint16_t GlVertexAttrib1f = 80;
static const uint16_t GlVertexAttrib2f = 81;
static const uint16_t GlVertexAttrib3f = 82;
static const uint16_t GlVertexAttrib4f = 83;
static const uint16_t GlVertexAttrib1fv = 84;
static const uint16_t GlVertexAttrib2fv = 85;
static const uint16_t GlVertexAttrib3fv = 86;
static const uint16_t GlVertexAttrib4fv = 87;
static const uint16_t GlGetShaderPrecisionFormat = 88;
static const uint16_t GlDepthMask = 89;
static const uint16_t GlDepthFunc = 90;
static const uint16_t GlDepthRangef = 91;
static const uint16_t GlColorMask = 92;
static const uint16_t GlStencilMask = 93;
static const uint16_t GlStencilMaskSeparate = 94;
static const uint16_t GlStencilFuncSeparate = 95;
static const uint16_t GlStencilOpSeparate = 96;
static const uint16_t GlFrontFace = 97;
static const uint16_t GlViewport = 98;
static const uint16_t GlScissor = 99;
static const uint16_t GlActiveTexture = 100;
static const uint16_t GlGenTextures = 101;
static const uint16_t GlDeleteTextures = 102;
static const uint16_t GlIsTexture = 103;
static const uint16_t GlBindTexture = 104;
static const uint16_t GlTexImage2D = 105;
static const uint16_t GlTexSubImage2D = 106;
static const uint16_t GlCopyTexImage2D = 107;
static const uint16_t GlCopyTexSubImage2D = 108;
static const uint16_t GlCompressedTexImage2D = 109;
static const uint16_t GlCompressedTexSubImage2D = 110;
static const uint16_t GlGenerateMipmap = 111;
static const uint16_t GlReadPixels = 112;
static const uint16_t GlGenFramebuffers = 113;
static const uint16_t GlBindFramebuffer = 114;
static const uint16_t GlCheckFramebufferStatus = 115;
static const uint16_t GlDeleteFramebuffers = 116;
static const uint16_t GlIsFramebuffer = 117;
static const uint16_t GlGenRenderbuffers = 118;
static const uint16_t GlBindRenderbuffer = 119;
static const uint16_t GlRenderbufferStorage = 120;
static const uint16_t GlDeleteRenderbuffers = 121;
static const uint16_t GlIsRenderbuffer = 122;
static const uint16_t GlGetRenderbufferParameteriv = 123;
static const uint16_t GlGenBuffers = 124;
static const uint16_t GlBindBuffer = 125;
static const uint16_t GlBufferData = 126;
static const uint16_t GlBufferSubData = 127;
static const uint16_t GlDeleteBuffers = 128;
static const uint16_t GlIsBuffer = 129;
static const uint16_t GlGetBufferParameteriv = 130;
static const uint16_t GlCreateShader = 131;
static const uint16_t GlDeleteShader = 132;
static const uint16_t GlShaderSource = 133;
static const uint16_t GlShaderBinary = 134;
static const uint16_t GlGetShaderInfoLog = 135;
static const uint16_t GlGetShaderSource = 136;
static const uint16_t GlReleaseShaderCompiler = 137;
static const uint16_t GlCompileShader = 138;
static const uint16_t GlIsShader = 139;
static const uint16_t GlCreateProgram = 140;
static const uint16_t GlDeleteProgram = 141;
static const uint16_t GlAttachShader = 142;
static const uint16_t GlDetachShader = 143;
static const uint16_t GlGetAttachedShaders = 144;
static const uint16_t GlLinkProgram = 145;
static const uint16_t GlGetProgramInfoLog = 146;
static const uint16_t GlUseProgram = 147;
static const uint16_t GlIsProgram = 148;
static const uint16_t GlValidateProgram = 149;
static const uint16_t GlClearColor = 150;
static const uint16_t GlClearDepthf = 151;
static const uint16_t GlClearStencil = 152;
static const uint16_t GlClear = 153;
static const uint16_t GlCullFace = 154;
static const uint16_t GlPolygonOffset = 155;
static const uint16_t GlLineWidth = 156;
static const uint16_t GlSampleCoverage = 157;
static const uint16_t GlHint = 158;
static const uint16_t GlFramebufferRenderbuffer = 159;
static const uint16_t GlFramebufferTexture2D = 160;
static const uint16_t GlGetFramebufferAttachmentParameteriv = 161;
static const uint16_t GlDrawElements = 162;
static const uint16_t GlDrawArrays = 163;
static const uint16_t GlFlush = 164;
static const uint16_t GlFinish = 165;
static const uint16_t GlGetBooleanv = 166;
static const uint16_t GlGetFloatv = 167;
static const uint16_t GlGetIntegerv = 168;
static const uint16_t GlGetString = 169;
static const uint16_t GlEnable = 170;
static const uint16_t GlDisable = 171;
static const uint16_t GlIsEnabled = 172;
static const uint16_t GlMapBufferRange = 173;
static const uint16_t GlUnmapBuffer = 174;
static const uint16_t GlInvalidateFramebuffer = 175;
static const uint16_t GlRenderbufferStorageMultisample = 176;
static const uint16_t GlBlitFramebuffer = 177;
static const uint16_t GlGenQueries = 178;
static const uint16_t GlBeginQuery = 179;
static const uint16_t GlEndQuery = 180;
static const uint16_t GlDeleteQueries = 181;
