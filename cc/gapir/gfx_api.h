...
static const uint16_t WglCreateContext = 7;
static const uint16_t WglMakeCurrent = 8;
static const uint16_t WglSwapBuffers = 9;
static const uint16_t GlEnableClientState = 10;
static const uint16_t GlDisableClientState = 11;
static const uint16_t GlGetProgramBinaryOES = 12;
static const uint16_t GlProgramBinaryOES = 13;
static const uint16_t GlStartTilingQCOM = 14;
static const uint16_t GlEndTilingQCOM = 15;
static const uint16_t GlDiscardFramebufferEXT = 16;
static const uint16_t GlInsertEventMarkerEXT = 17;
static const uint16_t GlPushGroupMarkerEXT = 18;
static const uint16_t GlPopGroupMarkerEXT = 19;
static const uint16_t GlTexStorage1DEXT = 20;
static const uint16_t GlTexStorage2DEXT = 21;
static const uint16_t GlTexStorage3DEXT = 22;
static const uint16_t GlTextureStorage1DEXT = 23;
static const uint16_t GlTextureStorage2DEXT = 24;
static const uint16_t GlTextureStorage3DEXT = 25;
static const uint16_t GlGenVertexArraysOES = 26;
static const uint16_t GlBindVertexArrayOES = 27;
static const uint16_t GlDeleteVertexArraysOES = 28;
static const uint16_t GlIsVertexArrayOES = 29;
static const uint16_t GlEGLImageTargetTexture2DOES = 30;
static const uint16_t GlEGLImageTargetRenderbufferStorageOES = 31;
static const uint16_t GlGetGraphicsResetStatusEXT = 32;
static const uint16_t GlBindAttribLocation = 33;
static const uint16_t GlBlendFunc = 34;
static const uint16_t GlBlendFuncSeparate = 35;
static const uint16_t GlBlendEquation = 36;
static const uint16_t GlBlendEquationSeparate = 37;
static const uint16_t GlBlendColor = 38;
static const uint16_t GlEnableVertexAttribArray = 39;
static const uint16_t GlDisableVertexAttribArray = 40;
static const uint16_t GlVertexAttribPointer = 41;
static const uint16_t GlGetActiveAttrib = 42;
static const uint16_t GlGetActiveUniform = 43;
static const uint16_t GlGetError = 44;
static const uint16_t GlGetProgramiv = 45;
static const uint16_t GlGetShaderiv = 46;
static const uint16_t GlGetUniformLocation = 47;
static const uint16_t GlGetAttribLocation = 48;
static const uint16_t GlPixelStorei = 49;
static const uint16_t GlTexParameteri = 50;
static const uint16_t GlTexParameterf = 51;
static const uint16_t GlGetTexParameteriv = 52;
static const uint16_t GlGetTexParameterfv = 53;
static const uint16_t GlUniform1i = 54;
static const uint16_t GlUniform2i = 55;
static const uint16_t GlUniform3i = 56;
static const uint16_t GlUniform4i = 57;
static const uint16_t GlUniform1iv = 58;
static const uint16_t GlUniform2iv = 59;
static const uint16_t GlUniform3iv = 60;
static const uint16_t GlUniform4iv = 61;
static const uint16_t GlUniform1f = 62;
static const uint16_t GlUniform2f = 63;
static const uint16_t GlUniform3f = 64;
static const uint16_t GlUniform4f = 65;
static const uint16_t GlUniform1fv = 66;
static const uint16_t GlUniform2fv = 67;
static const uint16_t GlUniform3fv = 68;
static const uint16_t GlUniform4fv = 69;
static const uint16_t GlUniformMatrix2fv = 70;
static const uint16_t GlUniformMatrix3fv = 71;
static const uint16_t GlUniformMatrix4fv = 72;
static const uint16_t GlGetUniformfv = 73;
static const uint16_t GlGetUniformiv = 74;
static const uint16_t GlVertexAttrib1f = 75;
static const uint16_t GlVertexAttrib2f = 76;
static const uint16_t GlVertexAttrib3f = 77;
static const uint16_t GlVertexAttrib4f = 78;
static const uint16_t GlVertexAttrib1fv = 79;
static const uint16_t GlVertexAttrib2fv = 80;
static const uint16_t GlVertexAttrib3fv = 81;
static const uint16_t GlVertexAttrib4fv = 82;
static const uint16_t GlGetShaderPrecisionFormat = 83;
static const uint16_t GlDepthMask = 84;
static const uint16_t GlDepthFunc = 85;
static const uint16_t GlDepthRangef = 86;
static const uint16_t GlColorMask = 87;
static const uint16_t GlStencilMask = 88;
static const uint16_t GlStencilMaskSeparate = 89;
static const uint16_t GlStencilFuncSeparate = 90;
static const uint16_t GlStencilOpSeparate = 91;
static const uint16_t GlFrontFace = 92;
static const uint16_t GlViewport = 93;
static const uint16_t GlScissor = 94;
static const uint16_t GlActiveTexture = 95;
static const uint16_t GlGenTextures = 96;
static const uint16_t GlDeleteTextures = 97;
static const uint16_t GlIsTexture = 98;
static const uint16_t GlBindTexture = 99;
static const uint16_t GlTexImage2D = 100;
static const uint16_t GlTexSubImage2D = 101;
static const uint16_t GlCopyTexImage2D = 102;
static const uint16_t GlCopyTexSubImage2D = 103;
static const uint16_t GlCompressedTexImage2D = 104;
static const uint16_t GlCompressedTexSubImage2D = 105;
static const uint16_t GlGenerateMipmap = 106;
static const uint16_t GlReadPixels = 107;
static const uint16_t GlGenFramebuffers = 108;
static const uint16_t GlBindFramebuffer = 109;
static const uint16_t GlCheckFramebufferStatus = 110;
static const uint16_t GlDeleteFramebuffers = 111;
static const uint16_t GlIsFramebuffer = 112;
static const uint16_t GlGenRenderbuffers = 113;
static const uint16_t GlBindRenderbuffer = 114;
static const uint16_t GlRenderbufferStorage = 115;
static const uint16_t GlDeleteRenderbuffers = 116;
static const uint16_t GlIsRenderbuffer = 117;
static const uint16_t GlGetRenderbufferParameteriv = 118;
static const uint16_t GlGenBuffers = 119;
static const uint16_t GlBindBuffer = 120;
static const uint16_t GlBufferData = 121;
static const uint16_t GlBufferSubData = 122;
static const uint16_t GlDeleteBuffers = 123;
static const uint16_t GlIsBuffer = 124;
static const uint16_t GlGetBufferParameteriv = 125;
static const uint16_t GlCreateShader = 126;
static const uint16_t GlDeleteShader = 127;
static const uint16_t GlShaderSource = 128;
static const uint16_t GlShaderBinary = 129;
static const uint16_t GlGetShaderInfoLog = 130;
static const uint16_t GlGetShaderSource = 131;
static const uint16_t GlReleaseShaderCompiler = 132;
static const uint16_t GlCompileShader = 133;
static const uint16_t GlIsShader = 134;
static const uint16_t GlCreateProgram = 135;
static const uint16_t GlDeleteProgram = 136;
static const uint16_t GlAttachShader = 137;
static const uint16_t GlDetachShader = 138;
static const uint16_t GlGetAttachedShaders = 139;
static const uint16_t GlLinkProgram = 140;
static const uint16_t GlGetProgramInfoLog = 141;
static const uint16_t GlUseProgram = 142;
static const uint16_t GlIsProgram = 143;
static const uint16_t GlValidateProgram = 144;
static const uint16_t GlClearColor = 145;
static const uint16_t GlClearDepthf = 146;
static const uint16_t GlClearStencil = 147;
static const uint16_t GlClear = 148;
static const uint16_t GlCullFace = 149;
static const uint16_t GlPolygonOffset = 150;
static const uint16_t GlLineWidth = 151;
static const uint16_t GlSampleCoverage = 152;
static const uint16_t GlHint = 153;
static const uint16_t GlFramebufferRenderbuffer = 154;
static const uint16_t GlFramebufferTexture2D = 155;
static const uint16_t GlGetFramebufferAttachmentParameteriv = 156;
static const uint16_t GlDrawElements = 157;
static const uint16_t GlDrawArrays = 158;
static const uint16_t GlFlush = 159;
static const uint16_t GlFinish = 160;
static const uint16_t GlGetBooleanv = 161;
static const uint16_t GlGetFloatv = 162;
static const uint16_t GlGetIntegerv = 163;
static const uint16_t GlGetString = 164;
static const uint16_t GlEnable = 165;
static const uint16_t GlDisable = 166;
static const uint16_t GlIsEnabled = 167;
static const uint16_t GlMapBufferRange = 168;
static const uint16_t GlUnmapBuffer = 169;
static const uint16_t GlInvalidateFramebuffer = 170;
static const uint16_t GlRenderbufferStorageMultisample = 171;
static const uint16_t GlBlitFramebuffer = 172;
static const uint16_t GlGenQueries = 173;
static const uint16_t GlBeginQuery = 174;
static const uint16_t GlEndQuery = 175;
static const uint16_t GlDeleteQueries = 176;
static const uint16_t GlIsQuery = 177;
static const uint16_t GlGetQueryiv = 178;
static const uint16_t GlGetQueryObjectuiv = 179;
static const uint16_t GlGenQueriesEXT = 180;
static const uint16_t GlBeginQueryEXT = 181;
static const uint16_t GlEndQueryEXT = 182;
static const uint16_t GlDeleteQueriesEXT = 183;
static const uint16_t GlIsQueryEXT = 184;
static const uint16_t GlQueryCounterEXT = 185;
static const uint16_t GlGetQueryivEXT = 186;
static const uint16_t GlGetQueryObjectivEXT = 187;
static const uint16_t GlGetQueryObjectuivEXT = 188;
static const uint16_t GlGetQueryObjecti64vEXT = 189;
static const uint16_t GlGetQueryObjectui64vEXT = 190;
