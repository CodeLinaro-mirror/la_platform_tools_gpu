...
namespace gapir {
    ...
    namespace gfxapi {
        ...
        typedef void* (STDCALL *PFNEGLCREATECONTEXT)(void* display, void* config, void* share_context, int* attrib_list);
        ...
        typedef void* (STDCALL *PFNGLXCREATENEWCONTEXT)(void* display, void* fbconfig, uint32_t type, void* shared, bool direct);
        ...
        typedef void* (STDCALL *PFNWGLCREATECONTEXTATTRIBSARB)(void* hdc, void* hShareContext, int* attribList);
        ...
        typedef void (STDCALL *PFNGLGETPROGRAMBINARYOES)(uint32_t program, int32_t buffer_size, int32_t* bytes_written, uint32_t* binary_format, void* binary);
        typedef void (STDCALL *PFNGLPROGRAMBINARYOES)(uint32_t program, uint32_t binary_format, void* binary, int32_t binary_size);
        typedef void (STDCALL *PFNGLSTARTTILINGQCOM)(int32_t x, int32_t y, int32_t width, int32_t height, TilePreserveMaskQCOM preserveMask);
        typedef void (STDCALL *PFNGLENDTILINGQCOM)(TilePreserveMaskQCOM preserve_mask);
        typedef void (STDCALL *PFNGLDISCARDFRAMEBUFFEREXT)(FramebufferTarget target, int32_t numAttachments, DiscardFramebufferAttachment* attachments);
        ...
        typedef void (STDCALL *PFNGLTEXSTORAGE1DEXT)(TextureTarget target, int32_t levels, TexelFormat format, int32_t width);
        typedef void (STDCALL *PFNGLTEXSTORAGE2DEXT)(TextureTarget target, int32_t levels, TexelFormat format, int32_t width, int32_t height);
        typedef void (STDCALL *PFNGLTEXSTORAGE3DEXT)(TextureTarget target, int32_t levels, TexelFormat format, int32_t width, int32_t height, int32_t depth);
        typedef void (STDCALL *PFNGLTEXTURESTORAGE1DEXT)(uint32_t texture, TextureTarget target, int32_t levels, TexelFormat format, int32_t width);
        typedef void (STDCALL *PFNGLTEXTURESTORAGE2DEXT)(uint32_t texture, TextureTarget target, int32_t levels, TexelFormat format, int32_t width, int32_t height);
        typedef void (STDCALL *PFNGLTEXTURESTORAGE3DEXT)(uint32_t texture, TextureTarget target, int32_t levels, TexelFormat format, int32_t width, int32_t height, int32_t depth);
        ...
        typedef void (STDCALL *PFNGLEGLIMAGETARGETRENDERBUFFERSTORAGEOES)(ImageTargetRenderbufferStorage target, void* image);
        ...
        typedef void (STDCALL *PFNGLBLENDFUNCSEPARATE)(BlendFactor src_factor_rgb, BlendFactor dst_factor_rgb, BlendFactor src_factor_alpha, BlendFactor dst_factor_alpha);
        ...
        typedef void (STDCALL *PFNGLVERTEXATTRIBPOINTER)(int32_t location, int32_t size, VertexAttribType type, bool normalized, int32_t stride, void* data);
        typedef void (STDCALL *PFNGLGETACTIVEATTRIB)(uint32_t program, int32_t location, int32_t buffer_size, int32_t* buffer_bytes_written, int32_t* vector_count, ShaderAttribType* type, char* name);
        typedef void (STDCALL *PFNGLGETACTIVEUNIFORM)(uint32_t program, int32_t location, int32_t buffer_size, int32_t* buffer_bytes_written, int32_t* vector_count, ShaderUniformType* type, char* name);
        typedef Error (STDCALL *PFNGLGETERROR)();
        typedef void (STDCALL *PFNGLGETPROGRAMIV)(uint32_t program, ProgramParameter parameter, int32_t* value);
        ...
        typedef void (STDCALL *PFNGLTEXPARAMETERI)(TextureTarget target, TextureParameter parameter, int32_t value);
        typedef void (STDCALL *PFNGLTEXPARAMETERF)(TextureTarget target, TextureParameter parameter, float value);
        typedef void (STDCALL *PFNGLGETTEXPARAMETERIV)(TextureTarget target, TextureParameter parameter, int32_t* values);
        typedef void (STDCALL *PFNGLGETTEXPARAMETERFV)(TextureTarget target, TextureParameter parameter, float* values);
        ...
        typedef void (STDCALL *PFNGLUNIFORM3I)(int32_t location, int32_t value0, int32_t value1, int32_t value2);
        typedef void (STDCALL *PFNGLUNIFORM4I)(int32_t location, int32_t value0, int32_t value1, int32_t value2, int32_t value3);
        ...
        typedef void (STDCALL *PFNGLUNIFORM4F)(int32_t location, float value0, float value1, float value2, float value3);
        ...
        typedef void (STDCALL *PFNGLUNIFORMMATRIX2FV)(int32_t location, int32_t count, bool transpose, float* values);
        typedef void (STDCALL *PFNGLUNIFORMMATRIX3FV)(int32_t location, int32_t count, bool transpose, float* values);
        typedef void (STDCALL *PFNGLUNIFORMMATRIX4FV)(int32_t location, int32_t count, bool transpose, float* values);
        ...
        typedef void (STDCALL *PFNGLVERTEXATTRIB3F)(int32_t location, float value0, float value1, float value2);
        typedef void (STDCALL *PFNGLVERTEXATTRIB4F)(int32_t location, float value0, float value1, float value2, float value3);
        ...
        typedef void (STDCALL *PFNGLGETSHADERPRECISIONFORMAT)(ShaderType shader_type, PrecisionType precision_type, int32_t* range, int32_t* precision);
        ...
        typedef void (STDCALL *PFNGLSTENCILFUNCSEPARATE)(FaceMode face, TestFunction function, int32_t reference_value, int32_t mask);
        typedef void (STDCALL *PFNGLSTENCILOPSEPARATE)(FaceMode face, StencilAction stencil_fail, StencilAction stencil_pass_depth_fail, StencilAction stencil_pass_depth_pass);
        ...
        typedef void (STDCALL *PFNGLTEXIMAGE2D)(TextureImageTarget target, int32_t level, TexelFormat internal_format, int32_t width, int32_t height, int32_t border, TexelFormat format, TexelType type, void* data);
        typedef void (STDCALL *PFNGLTEXSUBIMAGE2D)(TextureImageTarget target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, TexelFormat format, TexelType type, void* data);
        typedef void (STDCALL *PFNGLCOPYTEXIMAGE2D)(TextureImageTarget target, int32_t level, TexelFormat format, int32_t x, int32_t y, int32_t width, int32_t height, int32_t border);
        typedef void (STDCALL *PFNGLCOPYTEXSUBIMAGE2D)(TextureImageTarget target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t x, int32_t y, int32_t width, int32_t height);
        typedef void (STDCALL *PFNGLCOMPRESSEDTEXIMAGE2D)(TextureImageTarget target, int32_t level, CompressedTexelFormat format, int32_t width, int32_t height, int32_t border, int32_t image_size, void* data);
        typedef void (STDCALL *PFNGLCOMPRESSEDTEXSUBIMAGE2D)(TextureImageTarget target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, CompressedTexelFormat format, int32_t image_size, void* data);
        typedef void (STDCALL *PFNGLGENERATEMIPMAP)(TextureImageTarget target);
        typedef void (STDCALL *PFNGLREADPIXELS)(int32_t x, int32_t y, int32_t width, int32_t height, BaseTexelFormat format, TexelType type, void* data);
        ...
        typedef void (STDCALL *PFNGLRENDERBUFFERSTORAGE)(RenderbufferTarget target, RenderbufferFormat format, int32_t width, int32_t height);
        ...
        typedef void (STDCALL *PFNGLGETRENDERBUFFERPARAMETERIV)(RenderbufferTarget target, RenderbufferParameter parameter, int32_t* values);
        ...
        typedef void (STDCALL *PFNGLBUFFERDATA)(BufferTarget target, int32_t size, void* data, BufferUsage usage);
        typedef void (STDCALL *PFNGLBUFFERSUBDATA)(BufferTarget target, int32_t offset, int32_t size, void* data);
        typedef void (STDCALL *PFNGLDELETEBUFFERS)(int32_t count, uint32_t* buffers);
        typedef bool (STDCALL *PFNGLISBUFFER)(uint32_t buffer);
        typedef void (STDCALL *PFNGLGETBUFFERPARAMETERIV)(BufferTarget target, BufferParameter parameter, int32_t* value);
        typedef uint32_t (STDCALL *PFNGLCREATESHADER)(ShaderType type);
        typedef void (STDCALL *PFNGLDELETESHADER)(uint32_t shader);
        typedef void (STDCALL *PFNGLSHADERSOURCE)(uint32_t shader, int32_t count, char** source, int32_t* length);
        typedef void (STDCALL *PFNGLSHADERBINARY)(int32_t count, uint32_t* shaders, uint32_t binary_format, void* binary, int32_t binary_size);
        typedef void (STDCALL *PFNGLGETSHADERINFOLOG)(uint32_t shader, int32_t buffer_length, int32_t* string_length_written, char* info);
        typedef void (STDCALL *PFNGLGETSHADERSOURCE)(uint32_t shader, int32_t buffer_length, int32_t* string_length_written, char* source);
        ...
        typedef void (STDCALL *PFNGLGETATTACHEDSHADERS)(uint32_t program, int32_t buffer_length, int32_t* shaders_length_written, uint32_t* shaders);
        typedef void (STDCALL *PFNGLLINKPROGRAM)(uint32_t program);
        typedef void (STDCALL *PFNGLGETPROGRAMINFOLOG)(uint32_t program, int32_t buffer_length, int32_t* string_length_written, char* info);
        ...
        typedef void (STDCALL *PFNGLFRAMEBUFFERRENDERBUFFER)(FramebufferTarget framebuffer_target, FramebufferAttachment framebuffer_attachment, RenderbufferTarget renderbuffer_target, uint32_t renderbuffer);
        typedef void (STDCALL *PFNGLFRAMEBUFFERTEXTURE2D)(FramebufferTarget framebuffer_target, FramebufferAttachment framebuffer_attachment, TextureImageTarget texture_target, uint32_t texture, int32_t level);
        typedef void (STDCALL *PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIV)(FramebufferTarget framebuffer_target, FramebufferAttachment attachment, FramebufferAttachmentParameter parameter, int32_t* value);
        typedef void (STDCALL *PFNGLDRAWELEMENTS)(DrawMode draw_mode, int32_t element_count, IndicesType indices_type, void* indices);
        typedef void (STDCALL *PFNGLDRAWARRAYS)(DrawMode draw_mode, int32_t first_index, int32_t index_count);
        ...
        typedef ClientWaitSyncSignal (STDCALL *PFNGLCLIENTWAITSYNC)(uint64_t sync, SyncFlags syncFlags, uint64_t timeout);
        typedef void* (STDCALL *PFNGLMAPBUFFERRANGE)(BufferTarget target, int32_t offset, int32_t length, MapBufferRangeAccess access);
        typedef void (STDCALL *PFNGLUNMAPBUFFER)(BufferTarget target);
        typedef void (STDCALL *PFNGLINVALIDATEFRAMEBUFFER)(FramebufferTarget target, int32_t count, FramebufferAttachment* attachments);
        typedef void (STDCALL *PFNGLRENDERBUFFERSTORAGEMULTISAMPLE)(RenderbufferTarget target, int32_t samples, RenderbufferFormat format, int32_t width, int32_t height);
        typedef void (STDCALL *PFNGLBLITFRAMEBUFFER)(int32_t srcX0, int32_t srcY0, int32_t srcX1, int32_t srcY1, int32_t dstX0, int32_t dstY0, int32_t dstX1, int32_t dstY1, ClearMask mask, TextureFilterMode filter);
        ...
        typedef void (STDCALL *PFNGLGETQUERYIV)(QueryTarget target, QueryParameter parameter, int32_t* value);
        typedef void (STDCALL *PFNGLGETQUERYOBJECTUIV)(uint32_t query, QueryObjectParameter parameter, uint32_t* value);
        typedef void (STDCALL *PFNGLGETACTIVEUNIFORMBLOCKNAME)(uint32_t program, uint32_t uniform_block_index, int32_t buffer_size, int32_t* buffer_bytes_written, char* name);
        typedef void (STDCALL *PFNGLGETACTIVEUNIFORMBLOCKIV)(uint32_t program, uint32_t uniform_block_index, UniformBlockParameter parameter_name, int32_t* parameters);
        typedef void (STDCALL *PFNGLUNIFORMBLOCKBINDING)(uint32_t program, uint32_t uniform_block_index, uint32_t uniform_block_binding);
        typedef void (STDCALL *PFNGLGETACTIVEUNIFORMSIV)(uint32_t program, uint32_t uniform_count, uint32_t* uniform_indices, UniformBlockParameter parameter_name, int32_t* parameters);
        typedef void (STDCALL *PFNGLBINDBUFFERBASE)(IndexedBufferTarget target, uint32_t index, uint32_t buffer);
        ...
        typedef void (STDCALL *PFNGLGETQUERYOBJECTI64V)(uint32_t query, QueryObjectParameter parameter, int64_t* value);
        typedef void (STDCALL *PFNGLGETQUERYOBJECTUI64V)(uint32_t query, QueryObjectParameter parameter, uint64_t* value);
        ...
        typedef void (STDCALL *PFNGLGETQUERYIVEXT)(QueryTarget target, QueryParameter parameter, int32_t* value);
        typedef void (STDCALL *PFNGLGETQUERYOBJECTIVEXT)(uint32_t query, QueryObjectParameter parameter, int32_t* value);
        typedef void (STDCALL *PFNGLGETQUERYOBJECTUIVEXT)(uint32_t query, QueryObjectParameter parameter, uint32_t* value);
        typedef void (STDCALL *PFNGLGETQUERYOBJECTI64VEXT)(uint32_t query, QueryObjectParameter parameter, int64_t* value);
        typedef void (STDCALL *PFNGLGETQUERYOBJECTUI64VEXT)(uint32_t query, QueryObjectParameter parameter, uint64_t* value);
