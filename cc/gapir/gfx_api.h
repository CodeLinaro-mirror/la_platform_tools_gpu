...
static const uint16_t ReplayCreateRenderer = 0;
static const uint16_t ReplayBindRenderer = 1;
static const uint16_t BackbufferInfo = 2;
static const uint16_t StartTimer = 3;
static const uint16_t StopTimer = 4;
static const uint16_t FlushPostBuffer = 5;
static const uint16_t EglInitialize = 6;
static const uint16_t EglCreateContext = 7;
static const uint16_t EglMakeCurrent = 8;
static const uint16_t EglSwapBuffers = 9;
static const uint16_t EglQuerySurface = 10;
static const uint16_t GlXCreateContext = 11;
static const uint16_t GlXCreateNewContext = 12;
static const uint16_t GlXMakeContextCurrent = 13;
static const uint16_t GlXSwapBuffers = 14;
static const uint16_t WglCreateContext = 15;
static const uint16_t WglCreateContextAttribsARB = 16;
static const uint16_t WglMakeCurrent = 17;
static const uint16_t WglSwapBuffers = 18;
static const uint16_t CGLCreateContext = 19;
static const uint16_t CGLSetCurrentContext = 20;
static const uint16_t GlEnableClientState = 21;
static const uint16_t GlDisableClientState = 22;
static const uint16_t GlGetProgramBinaryOES = 23;
static const uint16_t GlProgramBinaryOES = 24;
static const uint16_t GlStartTilingQCOM = 25;
static const uint16_t GlEndTilingQCOM = 26;
static const uint16_t GlDiscardFramebufferEXT = 27;
static const uint16_t GlInsertEventMarkerEXT = 28;
static const uint16_t GlPushGroupMarkerEXT = 29;
static const uint16_t GlPopGroupMarkerEXT = 30;
static const uint16_t GlTexStorage1DEXT = 31;
static const uint16_t GlTexStorage2DEXT = 32;
static const uint16_t GlTexStorage3DEXT = 33;
static const uint16_t GlTextureStorage1DEXT = 34;
static const uint16_t GlTextureStorage2DEXT = 35;
static const uint16_t GlTextureStorage3DEXT = 36;
static const uint16_t GlGenVertexArraysOES = 37;
static const uint16_t GlBindVertexArrayOES = 38;
static const uint16_t GlDeleteVertexArraysOES = 39;
static const uint16_t GlIsVertexArrayOES = 40;
static const uint16_t GlEGLImageTargetTexture2DOES = 41;
static const uint16_t GlEGLImageTargetRenderbufferStorageOES = 42;
static const uint16_t GlGetGraphicsResetStatusEXT = 43;
static const uint16_t GlBindAttribLocation = 44;
static const uint16_t GlBlendFunc = 45;
static const uint16_t GlBlendFuncSeparate = 46;
static const uint16_t GlBlendEquation = 47;
static const uint16_t GlBlendEquationSeparate = 48;
static const uint16_t GlBlendColor = 49;
static const uint16_t GlEnableVertexAttribArray = 50;
static const uint16_t GlDisableVertexAttribArray = 51;
static const uint16_t GlVertexAttribPointer = 52;
static const uint16_t GlGetActiveAttrib = 53;
static const uint16_t GlGetActiveUniform = 54;
static const uint16_t GlGetError = 55;
static const uint16_t GlGetProgramiv = 56;
static const uint16_t GlGetShaderiv = 57;
static const uint16_t GlGetUniformLocation = 58;
static const uint16_t GlGetAttribLocation = 59;
static const uint16_t GlPixelStorei = 60;
static const uint16_t GlTexParameteri = 61;
static const uint16_t GlTexParameterf = 62;
static const uint16_t GlGetTexParameteriv = 63;
static const uint16_t GlGetTexParameterfv = 64;
static const uint16_t GlUniform1i = 65;
static const uint16_t GlUniform2i = 66;
static const uint16_t GlUniform3i = 67;
static const uint16_t GlUniform4i = 68;
static const uint16_t GlUniform1iv = 69;
static const uint16_t GlUniform2iv = 70;
static const uint16_t GlUniform3iv = 71;
static const uint16_t GlUniform4iv = 72;
static const uint16_t GlUniform1f = 73;
static const uint16_t GlUniform2f = 74;
static const uint16_t GlUniform3f = 75;
static const uint16_t GlUniform4f = 76;
static const uint16_t GlUniform1fv = 77;
static const uint16_t GlUniform2fv = 78;
static const uint16_t GlUniform3fv = 79;
static const uint16_t GlUniform4fv = 80;
static const uint16_t GlUniformMatrix2fv = 81;
static const uint16_t GlUniformMatrix3fv = 82;
static const uint16_t GlUniformMatrix4fv = 83;
static const uint16_t GlGetUniformfv = 84;
static const uint16_t GlGetUniformiv = 85;
static const uint16_t GlVertexAttrib1f = 86;
static const uint16_t GlVertexAttrib2f = 87;
static const uint16_t GlVertexAttrib3f = 88;
static const uint16_t GlVertexAttrib4f = 89;
static const uint16_t GlVertexAttrib1fv = 90;
static const uint16_t GlVertexAttrib2fv = 91;
static const uint16_t GlVertexAttrib3fv = 92;
static const uint16_t GlVertexAttrib4fv = 93;
static const uint16_t GlGetShaderPrecisionFormat = 94;
static const uint16_t GlDepthMask = 95;
static const uint16_t GlDepthFunc = 96;
static const uint16_t GlDepthRangef = 97;
static const uint16_t GlColorMask = 98;
static const uint16_t GlStencilMask = 99;
static const uint16_t GlStencilMaskSeparate = 100;
static const uint16_t GlStencilFuncSeparate = 101;
static const uint16_t GlStencilOpSeparate = 102;
static const uint16_t GlFrontFace = 103;
static const uint16_t GlViewport = 104;
static const uint16_t GlScissor = 105;
static const uint16_t GlActiveTexture = 106;
static const uint16_t GlGenTextures = 107;
static const uint16_t GlDeleteTextures = 108;
static const uint16_t GlIsTexture = 109;
static const uint16_t GlBindTexture = 110;
static const uint16_t GlTexImage2D = 111;
static const uint16_t GlTexSubImage2D = 112;
static const uint16_t GlCopyTexImage2D = 113;
static const uint16_t GlCopyTexSubImage2D = 114;
static const uint16_t GlCompressedTexImage2D = 115;
static const uint16_t GlCompressedTexSubImage2D = 116;
static const uint16_t GlGenerateMipmap = 117;
static const uint16_t GlReadPixels = 118;
static const uint16_t GlGenFramebuffers = 119;
static const uint16_t GlBindFramebuffer = 120;
static const uint16_t GlCheckFramebufferStatus = 121;
static const uint16_t GlDeleteFramebuffers = 122;
static const uint16_t GlIsFramebuffer = 123;
static const uint16_t GlGenRenderbuffers = 124;
static const uint16_t GlBindRenderbuffer = 125;
static const uint16_t GlRenderbufferStorage = 126;
static const uint16_t GlDeleteRenderbuffers = 127;
static const uint16_t GlIsRenderbuffer = 128;
static const uint16_t GlGetRenderbufferParameteriv = 129;
static const uint16_t GlGenBuffers = 130;
static const uint16_t GlBindBuffer = 131;
static const uint16_t GlBufferData = 132;
static const uint16_t GlBufferSubData = 133;
static const uint16_t GlDeleteBuffers = 134;
static const uint16_t GlIsBuffer = 135;
static const uint16_t GlGetBufferParameteriv = 136;
static const uint16_t GlCreateShader = 137;
static const uint16_t GlDeleteShader = 138;
static const uint16_t GlShaderSource = 139;
static const uint16_t GlShaderBinary = 140;
static const uint16_t GlGetShaderInfoLog = 141;
static const uint16_t GlGetShaderSource = 142;
static const uint16_t GlReleaseShaderCompiler = 143;
static const uint16_t GlCompileShader = 144;
static const uint16_t GlIsShader = 145;
static const uint16_t GlCreateProgram = 146;
static const uint16_t GlDeleteProgram = 147;
static const uint16_t GlAttachShader = 148;
static const uint16_t GlDetachShader = 149;
static const uint16_t GlGetAttachedShaders = 150;
static const uint16_t GlLinkProgram = 151;
static const uint16_t GlGetProgramInfoLog = 152;
static const uint16_t GlUseProgram = 153;
static const uint16_t GlIsProgram = 154;
static const uint16_t GlValidateProgram = 155;
static const uint16_t GlClearColor = 156;
static const uint16_t GlClearDepthf = 157;
static const uint16_t GlClearStencil = 158;
static const uint16_t GlClear = 159;
static const uint16_t GlCullFace = 160;
static const uint16_t GlPolygonOffset = 161;
static const uint16_t GlLineWidth = 162;
static const uint16_t GlSampleCoverage = 163;
static const uint16_t GlHint = 164;
static const uint16_t GlFramebufferRenderbuffer = 165;
static const uint16_t GlFramebufferTexture2D = 166;
static const uint16_t GlGetFramebufferAttachmentParameteriv = 167;
static const uint16_t GlDrawElements = 168;
static const uint16_t GlDrawArrays = 169;
static const uint16_t GlFlush = 170;
static const uint16_t GlFinish = 171;
static const uint16_t GlGetBooleanv = 172;
static const uint16_t GlGetFloatv = 173;
static const uint16_t GlGetIntegerv = 174;
static const uint16_t GlGetString = 175;
static const uint16_t GlEnable = 176;
static const uint16_t GlDisable = 177;
static const uint16_t GlIsEnabled = 178;
static const uint16_t GlMapBufferRange = 179;
static const uint16_t GlUnmapBuffer = 180;
static const uint16_t GlInvalidateFramebuffer = 181;
static const uint16_t GlRenderbufferStorageMultisample = 182;
static const uint16_t GlBlitFramebuffer = 183;
static const uint16_t GlGenQueries = 184;
static const uint16_t GlBeginQuery = 185;
static const uint16_t GlEndQuery = 186;
static const uint16_t GlDeleteQueries = 187;
static const uint16_t GlIsQuery = 188;
static const uint16_t GlGetQueryiv = 189;
static const uint16_t GlGetQueryObjectuiv = 190;
static const uint16_t GlGenQueriesEXT = 191;
static const uint16_t GlBeginQueryEXT = 192;
static const uint16_t GlEndQueryEXT = 193;
static const uint16_t GlDeleteQueriesEXT = 194;
static const uint16_t GlIsQueryEXT = 195;
static const uint16_t GlQueryCounterEXT = 196;
static const uint16_t GlGetQueryivEXT = 197;
static const uint16_t GlGetQueryObjectivEXT = 198;
static const uint16_t GlGetQueryObjectuivEXT = 199;
static const uint16_t GlGetQueryObjecti64vEXT = 200;
static const uint16_t GlGetQueryObjectui64vEXT = 201;
...
typedef void(STDCALL *PFNGLXMAKECONTEXTCURRENT)(void *display, void *draw, void *read, void *ctx);
