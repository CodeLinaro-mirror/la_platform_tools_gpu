...
static const uint16_t WglCreateContext = 8;
static const uint16_t WglMakeCurrent = 9;
static const uint16_t WglSwapBuffers = 10;
static const uint16_t CGLCreateContext = 11;
static const uint16_t GlEnableClientState = 12;
static const uint16_t GlDisableClientState = 13;
static const uint16_t GlGetProgramBinaryOES = 14;
static const uint16_t GlProgramBinaryOES = 15;
static const uint16_t GlStartTilingQCOM = 16;
static const uint16_t GlEndTilingQCOM = 17;
static const uint16_t GlDiscardFramebufferEXT = 18;
static const uint16_t GlInsertEventMarkerEXT = 19;
static const uint16_t GlPushGroupMarkerEXT = 20;
static const uint16_t GlPopGroupMarkerEXT = 21;
static const uint16_t GlTexStorage1DEXT = 22;
static const uint16_t GlTexStorage2DEXT = 23;
static const uint16_t GlTexStorage3DEXT = 24;
static const uint16_t GlTextureStorage1DEXT = 25;
static const uint16_t GlTextureStorage2DEXT = 26;
static const uint16_t GlTextureStorage3DEXT = 27;
static const uint16_t GlGenVertexArraysOES = 28;
static const uint16_t GlBindVertexArrayOES = 29;
static const uint16_t GlDeleteVertexArraysOES = 30;
static const uint16_t GlIsVertexArrayOES = 31;
static const uint16_t GlEGLImageTargetTexture2DOES = 32;
static const uint16_t GlEGLImageTargetRenderbufferStorageOES = 33;
static const uint16_t GlGetGraphicsResetStatusEXT = 34;
static const uint16_t GlBindAttribLocation = 35;
static const uint16_t GlBlendFunc = 36;
static const uint16_t GlBlendFuncSeparate = 37;
static const uint16_t GlBlendEquation = 38;
static const uint16_t GlBlendEquationSeparate = 39;
static const uint16_t GlBlendColor = 40;
static const uint16_t GlEnableVertexAttribArray = 41;
static const uint16_t GlDisableVertexAttribArray = 42;
static const uint16_t GlVertexAttribPointer = 43;
static const uint16_t GlGetActiveAttrib = 44;
static const uint16_t GlGetActiveUniform = 45;
static const uint16_t GlGetError = 46;
static const uint16_t GlGetProgramiv = 47;
static const uint16_t GlGetShaderiv = 48;
static const uint16_t GlGetUniformLocation = 49;
static const uint16_t GlGetAttribLocation = 50;
static const uint16_t GlPixelStorei = 51;
static const uint16_t GlTexParameteri = 52;
static const uint16_t GlTexParameterf = 53;
static const uint16_t GlGetTexParameteriv = 54;
static const uint16_t GlGetTexParameterfv = 55;
static const uint16_t GlUniform1i = 56;
static const uint16_t GlUniform2i = 57;
static const uint16_t GlUniform3i = 58;
static const uint16_t GlUniform4i = 59;
static const uint16_t GlUniform1iv = 60;
static const uint16_t GlUniform2iv = 61;
static const uint16_t GlUniform3iv = 62;
static const uint16_t GlUniform4iv = 63;
static const uint16_t GlUniform1f = 64;
static const uint16_t GlUniform2f = 65;
static const uint16_t GlUniform3f = 66;
static const uint16_t GlUniform4f = 67;
static const uint16_t GlUniform1fv = 68;
static const uint16_t GlUniform2fv = 69;
static const uint16_t GlUniform3fv = 70;
static const uint16_t GlUniform4fv = 71;
static const uint16_t GlUniformMatrix2fv = 72;
static const uint16_t GlUniformMatrix3fv = 73;
static const uint16_t GlUniformMatrix4fv = 74;
static const uint16_t GlGetUniformfv = 75;
static const uint16_t GlGetUniformiv = 76;
static const uint16_t GlVertexAttrib1f = 77;
static const uint16_t GlVertexAttrib2f = 78;
static const uint16_t GlVertexAttrib3f = 79;
static const uint16_t GlVertexAttrib4f = 80;
static const uint16_t GlVertexAttrib1fv = 81;
static const uint16_t GlVertexAttrib2fv = 82;
static const uint16_t GlVertexAttrib3fv = 83;
static const uint16_t GlVertexAttrib4fv = 84;
static const uint16_t GlGetShaderPrecisionFormat = 85;
static const uint16_t GlDepthMask = 86;
static const uint16_t GlDepthFunc = 87;
static const uint16_t GlDepthRangef = 88;
static const uint16_t GlColorMask = 89;
static const uint16_t GlStencilMask = 90;
static const uint16_t GlStencilMaskSeparate = 91;
static const uint16_t GlStencilFuncSeparate = 92;
static const uint16_t GlStencilOpSeparate = 93;
static const uint16_t GlFrontFace = 94;
static const uint16_t GlViewport = 95;
static const uint16_t GlScissor = 96;
static const uint16_t GlActiveTexture = 97;
static const uint16_t GlGenTextures = 98;
static const uint16_t GlDeleteTextures = 99;
static const uint16_t GlIsTexture = 100;
static const uint16_t GlBindTexture = 101;
static const uint16_t GlTexImage2D = 102;
static const uint16_t GlTexSubImage2D = 103;
static const uint16_t GlCopyTexImage2D = 104;
static const uint16_t GlCopyTexSubImage2D = 105;
static const uint16_t GlCompressedTexImage2D = 106;
static const uint16_t GlCompressedTexSubImage2D = 107;
static const uint16_t GlGenerateMipmap = 108;
static const uint16_t GlReadPixels = 109;
static const uint16_t GlGenFramebuffers = 110;
static const uint16_t GlBindFramebuffer = 111;
static const uint16_t GlCheckFramebufferStatus = 112;
static const uint16_t GlDeleteFramebuffers = 113;
static const uint16_t GlIsFramebuffer = 114;
static const uint16_t GlGenRenderbuffers = 115;
static const uint16_t GlBindRenderbuffer = 116;
static const uint16_t GlRenderbufferStorage = 117;
static const uint16_t GlDeleteRenderbuffers = 118;
static const uint16_t GlIsRenderbuffer = 119;
static const uint16_t GlGetRenderbufferParameteriv = 120;
static const uint16_t GlGenBuffers = 121;
static const uint16_t GlBindBuffer = 122;
static const uint16_t GlBufferData = 123;
static const uint16_t GlBufferSubData = 124;
static const uint16_t GlDeleteBuffers = 125;
static const uint16_t GlIsBuffer = 126;
static const uint16_t GlGetBufferParameteriv = 127;
static const uint16_t GlCreateShader = 128;
static const uint16_t GlDeleteShader = 129;
static const uint16_t GlShaderSource = 130;
static const uint16_t GlShaderBinary = 131;
static const uint16_t GlGetShaderInfoLog = 132;
static const uint16_t GlGetShaderSource = 133;
static const uint16_t GlReleaseShaderCompiler = 134;
static const uint16_t GlCompileShader = 135;
static const uint16_t GlIsShader = 136;
static const uint16_t GlCreateProgram = 137;
static const uint16_t GlDeleteProgram = 138;
static const uint16_t GlAttachShader = 139;
static const uint16_t GlDetachShader = 140;
static const uint16_t GlGetAttachedShaders = 141;
static const uint16_t GlLinkProgram = 142;
static const uint16_t GlGetProgramInfoLog = 143;
static const uint16_t GlUseProgram = 144;
static const uint16_t GlIsProgram = 145;
static const uint16_t GlValidateProgram = 146;
static const uint16_t GlClearColor = 147;
static const uint16_t GlClearDepthf = 148;
static const uint16_t GlClearStencil = 149;
static const uint16_t GlClear = 150;
static const uint16_t GlCullFace = 151;
static const uint16_t GlPolygonOffset = 152;
static const uint16_t GlLineWidth = 153;
static const uint16_t GlSampleCoverage = 154;
static const uint16_t GlHint = 155;
static const uint16_t GlFramebufferRenderbuffer = 156;
static const uint16_t GlFramebufferTexture2D = 157;
static const uint16_t GlGetFramebufferAttachmentParameteriv = 158;
static const uint16_t GlDrawElements = 159;
static const uint16_t GlDrawArrays = 160;
static const uint16_t GlFlush = 161;
static const uint16_t GlFinish = 162;
static const uint16_t GlGetBooleanv = 163;
static const uint16_t GlGetFloatv = 164;
static const uint16_t GlGetIntegerv = 165;
static const uint16_t GlGetString = 166;
static const uint16_t GlEnable = 167;
static const uint16_t GlDisable = 168;
static const uint16_t GlIsEnabled = 169;
static const uint16_t GlMapBufferRange = 170;
static const uint16_t GlUnmapBuffer = 171;
static const uint16_t GlInvalidateFramebuffer = 172;
static const uint16_t GlRenderbufferStorageMultisample = 173;
static const uint16_t GlBlitFramebuffer = 174;
static const uint16_t GlGenQueries = 175;
static const uint16_t GlBeginQuery = 176;
static const uint16_t GlEndQuery = 177;
static const uint16_t GlDeleteQueries = 178;
static const uint16_t GlIsQuery = 179;
static const uint16_t GlGetQueryiv = 180;
static const uint16_t GlGetQueryObjectuiv = 181;
static const uint16_t GlGenQueriesEXT = 182;
static const uint16_t GlBeginQueryEXT = 183;
static const uint16_t GlEndQueryEXT = 184;
static const uint16_t GlDeleteQueriesEXT = 185;
static const uint16_t GlIsQueryEXT = 186;
static const uint16_t GlQueryCounterEXT = 187;
static const uint16_t GlGetQueryivEXT = 188;
static const uint16_t GlGetQueryObjectivEXT = 189;
static const uint16_t GlGetQueryObjectuivEXT = 190;
static const uint16_t GlGetQueryObjecti64vEXT = 191;
static const uint16_t GlGetQueryObjectui64vEXT = 192;
...
enum class MapBufferTarget : uint32_t {
    GL_ARRAY_BUFFER = 34962,
...
typedef void *(STDCALL *PFNGLMAPBUFFERRANGE)(MapBufferTarget target, int32_t offset, int32_t length,
                                             MapBufferRangeAccess access);
typedef void(STDCALL *PFNGLUNMAPBUFFER)(MapBufferTarget target);
