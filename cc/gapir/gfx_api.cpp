...
namespace gapir {
    namespace gfxapi {
        namespace {
            ...
            bool callGlXCreateNewContext(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , display, fbconfig, type, shared, direct);
            ...
            bool callGlGetProgramBinaryOES(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , program, buffer_size, bytes_written, binary_format, binary);
            ...
            bool callGlBlendFuncSeparate(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , src_factor_rgb, dst_factor_rgb, src_factor_alpha, dst_factor_alpha);
            ...
            bool callGlGetActiveAttrib(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    if (glGetActiveAttrib != nullptr) {
                        glGetActiveAttrib(program, location, buffer_size, buffer_bytes_written, vector_count, type, name);
                    } else {
            ...
            bool callGlGetActiveUniform(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    if (glGetActiveUniform != nullptr) {
                        glGetActiveUniform(program, location, buffer_size, buffer_bytes_written, vector_count, type, name);
                    } else {
            ...
            bool callGlStencilOpSeparate(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , face, stencil_fail, stencil_pass_depth_fail, stencil_pass_depth_pass);
            ...
            bool callGlGetShaderInfoLog(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , shader, buffer_length, string_length_written, info);
            ...
            bool callGlGetShaderSource(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , shader, buffer_length, string_length_written, source);
            ...
            bool callGlGetAttachedShaders(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , program, buffer_length, shaders_length_written, shaders);
            ...
            bool callGlGetProgramInfoLog(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , program, buffer_length, string_length_written, info);
            ...
            bool callGlFramebufferRenderbuffer(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , framebuffer_target, framebuffer_attachment, renderbuffer_target, renderbuffer);
            ...
            bool callGlGetFramebufferAttachmentParameteriv(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , framebuffer_target, attachment, parameter, value);
            ...
            bool callGlGetActiveUniformBlockiv(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , program, uniform_block_index, parameter_name, parameters);
            ...
            bool callGlGetActiveUniformsiv(Stack* stack, bool pushReturn) {
                ...
                if (stack->isValid()) {
                    ...
                    , program, uniform_count, uniform_indices, parameter_name, parameters);
        ...
        void Register(Interpreter* interpreter) {
            ...
            interpreter->registerFunction(Ids::GlEGLImageTargetTexture2DOES, callGlEGLImageTargetTexture2DOES);
            interpreter->registerFunction(Ids::GlEGLImageTargetRenderbufferStorageOES, callGlEGLImageTargetRenderbufferStorageOES);
            interpreter->registerFunction(Ids::GlGetGraphicsResetStatusEXT, callGlGetGraphicsResetStatusEXT);
            ...
            interpreter->registerFunction(Ids::GlGetRenderbufferParameteriv, callGlGetRenderbufferParameteriv);
            ...
            interpreter->registerFunction(Ids::GlGetFramebufferAttachmentParameteriv, callGlGetFramebufferAttachmentParameteriv);
            ...
            interpreter->registerFunction(Ids::GlRenderbufferStorageMultisample, callGlRenderbufferStorageMultisample);
            ...
            interpreter->registerFunction(Ids::GlGetActiveUniformBlockName, callGlGetActiveUniformBlockName);
