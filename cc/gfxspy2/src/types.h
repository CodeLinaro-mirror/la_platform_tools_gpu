...
typedef std::map<uint32_t, bool> Bool_CapabilityMap;
typedef std::map<uint32_t, BufferId> BufferId_BufferTargetMap;
...
typedef std::map<uint32_t, FramebufferAttachmentInfo> FramebufferAttachmentInfo_FramebufferAttachmentMap;
typedef std::map<uint32_t, FramebufferId> FramebufferId_FramebufferTargetMap;
typedef std::map<FramebufferId, std::shared_ptr<Framebuffer>> FramebufferRef_FramebufferIdMap;
typedef std::map<uint32_t, Image> Image_CubeMapImageTargetMap;
...
typedef std::map<uint32_t, RenderbufferId> RenderbufferId_RenderbufferTargetMap;
typedef std::map<RenderbufferId, std::shared_ptr<Renderbuffer>> RenderbufferRef_RenderbufferIdMap;
typedef std::map<uint32_t, int32_t> S32_PixelStoreParameterMap;
typedef std::map<uint32_t, ShaderId> ShaderId_ShaderTypeMap;
typedef std::map<ShaderId, std::shared_ptr<Shader>> ShaderRef_ShaderIdMap;
typedef std::map<uint32_t, TextureId> TextureId_TextureTargetMap;
typedef std::map<uint32_t, TextureId_TextureTargetMap> TextureId_TextureTargetMap_TextureUnitMap;
typedef std::map<TextureId, std::shared_ptr<Texture>> TextureRef_TextureIdMap;
typedef std::map<uint32_t, uint32_t> U32_FaceModeMap;
...
// Classes
struct Color {
    inline Color& SetRed(float v) { this->Red = v; return *this; }
    inline Color& SetGreen(float v) { this->Green = v; return *this; }
    inline Color& SetBlue(float v) { this->Blue = v; return *this; }
    inline Color& SetAlpha(float v) { this->Alpha = v; return *this; }
...
struct Rect {
    inline Rect& SetX(int32_t v) { this->X = v; return *this; }
    inline Rect& SetY(int32_t v) { this->Y = v; return *this; }
    inline Rect& SetWidth(int32_t v) { this->Width = v; return *this; }
    inline Rect& SetHeight(int32_t v) { this->Height = v; return *this; }
...
struct Image {
    inline Image& SetWidth(int32_t v) { this->Width = v; return *this; }
    inline Image& SetHeight(int32_t v) { this->Height = v; return *this; }
    inline Image& SetData(Memory v) { this->Data = v; return *this; }
    inline Image& SetSize(int32_t v) { this->Size = v; return *this; }
    inline Image& SetFormat(uint32_t v) { this->Format = v; return *this; }
...
struct Renderbuffer {
    inline Renderbuffer& SetWidth(int32_t v) { this->Width = v; return *this; }
    inline Renderbuffer& SetHeight(int32_t v) { this->Height = v; return *this; }
    inline Renderbuffer& SetData(Memory v) { this->Data = v; return *this; }
    inline Renderbuffer& SetFormat(uint32_t v) { this->Format = v; return *this; }
...
struct Texture {
    inline Texture& SetKind(uint32_t v) { this->Kind = v; return *this; }
    inline Texture& SetFormat(uint32_t v) { this->Format = v; return *this; }
    inline Texture& SetTexture2D(Image_s32Map v) { this->Texture2D = v; return *this; }
    inline Texture& SetCubemap(CubemapLevel_s32Map v) { this->Cubemap = v; return *this; }
    inline Texture& SetMagFilter(uint32_t v) { this->MagFilter = v; return *this; }
    inline Texture& SetMinFilter(uint32_t v) { this->MinFilter = v; return *this; }
    inline Texture& SetWrapS(uint32_t v) { this->WrapS = v; return *this; }
    inline Texture& SetWrapT(uint32_t v) { this->WrapT = v; return *this; }
    inline Texture& SetSwizzleR(uint32_t v) { this->SwizzleR = v; return *this; }
    inline Texture& SetSwizzleG(uint32_t v) { this->SwizzleG = v; return *this; }
    inline Texture& SetSwizzleB(uint32_t v) { this->SwizzleB = v; return *this; }
    inline Texture& SetSwizzleA(uint32_t v) { this->SwizzleA = v; return *this; }
    inline Texture& SetMaxAnisotropy(float v) { this->MaxAnisotropy = v; return *this; }
...
struct CubemapLevel {
    inline CubemapLevel& SetFaces(Image_CubeMapImageTargetMap v) { this->Faces = v; return *this; }

    Image_CubeMapImageTargetMap Faces;
};

struct FramebufferAttachmentInfo {
    inline FramebufferAttachmentInfo& SetObject(uint32_t v) { this->Object = v; return *this; }
    inline FramebufferAttachmentInfo& SetType(uint32_t v) { this->Type = v; return *this; }
    inline FramebufferAttachmentInfo& SetTextureLevel(int32_t v) { this->TextureLevel = v; return *this; }
    inline FramebufferAttachmentInfo& SetCubeMapFace(uint32_t v) { this->CubeMapFace = v; return *this; }
...
struct Framebuffer {
    inline Framebuffer& SetAttachments(FramebufferAttachmentInfo_FramebufferAttachmentMap v) { this->Attachments = v; return *this; }

    FramebufferAttachmentInfo_FramebufferAttachmentMap Attachments;
};

struct Buffer {
    inline Buffer& SetData(Memory v) { this->Data = v; return *this; }
    inline Buffer& SetSize(int32_t v) { this->Size = v; return *this; }
    inline Buffer& SetUsage(uint32_t v) { this->Usage = v; return *this; }
...
struct Shader {
    inline Shader& SetBinary(Memory v) { this->Binary = v; return *this; }
    inline Shader& SetCompiled(bool v) { this->Compiled = v; return *this; }
    inline Shader& SetDeletable(bool v) { this->Deletable = v; return *this; }
    inline Shader& SetInfoLog(const char* v) { this->InfoLog = v; return *this; }
    inline Shader& SetSource(const char** v) { this->Source = v; return *this; }
    inline Shader& SetType(uint32_t v) { this->Type = v; return *this; }
...
struct VertexAttribute {
    inline VertexAttribute& SetName(const char* v) { this->Name = v; return *this; }
    inline VertexAttribute& SetVectorCount(int32_t v) { this->VectorCount = v; return *this; }
    inline VertexAttribute& SetType(uint32_t v) { this->Type = v; return *this; }
...
struct Vec2i {
    inline Vec2i& SetX(int32_t v) { this->X = v; return *this; }
    inline Vec2i& SetY(int32_t v) { this->Y = v; return *this; }
...
struct Vec3i {
    inline Vec3i& SetX(int32_t v) { this->X = v; return *this; }
    inline Vec3i& SetY(int32_t v) { this->Y = v; return *this; }
    inline Vec3i& SetZ(int32_t v) { this->Z = v; return *this; }
...
struct Vec4i {
    inline Vec4i& SetX(int32_t v) { this->X = v; return *this; }
    inline Vec4i& SetY(int32_t v) { this->Y = v; return *this; }
    inline Vec4i& SetZ(int32_t v) { this->Z = v; return *this; }
    inline Vec4i& SetW(int32_t v) { this->W = v; return *this; }
...
struct Vec2f {
    inline Vec2f& SetX(float v) { this->X = v; return *this; }
    inline Vec2f& SetY(float v) { this->Y = v; return *this; }
...
struct Vec3f {
    inline Vec3f& SetX(float v) { this->X = v; return *this; }
    inline Vec3f& SetY(float v) { this->Y = v; return *this; }
    inline Vec3f& SetZ(float v) { this->Z = v; return *this; }
...
struct Vec4f {
    inline Vec4f& SetX(float v) { this->X = v; return *this; }
    inline Vec4f& SetY(float v) { this->Y = v; return *this; }
    inline Vec4f& SetZ(float v) { this->Z = v; return *this; }
    inline Vec4f& SetW(float v) { this->W = v; return *this; }
...
struct Mat2f {
    inline Mat2f& SetCol0(Vec2f v) { this->Col0 = v; return *this; }
    inline Mat2f& SetCol1(Vec2f v) { this->Col1 = v; return *this; }
...
struct Mat3f {
    inline Mat3f& SetCol0(Vec3f v) { this->Col0 = v; return *this; }
    inline Mat3f& SetCol1(Vec3f v) { this->Col1 = v; return *this; }
    inline Mat3f& SetCol2(Vec3f v) { this->Col2 = v; return *this; }
...
struct Mat4f {
    inline Mat4f& SetCol0(Vec4f v) { this->Col0 = v; return *this; }
    inline Mat4f& SetCol1(Vec4f v) { this->Col1 = v; return *this; }
    inline Mat4f& SetCol2(Vec4f v) { this->Col2 = v; return *this; }
    inline Mat4f& SetCol3(Vec4f v) { this->Col3 = v; return *this; }
...
struct UniformValue {
    inline UniformValue& SetF32(float v) { this->F32 = v; return *this; }
    inline UniformValue& SetVec2f(Vec2f v) { this->Vec2f = v; return *this; }
    inline UniformValue& SetVec3f(Vec3f v) { this->Vec3f = v; return *this; }
    inline UniformValue& SetVec4f(Vec4f v) { this->Vec4f = v; return *this; }
    inline UniformValue& SetS32(int32_t v) { this->S32 = v; return *this; }
    inline UniformValue& SetVec2i(Vec2i v) { this->Vec2i = v; return *this; }
    inline UniformValue& SetVec3i(Vec3i v) { this->Vec3i = v; return *this; }
    inline UniformValue& SetVec4i(Vec4i v) { this->Vec4i = v; return *this; }
    inline UniformValue& SetMat2f(Mat2f v) { this->Mat2f = v; return *this; }
    inline UniformValue& SetMat3f(Mat3f v) { this->Mat3f = v; return *this; }
    inline UniformValue& SetMat4f(Mat4f v) { this->Mat4f = v; return *this; }
...
struct Uniform {
    inline Uniform& SetName(const char* v) { this->Name = v; return *this; }
    inline Uniform& SetType(uint32_t v) { this->Type = v; return *this; }
    inline Uniform& SetValue(UniformValue v) { this->Value = v; return *this; }
...
struct Program {
    inline Program& SetShaders(ShaderId_ShaderTypeMap v) { this->Shaders = v; return *this; }
    inline Program& SetLinked(bool v) { this->Linked = v; return *this; }
    inline Program& SetBinary(Memory v) { this->Binary = v; return *this; }
    inline Program& SetAttributeBindings(AttributeLocation_stringMap v) { this->AttributeBindings = v; return *this; }
    inline Program& SetAttributes(VertexAttribute_s32Map v) { this->Attributes = v; return *this; }
    inline Program& SetUniforms(Uniform_UniformLocationMap v) { this->Uniforms = v; return *this; }
    inline Program& SetInfoLog(const char* v) { this->InfoLog = v; return *this; }
...
struct VertexAttributeArray {
    inline VertexAttributeArray& SetEnabled(bool v) { this->Enabled = v; return *this; }
    inline VertexAttributeArray& SetSize(int32_t v) { this->Size = v; return *this; }
    inline VertexAttributeArray& SetType(uint32_t v) { this->Type = v; return *this; }
    inline VertexAttributeArray& SetNormalized(bool v) { this->Normalized = v; return *this; }
    inline VertexAttributeArray& SetStride(int32_t v) { this->Stride = v; return *this; }
    inline VertexAttributeArray& SetBuffer(BufferId v) { this->Buffer = v; return *this; }
    inline VertexAttributeArray& SetPointer(void* v) { this->Pointer = v; return *this; }
...
struct BlendState {
    inline BlendState& SetSrcRgbBlendFactor(uint32_t v) { this->SrcRgbBlendFactor = v; return *this; }
    inline BlendState& SetSrcAlphaBlendFactor(uint32_t v) { this->SrcAlphaBlendFactor = v; return *this; }
    inline BlendState& SetDstRgbBlendFactor(uint32_t v) { this->DstRgbBlendFactor = v; return *this; }
    inline BlendState& SetDstAlphaBlendFactor(uint32_t v) { this->DstAlphaBlendFactor = v; return *this; }
    inline BlendState& SetBlendEquationRgb(uint32_t v) { this->BlendEquationRgb = v; return *this; }
    inline BlendState& SetBlendEquationAlpha(uint32_t v) { this->BlendEquationAlpha = v; return *this; }
    inline BlendState& SetBlendColor(Color v) { this->BlendColor = v; return *this; }
...
struct RasterizerState {
    inline RasterizerState& SetDepthMask(bool v) { this->DepthMask = v; return *this; }
    inline RasterizerState& SetDepthTestFunction(uint32_t v) { this->DepthTestFunction = v; return *this; }
    inline RasterizerState& SetDepthNear(float v) { this->DepthNear = v; return *this; }
    inline RasterizerState& SetDepthFar(float v) { this->DepthFar = v; return *this; }
    inline RasterizerState& SetColorMaskRed(bool v) { this->ColorMaskRed = v; return *this; }
    inline RasterizerState& SetColorMaskGreen(bool v) { this->ColorMaskGreen = v; return *this; }
    inline RasterizerState& SetColorMaskBlue(bool v) { this->ColorMaskBlue = v; return *this; }
    inline RasterizerState& SetColorMaskAlpha(bool v) { this->ColorMaskAlpha = v; return *this; }
    inline RasterizerState& SetStencilMask(U32_FaceModeMap v) { this->StencilMask = v; return *this; }
    inline RasterizerState& SetViewport(Rect v) { this->Viewport = v; return *this; }
    inline RasterizerState& SetScissor(Rect v) { this->Scissor = v; return *this; }
    inline RasterizerState& SetFrontFace(uint32_t v) { this->FrontFace = v; return *this; }
    inline RasterizerState& SetCullFace(uint32_t v) { this->CullFace = v; return *this; }
    inline RasterizerState& SetLineWidth(float v) { this->LineWidth = v; return *this; }
    inline RasterizerState& SetPolygonOffsetFactor(float v) { this->PolygonOffsetFactor = v; return *this; }
    inline RasterizerState& SetPolygonOffsetUnits(float v) { this->PolygonOffsetUnits = v; return *this; }
    inline RasterizerState& SetSampleCoverageValue(float v) { this->SampleCoverageValue = v; return *this; }
    inline RasterizerState& SetSampleCoverageInvert(bool v) { this->SampleCoverageInvert = v; return *this; }
...
struct ClearState {
    inline ClearState& SetClearColor(Color v) { this->ClearColor = v; return *this; }
    inline ClearState& SetClearDepth(float v) { this->ClearDepth = v; return *this; }
    inline ClearState& SetClearStencil(int32_t v) { this->ClearStencil = v; return *this; }
...
struct InternalState {
    inline InternalState& SetNilBuffer(BufferId v) { this->NilBuffer = v; return *this; }
    inline InternalState& SetNilTexture(TextureId v) { this->NilTexture = v; return *this; }
    inline InternalState& SetNilRenderbuffer(RenderbufferId v) { this->NilRenderbuffer = v; return *this; }
    inline InternalState& SetBackbuffer(FramebufferId v) { this->Backbuffer = v; return *this; }
...
struct Objects {
    inline Objects& SetRenderbuffers(RenderbufferRef_RenderbufferIdMap v) { this->Renderbuffers = v; return *this; }
    inline Objects& SetTextures(TextureRef_TextureIdMap v) { this->Textures = v; return *this; }
    inline Objects& SetFramebuffers(FramebufferRef_FramebufferIdMap v) { this->Framebuffers = v; return *this; }
    inline Objects& SetBuffers(BufferRef_BufferIdMap v) { this->Buffers = v; return *this; }
    inline Objects& SetShaders(ShaderRef_ShaderIdMap v) { this->Shaders = v; return *this; }
    inline Objects& SetPrograms(ProgramRef_ProgramIdMap v) { this->Programs = v; return *this; }
    inline Objects& SetVertexArrays(VertexArrayRef_VertexArrayIdMap v) { this->VertexArrays = v; return *this; }
    inline Objects& SetQueries(QueryRef_QueryIdMap v) { this->Queries = v; return *this; }
