...
void __stdcall eglMakeCurrent(int32_t context) { spy()->eglMakeCurrent(context); }
void __stdcall eglSwapBuffers() { spy()->eglSwapBuffers(); }
void __stdcall wglSwapBuffers(HDC hdc) { spy()->wglSwapBuffers(hdc); }
void __stdcall glEnableClientState(uint32_t type) { spy()->glEnableClientState(type); }
void __stdcall glDisableClientState(uint32_t type) { spy()->glDisableClientState(type); }
void __stdcall glGetProgramBinaryOES(ProgramId program, int32_t buffer_size, int32_t* bytes_written,
                                     uint32_t* binary_format, void* binary) {
    spy()->glGetProgramBinaryOES(program, buffer_size, bytes_written, binary_format, binary);
}
void __stdcall glProgramBinaryOES(ProgramId program, uint32_t binary_format, const void* binary,
                                  int32_t binary_size) {
    spy()->glProgramBinaryOES(program, binary_format, binary, binary_size);
}
void __stdcall glStartTilingQCOM(int32_t x, int32_t y, int32_t width, int32_t height,
                                 uint32_t preserveMask) {
    spy()->glStartTilingQCOM(x, y, width, height, preserveMask);
}
void __stdcall glEndTilingQCOM(uint32_t preserve_mask) { spy()->glEndTilingQCOM(preserve_mask); }
void __stdcall glDiscardFramebufferEXT(uint32_t target, int32_t numAttachments,
...
void __stdcall glPopGroupMarkerEXT() { spy()->glPopGroupMarkerEXT(); }
...
void __stdcall glTexStorage2DEXT(uint32_t target, int32_t levels, uint32_t format, int32_t width,
                                 int32_t height) {
    spy()->glTexStorage2DEXT(target, levels, format, width, height);
}
void __stdcall glTexStorage3DEXT(uint32_t target, int32_t levels, uint32_t format, int32_t width,
                                 int32_t height, int32_t depth) {
    spy()->glTexStorage3DEXT(target, levels, format, width, height, depth);
}
void __stdcall glTextureStorage1DEXT(TextureId texture, uint32_t target, int32_t levels,
                                     uint32_t format, int32_t width) {
    spy()->glTextureStorage1DEXT(texture, target, levels, format, width);
}
void __stdcall glTextureStorage2DEXT(TextureId texture, uint32_t target, int32_t levels,
                                     uint32_t format, int32_t width, int32_t height) {
    spy()->glTextureStorage2DEXT(texture, target, levels, format, width, height);
}
void __stdcall glTextureStorage3DEXT(TextureId texture, uint32_t target, int32_t levels,
                                     uint32_t format, int32_t width, int32_t height,
                                     int32_t depth) {
...
void __stdcall glBindVertexArrayOES(VertexArrayId array) { spy()->glBindVertexArrayOES(array); }
void __stdcall glDeleteVertexArraysOES(int32_t count, const VertexArrayId* arrays) {
    spy()->glDeleteVertexArraysOES(count, arrays);
}
bool __stdcall glIsVertexArrayOES(VertexArrayId array) { return spy()->glIsVertexArrayOES(array); }
...
uint32_t __stdcall glGetGraphicsResetStatusEXT() { return spy()->glGetGraphicsResetStatusEXT(); }
void __stdcall glBindAttribLocation(ProgramId program, AttributeLocation location,
                                    const char* name) {
...
void __stdcall glBlendFuncSeparate(uint32_t src_factor_rgb, uint32_t dst_factor_rgb,
...
void __stdcall glBlendEquation(uint32_t equation) { spy()->glBlendEquation(equation); }
...
void __stdcall glVertexAttribPointer(AttributeLocation location, int32_t size, uint32_t type,
                                     bool normalized, int32_t stride, VertexPointer data) {
    spy()->glVertexAttribPointer(location, size, type, normalized, stride, data);
}
void __stdcall glGetActiveAttrib(ProgramId program, AttributeLocation location, int32_t buffer_size,
...
void __stdcall glGetActiveUniform(ProgramId program, int32_t location, int32_t buffer_size,
...
uint32_t __stdcall glGetError() { return spy()->glGetError(); }
...
void __stdcall glUniform3i(UniformLocation location, int32_t value0, int32_t value1,
                           int32_t value2) {
    spy()->glUniform3i(location, value0, value1, value2);
}
void __stdcall glUniform4i(UniformLocation location, int32_t value0, int32_t value1, int32_t value2,
                           int32_t value3) {
    spy()->glUniform4i(location, value0, value1, value2, value3);
}
void __stdcall glUniform1iv(UniformLocation location, int32_t count, const int32_t* value) {
    spy()->glUniform1iv(location, count, value);
}
void __stdcall glUniform2iv(UniformLocation location, int32_t count, const int32_t* value) {
    spy()->glUniform2iv(location, count, value);
}
void __stdcall glUniform3iv(UniformLocation location, int32_t count, const int32_t* value) {
    spy()->glUniform3iv(location, count, value);
}
void __stdcall glUniform4iv(UniformLocation location, int32_t count, const int32_t* value) {
...
void __stdcall glUniform4f(UniformLocation location, float value0, float value1, float value2,
                           float value3) {
    spy()->glUniform4f(location, value0, value1, value2, value3);
}
void __stdcall glUniform1fv(UniformLocation location, int32_t count, const float* value) {
    spy()->glUniform1fv(location, count, value);
}
void __stdcall glUniform2fv(UniformLocation location, int32_t count, const float* value) {
    spy()->glUniform2fv(location, count, value);
}
void __stdcall glUniform3fv(UniformLocation location, int32_t count, const float* value) {
    spy()->glUniform3fv(location, count, value);
}
void __stdcall glUniform4fv(UniformLocation location, int32_t count, const float* value) {
    spy()->glUniform4fv(location, count, value);
}
void __stdcall glUniformMatrix2fv(UniformLocation location, int32_t count, bool transpose,
                                  const float* values) {
    spy()->glUniformMatrix2fv(location, count, transpose, values);
}
void __stdcall glUniformMatrix3fv(UniformLocation location, int32_t count, bool transpose,
                                  const float* values) {
    spy()->glUniformMatrix3fv(location, count, transpose, values);
}
void __stdcall glUniformMatrix4fv(UniformLocation location, int32_t count, bool transpose,
                                  const float* values) {
    spy()->glUniformMatrix4fv(location, count, transpose, values);
}
void __stdcall glGetUniformfv(ProgramId program, UniformLocation location, const float* values) {
    spy()->glGetUniformfv(program, location, values);
}
void __stdcall glGetUniformiv(ProgramId program, UniformLocation location, const int32_t* values) {
...
void __stdcall glVertexAttrib3f(AttributeLocation location, float value0, float value1,
                                float value2) {
    spy()->glVertexAttrib3f(location, value0, value1, value2);
}
void __stdcall glVertexAttrib4f(AttributeLocation location, float value0, float value1,
                                float value2, float value3) {
    spy()->glVertexAttrib4f(location, value0, value1, value2, value3);
}
void __stdcall glVertexAttrib1fv(AttributeLocation location, const float* value) {
    spy()->glVertexAttrib1fv(location, value);
}
void __stdcall glVertexAttrib2fv(AttributeLocation location, const float* value) {
    spy()->glVertexAttrib2fv(location, value);
}
void __stdcall glVertexAttrib3fv(AttributeLocation location, const float* value) {
    spy()->glVertexAttrib3fv(location, value);
}
void __stdcall glVertexAttrib4fv(AttributeLocation location, const float* value) {
    spy()->glVertexAttrib4fv(location, value);
}
void __stdcall glGetShaderPrecisionFormat(uint32_t shader_type, uint32_t precision_type,
                                          int32_t* range, int32_t* precision) {
    spy()->glGetShaderPrecisionFormat(shader_type, precision_type, range, precision);
}
void __stdcall glDepthMask(bool enabled) { spy()->glDepthMask(enabled); }
void __stdcall glDepthFunc(uint32_t function) { spy()->glDepthFunc(function); }
void __stdcall glDepthRangef(float near, float far) { spy()->glDepthRangef(near, far); }
void __stdcall glColorMask(bool red, bool green, bool blue, bool alpha) {
    spy()->glColorMask(red, green, blue, alpha);
}
void __stdcall glStencilMask(uint32_t mask) { spy()->glStencilMask(mask); }
void __stdcall glStencilMaskSeparate(uint32_t face, uint32_t mask) {
    spy()->glStencilMaskSeparate(face, mask);
}
void __stdcall glStencilFuncSeparate(uint32_t face, uint32_t function, int32_t reference_value,
                                     int32_t mask) {
    spy()->glStencilFuncSeparate(face, function, reference_value, mask);
}
void __stdcall glStencilOpSeparate(uint32_t face, uint32_t stencil_fail,
...
void __stdcall glFrontFace(uint32_t orientation) { spy()->glFrontFace(orientation); }
...
void __stdcall glActiveTexture(uint32_t unit) { spy()->glActiveTexture(unit); }
void __stdcall glGenTextures(int32_t count, TextureId* textures) {
    spy()->glGenTextures(count, textures);
}
void __stdcall glDeleteTextures(int32_t count, const TextureId* textures) {
    spy()->glDeleteTextures(count, textures);
}
bool __stdcall glIsTexture(TextureId texture) { return spy()->glIsTexture(texture); }
void __stdcall glBindTexture(uint32_t target, TextureId texture) {
    spy()->glBindTexture(target, texture);
}
void __stdcall glTexImage2D(uint32_t target, int32_t level, uint32_t internal_format, int32_t width,
...
void __stdcall glTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset,
...
void __stdcall glCopyTexImage2D(uint32_t target, int32_t level, uint32_t format, int32_t x,
                                int32_t y, int32_t width, int32_t height, int32_t border) {
    spy()->glCopyTexImage2D(target, level, format, x, y, width, height, border);
}
void __stdcall glCopyTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset,
                                   int32_t x, int32_t y, int32_t width, int32_t height) {
    spy()->glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y, width, height);
}
void __stdcall glCompressedTexImage2D(uint32_t target, int32_t level, uint32_t format,
...
void __stdcall glCompressedTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset,
...
void __stdcall glGenerateMipmap(uint32_t target) { spy()->glGenerateMipmap(target); }
void __stdcall glReadPixels(int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format,
...
void __stdcall glDeleteFramebuffers(int32_t count, const FramebufferId* framebuffers) {
...
void __stdcall glRenderbufferStorage(uint32_t target, uint32_t format, int32_t width,
                                     int32_t height) {
    spy()->glRenderbufferStorage(target, format, width, height);
}
void __stdcall glDeleteRenderbuffers(int32_t count, const RenderbufferId* renderbuffers) {
...
void __stdcall glBufferSubData(uint32_t target, int32_t offset, int32_t size, const void* data) {
    spy()->glBufferSubData(target, offset, size, data);
}
void __stdcall glDeleteBuffers(int32_t count, const BufferId* buffers) {
    spy()->glDeleteBuffers(count, buffers);
}
bool __stdcall glIsBuffer(BufferId buffer) { return spy()->glIsBuffer(buffer); }
...
ShaderId __stdcall glCreateShader(uint32_t type) { return spy()->glCreateShader(type); }
void __stdcall glDeleteShader(ShaderId shader) { spy()->glDeleteShader(shader); }
void __stdcall glShaderSource(ShaderId shader, int32_t count, const char** source,
                              const int32_t* length) {
    spy()->glShaderSource(shader, count, source, length);
}
void __stdcall glShaderBinary(int32_t count, const ShaderId* shaders, uint32_t binary_format,
                              const void* binary, int32_t binary_size) {
    spy()->glShaderBinary(count, shaders, binary_format, binary, binary_size);
}
void __stdcall glGetShaderInfoLog(ShaderId shader, int32_t buffer_length,
                                  int32_t* string_length_written, char* info) {
    spy()->glGetShaderInfoLog(shader, buffer_length, string_length_written, info);
}
void __stdcall glGetShaderSource(ShaderId shader, int32_t buffer_length,
                                 int32_t* string_length_written, char* source) {
    spy()->glGetShaderSource(shader, buffer_length, string_length_written, source);
}
void __stdcall glReleaseShaderCompiler() { spy()->glReleaseShaderCompiler(); }
void __stdcall glCompileShader(ShaderId shader) { spy()->glCompileShader(shader); }
bool __stdcall glIsShader(ShaderId shader) { return spy()->glIsShader(shader); }
ProgramId __stdcall glCreateProgram() { return spy()->glCreateProgram(); }
void __stdcall glDeleteProgram(ProgramId program) { spy()->glDeleteProgram(program); }
...
void __stdcall glGetAttachedShaders(ProgramId program, int32_t buffer_length,
...
void __stdcall glLinkProgram(ProgramId program) { spy()->glLinkProgram(program); }
void __stdcall glGetProgramInfoLog(ProgramId program, int32_t buffer_length,
                                   int32_t* string_length_written, char* info) {
    spy()->glGetProgramInfoLog(program, buffer_length, string_length_written, info);
}
void __stdcall glUseProgram(ProgramId program) { spy()->glUseProgram(program); }
bool __stdcall glIsProgram(ProgramId program) { return spy()->glIsProgram(program); }
void __stdcall glValidateProgram(ProgramId program) { spy()->glValidateProgram(program); }
void __stdcall glClearColor(float r, float g, float b, float a) { spy()->glClearColor(r, g, b, a); }
void __stdcall glClearDepthf(float depth) { spy()->glClearDepthf(depth); }
void __stdcall glClearStencil(int32_t stencil) { spy()->glClearStencil(stencil); }
void __stdcall glClear(uint32_t mask) { spy()->glClear(mask); }
void __stdcall glCullFace(uint32_t mode) { spy()->glCullFace(mode); }
void __stdcall glPolygonOffset(float scale_factor, float units) {
    spy()->glPolygonOffset(scale_factor, units);
}
void __stdcall glLineWidth(float width) { spy()->glLineWidth(width); }
void __stdcall glSampleCoverage(float value, bool invert) {
    spy()->glSampleCoverage(value, invert);
}
void __stdcall glHint(uint32_t target, uint32_t mode) { spy()->glHint(target, mode); }
void __stdcall glFramebufferRenderbuffer(uint32_t framebuffer_target,
...
void __stdcall glFramebufferTexture2D(uint32_t framebuffer_target, uint32_t framebuffer_attachment,
...
void __stdcall glGetFramebufferAttachmentParameteriv(uint32_t framebuffer_target,
...
void __stdcall glDrawElements(uint32_t draw_mode, int32_t element_count, uint32_t indices_type,
...
void __stdcall glFlush() { spy()->glFlush(); }
void __stdcall glFinish() { spy()->glFinish(); }
void __stdcall glGetBooleanv(uint32_t param, bool* values) { spy()->glGetBooleanv(param, values); }
void __stdcall glGetFloatv(uint32_t param, float* values) { spy()->glGetFloatv(param, values); }
void __stdcall glGetIntegerv(uint32_t param, int32_t* values) {
    spy()->glGetIntegerv(param, values);
}
char* __stdcall glGetString(uint32_t param) { return spy()->glGetString(param); }
void __stdcall glEnable(uint32_t capability) { spy()->glEnable(capability); }
void __stdcall glDisable(uint32_t capability) { spy()->glDisable(capability); }
bool __stdcall glIsEnabled(uint32_t capability) { return spy()->glIsEnabled(capability); }
...
void __stdcall glUnmapBuffer(uint32_t target) { spy()->glUnmapBuffer(target); }
void __stdcall glInvalidateFramebuffer(uint32_t target, int32_t count,
                                       const uint32_t* attachments) {
    spy()->glInvalidateFramebuffer(target, count, attachments);
}
void __stdcall glRenderbufferStorageMultisample(uint32_t target, int32_t samples, uint32_t format,
                                                int32_t width, int32_t height) {
    spy()->glRenderbufferStorageMultisample(target, samples, format, width, height);
}
void __stdcall glBlitFramebuffer(int32_t srcX0, int32_t srcY0, int32_t srcX1, int32_t srcY1,
...
void __stdcall glBeginQuery(uint32_t target, QueryId query) { spy()->glBeginQuery(target, query); }
void __stdcall glEndQuery(uint32_t target) { spy()->glEndQuery(target); }
void __stdcall glDeleteQueries(int32_t count, const QueryId* queries) {
    spy()->glDeleteQueries(count, queries);
}
bool __stdcall glIsQuery(QueryId query) { return spy()->glIsQuery(query); }
...
void __stdcall glEndQueryEXT(uint32_t target) { spy()->glEndQueryEXT(target); }
void __stdcall glDeleteQueriesEXT(int32_t count, const QueryId* queries) {
    spy()->glDeleteQueriesEXT(count, queries);
}
bool __stdcall glIsQueryEXT(QueryId query) { return spy()->glIsQueryEXT(query); }
