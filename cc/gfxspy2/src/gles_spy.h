...
public:
    ...
    inline void eglInitialize(EGLDisplay display, int32_t* major, int32_t* minor);
...
inline void GlesSpy::eglInitialize(EGLDisplay display, int32_t* major, int32_t* minor) {
    mImports.eglInitialize(display, major, minor);
    mState.eglInitialize(display, major, minor);
