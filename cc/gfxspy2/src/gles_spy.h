...
inline GlesSpy::GlesSpy(gapic::Encoder* encoder) : mEncoder(encoder) {
    mState.read = std::bind(&GlesSpy::observe, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    mState.write = std::bind(&GlesSpy::observe, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    mImports.Resolve();
    // HACK TODO: Remove
...
inline void GlesSpy::glGetProgramBinaryOES(ProgramId program, int32_t buffer_size, int32_t* bytes_written, uint32_t* binary_format, void* binary) {
...
inline void GlesSpy::glProgramBinaryOES(ProgramId program, uint32_t binary_format, void* binary, int32_t binary_size) {
...
inline void GlesSpy::glTextureStorage1DEXT(TextureId texture, uint32_t target, int32_t levels, uint32_t format, int32_t width) {
...
inline void GlesSpy::glTextureStorage2DEXT(TextureId texture, uint32_t target, int32_t levels, uint32_t format, int32_t width, int32_t height) {
...
inline void GlesSpy::glTextureStorage3DEXT(TextureId texture, uint32_t target, int32_t levels, uint32_t format, int32_t width, int32_t height, int32_t depth) {
...
inline void GlesSpy::glDeleteVertexArraysOES(int32_t count, VertexArrayId* arrays) {
...
inline void GlesSpy::glBindAttribLocation(ProgramId program, AttributeLocation location, const char* name) {
...
inline void GlesSpy::glVertexAttribPointer(AttributeLocation location, int32_t size, uint32_t type, bool normalized, int32_t stride, VertexPointer data) {
...
inline void GlesSpy::glGetActiveAttrib(ProgramId program, AttributeLocation location, int32_t buffer_size, int32_t* buffer_bytes_written, int32_t* vector_count, uint32_t* type, const char* name) {
...
inline void GlesSpy::glGetActiveUniform(ProgramId program, int32_t location, int32_t buffer_size, int32_t* buffer_bytes_written, int32_t* size, uint32_t* type, const char* name) {
...
inline void GlesSpy::glUniform3i(UniformLocation location, int32_t value0, int32_t value1, int32_t value2) {
...
inline void GlesSpy::glUniform4i(UniformLocation location, int32_t value0, int32_t value1, int32_t value2, int32_t value3) {
...
inline void GlesSpy::glUniform1iv(UniformLocation location, int32_t count, int32_t* value) {
...
inline void GlesSpy::glUniform2iv(UniformLocation location, int32_t count, int32_t* value) {
...
inline void GlesSpy::glUniform3iv(UniformLocation location, int32_t count, int32_t* value) {
...
inline void GlesSpy::glUniform4iv(UniformLocation location, int32_t count, int32_t* value) {
...
inline void GlesSpy::glUniform3f(UniformLocation location, float value0, float value1, float value2) {
...
inline void GlesSpy::glUniform4f(UniformLocation location, float value0, float value1, float value2, float value3) {
...
inline void GlesSpy::glUniform1fv(UniformLocation location, int32_t count, float* value) {
...
inline void GlesSpy::glUniform2fv(UniformLocation location, int32_t count, float* value) {
...
inline void GlesSpy::glUniform3fv(UniformLocation location, int32_t count, float* value) {
...
inline void GlesSpy::glUniform4fv(UniformLocation location, int32_t count, float* value) {
...
inline void GlesSpy::glUniformMatrix2fv(UniformLocation location, int32_t count, bool transpose, float* values) {
...
inline void GlesSpy::glUniformMatrix3fv(UniformLocation location, int32_t count, bool transpose, float* values) {
...
inline void GlesSpy::glUniformMatrix4fv(UniformLocation location, int32_t count, bool transpose, float* values) {
...
inline void GlesSpy::glGetUniformfv(ProgramId program, UniformLocation location, float* values) {
...
inline void GlesSpy::glGetUniformiv(ProgramId program, UniformLocation location, int32_t* values) {
...
inline void GlesSpy::glVertexAttrib3f(AttributeLocation location, float value0, float value1, float value2) {
...
inline void GlesSpy::glVertexAttrib4f(AttributeLocation location, float value0, float value1, float value2, float value3) {
...
inline void GlesSpy::glVertexAttrib1fv(AttributeLocation location, float* value) {
...
inline void GlesSpy::glVertexAttrib2fv(AttributeLocation location, float* value) {
...
inline void GlesSpy::glVertexAttrib3fv(AttributeLocation location, float* value) {
...
inline void GlesSpy::glVertexAttrib4fv(AttributeLocation location, float* value) {
...
inline void GlesSpy::glDeleteTextures(int32_t count, TextureId* textures) {
...
inline void GlesSpy::glTexImage2D(uint32_t target, int32_t level, uint32_t internal_format, int32_t width, int32_t height, int32_t border, uint32_t format, uint32_t type, TexturePointer data) {
...
inline void GlesSpy::glTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, uint32_t type, TexturePointer data) {
...
inline void GlesSpy::glCompressedTexImage2D(uint32_t target, int32_t level, uint32_t format, int32_t width, int32_t height, int32_t border, int32_t image_size, TexturePointer data) {
...
inline void GlesSpy::glCompressedTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, int32_t image_size, TexturePointer data) {
...
inline void GlesSpy::glDeleteFramebuffers(int32_t count, FramebufferId* framebuffers) {
...
inline void GlesSpy::glDeleteRenderbuffers(int32_t count, RenderbufferId* renderbuffers) {
...
inline void GlesSpy::glBufferData(uint32_t target, int32_t size, BufferDataPointer data, uint32_t usage) {
...
inline void GlesSpy::glDeleteBuffers(int32_t count, BufferId* buffers) {
...
inline void GlesSpy::glShaderSource(ShaderId shader, int32_t count, const char** source, int32_t* length) {
...
inline void GlesSpy::glShaderBinary(int32_t count, ShaderId* shaders, uint32_t binary_format, void* binary, int32_t binary_size) {
...
inline void GlesSpy::glGetShaderInfoLog(ShaderId shader, int32_t buffer_length, int32_t* string_length_written, const char* info) {
...
inline void GlesSpy::glGetShaderSource(ShaderId shader, int32_t buffer_length, int32_t* string_length_written, const char* source) {
...
inline void GlesSpy::glGetAttachedShaders(ProgramId program, int32_t buffer_length, int32_t* shaders_length_written, ShaderId* shaders) {
...
inline void GlesSpy::glGetProgramInfoLog(ProgramId program, int32_t buffer_length, int32_t* string_length_written, const char* info) {
...
inline void GlesSpy::glFramebufferRenderbuffer(uint32_t framebuffer_target, uint32_t framebuffer_attachment, uint32_t renderbuffer_target, RenderbufferId renderbuffer) {
...
inline void GlesSpy::glFramebufferTexture2D(uint32_t framebuffer_target, uint32_t framebuffer_attachment, uint32_t texture_target, TextureId texture, int32_t level) {
...
inline void GlesSpy::glDrawElements(uint32_t draw_mode, int32_t element_count, uint32_t indices_type, IndicesPointer indices) {
...
inline const char* GlesSpy::glGetString(uint32_t param) {
...
inline void GlesSpy::glDeleteQueries(int32_t count, QueryId* queries) {
...
inline void GlesSpy::glDeleteQueriesEXT(int32_t count, QueryId* queries) {
