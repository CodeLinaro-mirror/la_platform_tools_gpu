...
public:
    ...
    inline EGLContext eglCreateContext(EGLDisplay display, EGLConfig config,
                                       EGLContext share_context, const EGLint* attrib_list);
    inline EGLBoolean eglMakeCurrent(EGLDisplay display, EGLSurface draw, EGLSurface read,
                                     EGLContext context);
    inline EGLBoolean eglSwapBuffers(EGLDisplay display, const void* surface);
    inline GLXContext glXCreateContext(const void* dpy, const void* vis, GLXContext shareList,
                                       bool direct);
    inline GLXContext glXCreateNewContext(const void* display, const void* fbconfig, uint32_t type,
                                          GLXContext shared, bool direct);
    inline void glXMakeContextCurrent(const void* display, GLXDrawable draw, GLXDrawable read,
                                      GLXContext ctx);
    inline void glXSwapBuffers(const void* display, GLXDrawable drawable);
    inline HGLRC wglCreateContext(HDC hdc);
    inline BOOL wglMakeCurrent(HDC hdc, HGLRC hglrc);
    inline void wglSwapBuffers(HDC hdc);
    inline CGLError CGLCreateContext(CGLPixelFormatObj pix, CGLContextObj share, CGLContextObj ctx);
...
private:
    ...
    static const gapic::Id EGL_INITIALIZE_ID;
    ...
    static const gapic::Id GL_X_CREATE_CONTEXT_ID;
    static const gapic::Id GL_X_CREATE_NEW_CONTEXT_ID;
    static const gapic::Id GL_X_MAKE_CONTEXT_CURRENT_ID;
    static const gapic::Id GL_X_SWAP_BUFFERS_ID;
    ...
    static const gapic::Id C_G_L_CREATE_CONTEXT_ID;
...
inline void GlesSpy::observe(const void* base, uint64_t offset, uint64_t size) {
    ...
    mEncoder->Uint32(0);       // TODO: ContextID
    mEncoder->Uint64(reinterpret_cast<uint64_t>(ptr));
    mEncoder->Uint64(size);
    mEncoder->Id(id);
}

inline EGLBoolean GlesSpy::eglInitialize(EGLDisplay dpy, EGLint* major, EGLint* minor) {
    GAPID_INFO("eglInitialize");
    EGLBoolean result = mImports.eglInitialize(dpy, major, minor);
    mState.eglInitialize(dpy, major, minor, result);

    mEncoder->Uint16(4);  // Type ID -- TODO: mEncoder->Id(EGL_INITIALIZE_ID);
    mEncoder->Uint32(0);  // TODO: ContextID
    mEncoder->Uint64(reinterpret_cast<uint64_t>(dpy));
    mEncoder->Int64(major ? (*major) : EGLint{});
    mEncoder->Int64(minor ? (*minor) : EGLint{});
    mEncoder->Int64(result);

    return result;
}

inline EGLContext GlesSpy::eglCreateContext(EGLDisplay display, EGLConfig config,
                                            EGLContext share_context, const EGLint* attrib_list) {
    GAPID_INFO("eglCreateContext");
    EGLContext result = mImports.eglCreateContext(display, config, share_context, attrib_list);
    mState.eglCreateContext(display, config, share_context, attrib_list, result);

    mEncoder->Uint16(5);  // Type ID -- TODO: mEncoder->Id(EGL_CREATE_CONTEXT_ID);
    mEncoder->Uint32(0);  // TODO: ContextID
    ...
    if (attrib_list != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = 0;
        mEncoder->Uint32(count_);
        for (int i = 0; i < count_; i++) {
            mEncoder->Int64(attrib_list[i]);
        }
    } else {
        mEncoder->Uint32(0);
    }
...
inline EGLBoolean GlesSpy::eglMakeCurrent(EGLDisplay display, EGLSurface draw, EGLSurface read,
                                          EGLContext context) {
    GAPID_INFO("eglMakeCurrent");
    EGLBoolean result = mImports.eglMakeCurrent(display, draw, read, context);
    mState.eglMakeCurrent(display, draw, read, context, result);

    mEncoder->Uint16(6);  // Type ID -- TODO: mEncoder->Id(EGL_MAKE_CURRENT_ID);
    mEncoder->Uint32(0);  // TODO: ContextID
    mEncoder->Uint64(reinterpret_cast<uint64_t>(display));
...
inline EGLBoolean GlesSpy::eglSwapBuffers(EGLDisplay display, const void* surface) {
    GAPID_INFO("eglSwapBuffers");
    EGLBoolean result = mImports.eglSwapBuffers(display, surface);
    mState.eglSwapBuffers(display, surface, result);

    mEncoder->Uint16(7);  // Type ID -- TODO: mEncoder->Id(EGL_SWAP_BUFFERS_ID);
    mEncoder->Uint32(0);  // TODO: ContextID
    mEncoder->Uint64(reinterpret_cast<uint64_t>(display));
...
inline GLXContext GlesSpy::glXCreateContext(const void* dpy, const void* vis, GLXContext shareList,
                                            bool direct) {
    GAPID_INFO("glXCreateContext");
    GLXContext result = mImports.glXCreateContext(dpy, vis, shareList, direct);
    mState.glXCreateContext(dpy, vis, shareList, direct, result);

    mEncoder->Uint16(8);  // Type ID -- TODO: mEncoder->Id(GL_X_CREATE_CONTEXT_ID);
    mEncoder->Uint32(0);  // TODO: ContextID
    mEncoder->Uint64(reinterpret_cast<uint64_t>(dpy));
...
inline GLXContext GlesSpy::glXCreateNewContext(const void* display, const void* fbconfig,
                                               uint32_t type, GLXContext shared, bool direct) {
    GAPID_INFO("glXCreateNewContext");
    GLXContext result = mImports.glXCreateNewContext(display, fbconfig, type, shared, direct);
    mState.glXCreateNewContext(display, fbconfig, type, shared, direct, result);

    mEncoder->Uint16(9);  // Type ID -- TODO: mEncoder->Id(GL_X_CREATE_NEW_CONTEXT_ID);
    mEncoder->Uint32(0);  // TODO: ContextID
    mEncoder->Uint64(reinterpret_cast<uint64_t>(display));
...
inline void GlesSpy::glXMakeContextCurrent(const void* display, GLXDrawable draw, GLXDrawable read,
                                           GLXContext ctx) {
    ...
    mEncoder->Uint16(10);  // Type ID -- TODO: mEncoder->Id(GL_X_MAKE_CONTEXT_CURRENT_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint64(reinterpret_cast<uint64_t>(display));
    mEncoder->Uint64(reinterpret_cast<uint64_t>(draw));
    mEncoder->Uint64(reinterpret_cast<uint64_t>(read));
...
inline void GlesSpy::glXSwapBuffers(const void* display, GLXDrawable drawable) {
    GAPID_INFO("glXSwapBuffers");
    mImports.glXSwapBuffers(display, drawable);
    mState.glXSwapBuffers(display, drawable);

    mEncoder->Uint16(11);  // Type ID -- TODO: mEncoder->Id(GL_X_SWAP_BUFFERS_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint64(reinterpret_cast<uint64_t>(display));
...
inline HGLRC GlesSpy::wglCreateContext(HDC hdc) {
    ...
    mEncoder->Uint16(12);  // Type ID -- TODO: mEncoder->Id(WGL_CREATE_CONTEXT_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline CGLError GlesSpy::CGLCreateContext(CGLPixelFormatObj pix, CGLContextObj share,
                                          CGLContextObj ctx) {
    GAPID_INFO("CGLCreateContext");
    CGLError result = mImports.CGLCreateContext(pix, share, ctx);
...
inline void GlesSpy::glEnableClientState(uint32_t type) {
    ...
    mEncoder->Uint16(16);  // Type ID -- TODO: mEncoder->Id(GL_ENABLE_CLIENT_STATE_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glDisableClientState(uint32_t type) {
    ...
    mEncoder->Uint16(17);  // Type ID -- TODO: mEncoder->Id(GL_DISABLE_CLIENT_STATE_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(type));
}
...
inline void GlesSpy::glGetProgramBinaryOES(ProgramId program, int32_t buffer_size,
    ...
    mEncoder->Uint16(18);  // Type ID -- TODO: mEncoder->Id(GL_GET_PROGRAM_BINARY_O_E_S_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->Int32(buffer_size);
    mEncoder->Int32(bytes_written ? (*bytes_written) : int32_t{});
    mEncoder->Uint32(binary_format ? (*binary_format) : uint32_t{});
...
inline void GlesSpy::glProgramBinaryOES(ProgramId program, uint32_t binary_format,
    ...
    mEncoder->Uint16(19);  // Type ID -- TODO: mEncoder->Id(GL_PROGRAM_BINARY_O_E_S_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(program);
...
inline void GlesSpy::glStartTilingQCOM(int32_t x, int32_t y, int32_t width, int32_t height,
    ...
    mEncoder->Uint16(20);  // Type ID -- TODO: mEncoder->Id(GL_START_TILING_Q_C_O_M_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(x);
    mEncoder->Int32(y);
...
inline void GlesSpy::glEndTilingQCOM(uint32_t preserve_mask) {
    ...
    mEncoder->Uint16(21);  // Type ID -- TODO: mEncoder->Id(GL_END_TILING_Q_C_O_M_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glDiscardFramebufferEXT(uint32_t target, int32_t numAttachments,
    ...
    mEncoder->Uint16(22);  // Type ID -- TODO: mEncoder->Id(GL_DISCARD_FRAMEBUFFER_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    ...
    if (attachments != nullptr) {  // TODO: This check should not be necessary!
        ...
        mEncoder->Uint32(count_);
        for (int i = 0; i < count_; i++) {
            mEncoder->Uint32(static_cast<uint32_t>(attachments[i]));
        }
    } else {
        mEncoder->Uint32(0);
    }
...
inline void GlesSpy::glInsertEventMarkerEXT(int32_t length, const char* marker) {
    ...
    mEncoder->Uint16(23);  // Type ID -- TODO: mEncoder->Id(GL_INSERT_EVENT_MARKER_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glPushGroupMarkerEXT(int32_t length, const char* marker) {
    ...
    mEncoder->Uint16(24);  // Type ID -- TODO: mEncoder->Id(GL_PUSH_GROUP_MARKER_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(length);
    mEncoder->String(marker);
}
...
inline void GlesSpy::glPopGroupMarkerEXT() {
    ...
    mEncoder->Uint16(25);  // Type ID -- TODO: mEncoder->Id(GL_POP_GROUP_MARKER_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
}
...
inline void GlesSpy::glTexStorage1DEXT(uint32_t target, int32_t levels, uint32_t format,
    ...
    mEncoder->Uint16(26);  // Type ID -- TODO: mEncoder->Id(GL_TEX_STORAGE1D_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
...
inline void GlesSpy::glTexStorage2DEXT(uint32_t target, int32_t levels, uint32_t format,
    ...
    mEncoder->Uint16(27);  // Type ID -- TODO: mEncoder->Id(GL_TEX_STORAGE2D_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(levels);
    mEncoder->Uint32(static_cast<uint32_t>(format));
...
inline void GlesSpy::glTexStorage3DEXT(uint32_t target, int32_t levels, uint32_t format,
    ...
    mEncoder->Uint16(28);  // Type ID -- TODO: mEncoder->Id(GL_TEX_STORAGE3D_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(levels);
    mEncoder->Uint32(static_cast<uint32_t>(format));
...
inline void GlesSpy::glTextureStorage1DEXT(TextureId texture, uint32_t target, int32_t levels,
    ...
    mEncoder->Uint16(29);  // Type ID -- TODO: mEncoder->Id(GL_TEXTURE_STORAGE1D_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glTextureStorage2DEXT(TextureId texture, uint32_t target, int32_t levels,
    ...
    mEncoder->Uint16(30);  // Type ID -- TODO: mEncoder->Id(GL_TEXTURE_STORAGE2D_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(texture);
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(levels);
...
inline void GlesSpy::glTextureStorage3DEXT(TextureId texture, uint32_t target, int32_t levels,
    ...
    mEncoder->Uint16(31);  // Type ID -- TODO: mEncoder->Id(GL_TEXTURE_STORAGE3D_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(texture);
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(levels);
...
inline void GlesSpy::glGenVertexArraysOES(int32_t count, VertexArrayId* arrays) {
    ...
    mEncoder->Uint16(32);  // Type ID -- TODO: mEncoder->Id(GL_GEN_VERTEX_ARRAYS_O_E_S_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glBindVertexArrayOES(VertexArrayId array) {
    ...
    mEncoder->Uint16(33);  // Type ID -- TODO: mEncoder->Id(GL_BIND_VERTEX_ARRAY_O_E_S_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glDeleteVertexArraysOES(int32_t count, const VertexArrayId* arrays) {
    ...
    mEncoder->Uint16(34);  // Type ID -- TODO: mEncoder->Id(GL_DELETE_VERTEX_ARRAYS_O_E_S_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(count);
    if (arrays != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = count;
...
inline bool GlesSpy::glIsVertexArrayOES(VertexArrayId array) {
    ...
    mEncoder->Uint16(35);  // Type ID -- TODO: mEncoder->Id(GL_IS_VERTEX_ARRAY_O_E_S_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(array);
...
inline void GlesSpy::glEGLImageTargetTexture2DOES(uint32_t target, ImageOES image) {
    ...
    mEncoder->Uint16(
            36);  // Type ID -- TODO: mEncoder->Id(GL_E_G_L_IMAGE_TARGET_TEXTURE2D_O_E_S_ID);
    mEncoder->Uint32(0);  // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
...
inline void GlesSpy::glEGLImageTargetRenderbufferStorageOES(uint32_t target, TexturePointer image) {
    ...
    mEncoder->Uint16(37);  // Type ID -- TODO:
...
inline uint32_t GlesSpy::glGetGraphicsResetStatusEXT() {
    ...
    mEncoder->Uint16(38);  // Type ID -- TODO: mEncoder->Id(GL_GET_GRAPHICS_RESET_STATUS_E_X_T_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glBindAttribLocation(ProgramId program, AttributeLocation location,
    ...
    mEncoder->Uint16(39);  // Type ID -- TODO: mEncoder->Id(GL_BIND_ATTRIB_LOCATION_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(program);
...
inline void GlesSpy::glBlendFunc(uint32_t src_factor, uint32_t dst_factor) {
    ...
    mEncoder->Uint16(40);  // Type ID -- TODO: mEncoder->Id(GL_BLEND_FUNC_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glBlendFuncSeparate(uint32_t src_factor_rgb, uint32_t dst_factor_rgb,
    ...
    mEncoder->Uint16(41);  // Type ID -- TODO: mEncoder->Id(GL_BLEND_FUNC_SEPARATE_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glBlendEquation(uint32_t equation) {
    ...
    mEncoder->Uint16(42);  // Type ID -- TODO: mEncoder->Id(GL_BLEND_EQUATION_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glBlendEquationSeparate(uint32_t rgb, uint32_t alpha) {
    ...
    mEncoder->Uint16(43);  // Type ID -- TODO: mEncoder->Id(GL_BLEND_EQUATION_SEPARATE_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glBlendColor(float red, float green, float blue, float alpha) {
    ...
    mEncoder->Uint16(44);  // Type ID -- TODO: mEncoder->Id(GL_BLEND_COLOR_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glEnableVertexAttribArray(AttributeLocation location) {
    ...
    mEncoder->Uint16(45);  // Type ID -- TODO: mEncoder->Id(GL_ENABLE_VERTEX_ATTRIB_ARRAY_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
}
...
inline void GlesSpy::glDisableVertexAttribArray(AttributeLocation location) {
    ...
    mEncoder->Uint16(46);  // Type ID -- TODO: mEncoder->Id(GL_DISABLE_VERTEX_ATTRIB_ARRAY_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
}
...
inline void GlesSpy::glVertexAttribPointer(AttributeLocation location, int32_t size, uint32_t type,
    ...
    mEncoder->Uint16(47);  // Type ID -- TODO: mEncoder->Id(GL_VERTEX_ATTRIB_POINTER_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
    mEncoder->Int32(size);
    mEncoder->Uint32(static_cast<uint32_t>(type));
...
inline void GlesSpy::glGetActiveAttrib(ProgramId program, AttributeLocation location,
    ...
    mEncoder->Uint16(48);  // Type ID -- TODO: mEncoder->Id(GL_GET_ACTIVE_ATTRIB_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->Uint32(location);
    mEncoder->Int32(buffer_size);
    mEncoder->Int32(buffer_bytes_written ? (*buffer_bytes_written) : int32_t{});
    mEncoder->Int32(vector_count ? (*vector_count) : int32_t{});
    mEncoder->Uint32(static_cast<uint32_t>(type ? (*type) : uint32_t{}));
    mEncoder->String(name);
}
...
inline void GlesSpy::glGetActiveUniform(ProgramId program, int32_t location, int32_t buffer_size,
    ...
    mEncoder->Uint16(49);  // Type ID -- TODO: mEncoder->Id(GL_GET_ACTIVE_UNIFORM_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->Int32(location);
    mEncoder->Int32(buffer_size);
    mEncoder->Int32(buffer_bytes_written ? (*buffer_bytes_written) : int32_t{});
    mEncoder->Int32(size ? (*size) : int32_t{});
    mEncoder->Uint32(static_cast<uint32_t>(type ? (*type) : uint32_t{}));
    mEncoder->String(name);
}
...
inline uint32_t GlesSpy::glGetError() {
    ...
    mEncoder->Uint16(50);  // Type ID -- TODO: mEncoder->Id(GL_GET_ERROR_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(result));
...
inline void GlesSpy::glGetProgramiv(ProgramId program, uint32_t parameter, int32_t* value) {
    ...
    mEncoder->Uint16(51);  // Type ID -- TODO: mEncoder->Id(GL_GET_PROGRAMIV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(program);
...
inline void GlesSpy::glGetShaderiv(ShaderId shader, uint32_t parameter, int32_t* value) {
    ...
    mEncoder->Uint16(52);  // Type ID -- TODO: mEncoder->Id(GL_GET_SHADERIV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline UniformLocation GlesSpy::glGetUniformLocation(ProgramId program, const char* name) {
    ...
    mEncoder->Uint16(53);  // Type ID -- TODO: mEncoder->Id(GL_GET_UNIFORM_LOCATION_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->String(name);
...
inline AttributeLocation GlesSpy::glGetAttribLocation(ProgramId program, const char* name) {
    ...
    mEncoder->Uint16(54);  // Type ID -- TODO: mEncoder->Id(GL_GET_ATTRIB_LOCATION_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->String(name);
...
inline void GlesSpy::glPixelStorei(uint32_t parameter, int32_t value) {
    ...
    mEncoder->Uint16(55);  // Type ID -- TODO: mEncoder->Id(GL_PIXEL_STOREI_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
...
inline void GlesSpy::glTexParameteri(uint32_t target, uint32_t parameter, int32_t value) {
    ...
    mEncoder->Uint16(56);  // Type ID -- TODO: mEncoder->Id(GL_TEX_PARAMETERI_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    mEncoder->Int32(value);
...
inline void GlesSpy::glTexParameterf(uint32_t target, uint32_t parameter, float value) {
    ...
    mEncoder->Uint16(57);  // Type ID -- TODO: mEncoder->Id(GL_TEX_PARAMETERF_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
...
inline void GlesSpy::glGetTexParameteriv(uint32_t target, uint32_t parameter, int32_t* values) {
    ...
    mEncoder->Uint16(58);  // Type ID -- TODO: mEncoder->Id(GL_GET_TEX_PARAMETERIV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
...
inline void GlesSpy::glGetTexParameterfv(uint32_t target, uint32_t parameter, float* values) {
    ...
    mEncoder->Uint16(59);  // Type ID -- TODO: mEncoder->Id(GL_GET_TEX_PARAMETERFV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    if (values != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glUniform1i(UniformLocation location, int32_t value) {
    ...
    mEncoder->Uint16(60);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM1I_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(value);
}
...
inline void GlesSpy::glUniform2i(UniformLocation location, int32_t value0, int32_t value1) {
    ...
    mEncoder->Uint16(61);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM2I_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
...
inline void GlesSpy::glUniform3i(UniformLocation location, int32_t value0, int32_t value1,
    ...
    mEncoder->Uint16(62);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM3I_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(value0);
    mEncoder->Int32(value1);
...
inline void GlesSpy::glUniform4i(UniformLocation location, int32_t value0, int32_t value1,
    ...
    mEncoder->Uint16(63);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM4I_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(value0);
    mEncoder->Int32(value1);
...
inline void GlesSpy::glUniform1iv(UniformLocation location, int32_t count, const int32_t* value) {
    ...
    mEncoder->Uint16(64);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM1IV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
    if (value != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glUniform2iv(UniformLocation location, int32_t count, const int32_t* value) {
    ...
    mEncoder->Uint16(65);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM2IV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
    if (value != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glUniform3iv(UniformLocation location, int32_t count, const int32_t* value) {
    ...
    mEncoder->Uint16(66);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM3IV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
    if (value != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glUniform4iv(UniformLocation location, int32_t count, const int32_t* value) {
    ...
    mEncoder->Uint16(67);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM4IV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
    if (value != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glUniform1f(UniformLocation location, float value) {
    ...
    mEncoder->Uint16(68);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM1F_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Float32(value);
}
...
inline void GlesSpy::glUniform2f(UniformLocation location, float value0, float value1) {
    ...
    mEncoder->Uint16(69);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM2F_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
...
inline void GlesSpy::glUniform3f(UniformLocation location, float value0, float value1,
    ...
    mEncoder->Uint16(70);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM3F_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Float32(value0);
    mEncoder->Float32(value1);
...
inline void GlesSpy::glUniform4f(UniformLocation location, float value0, float value1, float value2,
    ...
    mEncoder->Uint16(71);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM4F_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Float32(value0);
    mEncoder->Float32(value1);
...
inline void GlesSpy::glUniform1fv(UniformLocation location, int32_t count, const float* value) {
    ...
    mEncoder->Uint16(72);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM1FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
    if (value != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glUniform2fv(UniformLocation location, int32_t count, const float* value) {
    ...
    mEncoder->Uint16(73);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM2FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
    if (value != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glUniform3fv(UniformLocation location, int32_t count, const float* value) {
    ...
    mEncoder->Uint16(74);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM3FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
    if (value != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glUniform4fv(UniformLocation location, int32_t count, const float* value) {
    ...
    mEncoder->Uint16(75);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM4FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
    if (value != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glUniformMatrix2fv(UniformLocation location, int32_t count, bool transpose,
    ...
    mEncoder->Uint16(76);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM_MATRIX2FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
...
inline void GlesSpy::glUniformMatrix3fv(UniformLocation location, int32_t count, bool transpose,
    ...
    mEncoder->Uint16(77);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM_MATRIX3FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
    mEncoder->Bool(transpose);
...
inline void GlesSpy::glUniformMatrix4fv(UniformLocation location, int32_t count, bool transpose,
    ...
    mEncoder->Uint16(78);  // Type ID -- TODO: mEncoder->Id(GL_UNIFORM_MATRIX4FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(location);
    mEncoder->Int32(count);
    mEncoder->Bool(transpose);
...
inline void GlesSpy::glGetUniformfv(ProgramId program, UniformLocation location,
    ...
    mEncoder->Uint16(79);  // Type ID -- TODO: mEncoder->Id(GL_GET_UNIFORMFV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->Int32(location);
    if (values != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glGetUniformiv(ProgramId program, UniformLocation location,
    ...
    mEncoder->Uint16(80);  // Type ID -- TODO: mEncoder->Id(GL_GET_UNIFORMIV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->Int32(location);
    if (values != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glVertexAttrib1f(AttributeLocation location, float value0) {
    ...
    mEncoder->Uint16(81);  // Type ID -- TODO: mEncoder->Id(GL_VERTEX_ATTRIB1F_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
    mEncoder->Float32(value0);
}
...
inline void GlesSpy::glVertexAttrib2f(AttributeLocation location, float value0, float value1) {
    ...
    mEncoder->Uint16(82);  // Type ID -- TODO: mEncoder->Id(GL_VERTEX_ATTRIB2F_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
    mEncoder->Float32(value0);
    mEncoder->Float32(value1);
...
inline void GlesSpy::glVertexAttrib3f(AttributeLocation location, float value0, float value1,
    ...
    mEncoder->Uint16(83);  // Type ID -- TODO: mEncoder->Id(GL_VERTEX_ATTRIB3F_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
    mEncoder->Float32(value0);
    mEncoder->Float32(value1);
...
inline void GlesSpy::glVertexAttrib4f(AttributeLocation location, float value0, float value1,
    ...
    mEncoder->Uint16(84);  // Type ID -- TODO: mEncoder->Id(GL_VERTEX_ATTRIB4F_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
    mEncoder->Float32(value0);
    mEncoder->Float32(value1);
...
inline void GlesSpy::glVertexAttrib1fv(AttributeLocation location, const float* value) {
    ...
    mEncoder->Uint16(85);  // Type ID -- TODO: mEncoder->Id(GL_VERTEX_ATTRIB1FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
    if (value != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = 1;
...
inline void GlesSpy::glVertexAttrib2fv(AttributeLocation location, const float* value) {
    ...
    mEncoder->Uint16(86);  // Type ID -- TODO: mEncoder->Id(GL_VERTEX_ATTRIB2FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
    if (value != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = 2;
...
inline void GlesSpy::glVertexAttrib3fv(AttributeLocation location, const float* value) {
    ...
    mEncoder->Uint16(87);  // Type ID -- TODO: mEncoder->Id(GL_VERTEX_ATTRIB3FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
    if (value != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = 3;
...
inline void GlesSpy::glVertexAttrib4fv(AttributeLocation location, const float* value) {
    ...
    mEncoder->Uint16(88);  // Type ID -- TODO: mEncoder->Id(GL_VERTEX_ATTRIB4FV_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(location);
    if (value != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = 4;
...
inline void GlesSpy::glGetShaderPrecisionFormat(uint32_t shader_type, uint32_t precision_type,
    ...
    mEncoder->Uint16(89);  // Type ID -- TODO: mEncoder->Id(GL_GET_SHADER_PRECISION_FORMAT_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    ...
    if (range != nullptr) {  // TODO: This check should not be necessary!
        ...
        mEncoder->Uint32(count_);
        for (int i = 0; i < count_; i++) {
            mEncoder->Int32(range[i]);
        }
    } else {
        mEncoder->Uint32(0);
    }
    mEncoder->Int32(precision ? (*precision) : int32_t{});
}
...
inline void GlesSpy::glDepthMask(bool enabled) {
    ...
    mEncoder->Uint16(90);  // Type ID -- TODO: mEncoder->Id(GL_DEPTH_MASK_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glDepthFunc(uint32_t function) {
    ...
    mEncoder->Uint16(91);  // Type ID -- TODO: mEncoder->Id(GL_DEPTH_FUNC_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glDepthRangef(float near, float far) {
    ...
    mEncoder->Uint16(92);  // Type ID -- TODO: mEncoder->Id(GL_DEPTH_RANGEF_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glColorMask(bool red, bool green, bool blue, bool alpha) {
    ...
    mEncoder->Uint16(93);  // Type ID -- TODO: mEncoder->Id(GL_COLOR_MASK_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Bool(red);
    mEncoder->Bool(green);
    mEncoder->Bool(blue);
...
inline void GlesSpy::glStencilMask(uint32_t mask) {
    ...
    mEncoder->Uint16(94);  // Type ID -- TODO: mEncoder->Id(GL_STENCIL_MASK_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glStencilMaskSeparate(uint32_t face, uint32_t mask) {
    ...
    mEncoder->Uint16(95);  // Type ID -- TODO: mEncoder->Id(GL_STENCIL_MASK_SEPARATE_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glStencilFuncSeparate(uint32_t face, uint32_t function,
    ...
    mEncoder->Uint16(96);  // Type ID -- TODO: mEncoder->Id(GL_STENCIL_FUNC_SEPARATE_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(face));
    mEncoder->Uint32(static_cast<uint32_t>(function));
...
inline void GlesSpy::glStencilOpSeparate(uint32_t face, uint32_t stencil_fail,
    ...
    mEncoder->Uint16(97);  // Type ID -- TODO: mEncoder->Id(GL_STENCIL_OP_SEPARATE_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(face));
...
inline void GlesSpy::glFrontFace(uint32_t orientation) {
    ...
    mEncoder->Uint16(98);  // Type ID -- TODO: mEncoder->Id(GL_FRONT_FACE_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
...
inline void GlesSpy::glViewport(int32_t x, int32_t y, int32_t width, int32_t height) {
    ...
    mEncoder->Uint16(99);  // Type ID -- TODO: mEncoder->Id(GL_VIEWPORT_ID);
    mEncoder->Uint32(0);   // TODO: ContextID
    mEncoder->Int32(x);
    mEncoder->Int32(y);
    mEncoder->Int32(width);
...
inline void GlesSpy::glScissor(int32_t x, int32_t y, int32_t width, int32_t height) {
    ...
    mEncoder->Uint16(100);  // Type ID -- TODO: mEncoder->Id(GL_SCISSOR_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(x);
    mEncoder->Int32(y);
    mEncoder->Int32(width);
...
inline void GlesSpy::glActiveTexture(uint32_t unit) {
    ...
    mEncoder->Uint16(101);  // Type ID -- TODO: mEncoder->Id(GL_ACTIVE_TEXTURE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glGenTextures(int32_t count, TextureId* textures) {
    ...
    mEncoder->Uint16(102);  // Type ID -- TODO: mEncoder->Id(GL_GEN_TEXTURES_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
...
inline void GlesSpy::glDeleteTextures(int32_t count, const TextureId* textures) {
    ...
    mEncoder->Uint16(103);  // Type ID -- TODO: mEncoder->Id(GL_DELETE_TEXTURES_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
    if (textures != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = count;
...
inline bool GlesSpy::glIsTexture(TextureId texture) {
    ...
    mEncoder->Uint16(104);  // Type ID -- TODO: mEncoder->Id(GL_IS_TEXTURE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(texture);
    mEncoder->Bool(result);
...
inline void GlesSpy::glBindTexture(uint32_t target, TextureId texture) {
    ...
    mEncoder->Uint16(105);  // Type ID -- TODO: mEncoder->Id(GL_BIND_TEXTURE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(texture);
}
...
inline void GlesSpy::glTexImage2D(uint32_t target, int32_t level, uint32_t internal_format,
    ...
    mEncoder->Uint16(106);  // Type ID -- TODO: mEncoder->Id(GL_TEX_IMAGE2D_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
...
inline void GlesSpy::glTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset,
    ...
    mEncoder->Uint16(107);  // Type ID -- TODO: mEncoder->Id(GL_TEX_SUB_IMAGE2D_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(level);
...
inline void GlesSpy::glCopyTexImage2D(uint32_t target, int32_t level, uint32_t format, int32_t x,
    ...
    mEncoder->Uint16(108);  // Type ID -- TODO: mEncoder->Id(GL_COPY_TEX_IMAGE2D_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(level);
    mEncoder->Uint32(static_cast<uint32_t>(format));
...
inline void GlesSpy::glCopyTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset,
    ...
    mEncoder->Uint16(109);  // Type ID -- TODO: mEncoder->Id(GL_COPY_TEX_SUB_IMAGE2D_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(level);
    mEncoder->Int32(xoffset);
...
inline void GlesSpy::glCompressedTexImage2D(uint32_t target, int32_t level, uint32_t format,
    ...
    mEncoder->Uint16(110);  // Type ID -- TODO: mEncoder->Id(GL_COMPRESSED_TEX_IMAGE2D_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(level);
    mEncoder->Uint32(static_cast<uint32_t>(format));
...
inline void GlesSpy::glCompressedTexSubImage2D(uint32_t target, int32_t level, int32_t xoffset,
    ...
    mEncoder->Uint16(111);  // Type ID -- TODO: mEncoder->Id(GL_COMPRESSED_TEX_SUB_IMAGE2D_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(level);
    mEncoder->Int32(xoffset);
...
inline void GlesSpy::glGenerateMipmap(uint32_t target) {
    ...
    mEncoder->Uint16(112);  // Type ID -- TODO: mEncoder->Id(GL_GENERATE_MIPMAP_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
}
...
inline void GlesSpy::glReadPixels(int32_t x, int32_t y, int32_t width, int32_t height,
    ...
    mEncoder->Uint16(113);  // Type ID -- TODO: mEncoder->Id(GL_READ_PIXELS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(x);
    mEncoder->Int32(y);
    mEncoder->Int32(width);
...
inline void GlesSpy::glGenFramebuffers(int32_t count, FramebufferId* framebuffers) {
    ...
    mEncoder->Uint16(114);  // Type ID -- TODO: mEncoder->Id(GL_GEN_FRAMEBUFFERS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
    if (framebuffers != nullptr) {  // TODO: This check should not be necessary!
        ...
        mEncoder->Uint32(count_);
        for (int i = 0; i < count_; i++) {
            mEncoder->Uint32(framebuffers[i]);
        }
    } else {
        mEncoder->Uint32(0);
    }
...
inline void GlesSpy::glBindFramebuffer(uint32_t target, FramebufferId framebuffer) {
    ...
    mEncoder->Uint16(115);  // Type ID -- TODO: mEncoder->Id(GL_BIND_FRAMEBUFFER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
...
inline uint32_t GlesSpy::glCheckFramebufferStatus(uint32_t target) {
    ...
    mEncoder->Uint16(116);  // Type ID -- TODO: mEncoder->Id(GL_CHECK_FRAMEBUFFER_STATUS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(result));
...
inline void GlesSpy::glDeleteFramebuffers(int32_t count, const FramebufferId* framebuffers) {
    ...
    mEncoder->Uint16(117);  // Type ID -- TODO: mEncoder->Id(GL_DELETE_FRAMEBUFFERS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
    if (framebuffers != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = count;
...
inline bool GlesSpy::glIsFramebuffer(FramebufferId framebuffer) {
    ...
    mEncoder->Uint16(118);  // Type ID -- TODO: mEncoder->Id(GL_IS_FRAMEBUFFER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(framebuffer);
    mEncoder->Bool(result);
...
inline void GlesSpy::glGenRenderbuffers(int32_t count, RenderbufferId* renderbuffers) {
    ...
    mEncoder->Uint16(119);  // Type ID -- TODO: mEncoder->Id(GL_GEN_RENDERBUFFERS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
    if (renderbuffers != nullptr) {  // TODO: This check should not be necessary!
        ...
        mEncoder->Uint32(count_);
        for (int i = 0; i < count_; i++) {
            mEncoder->Uint32(renderbuffers[i]);
        }
    } else {
        mEncoder->Uint32(0);
    }
...
inline void GlesSpy::glBindRenderbuffer(uint32_t target, RenderbufferId renderbuffer) {
    ...
    mEncoder->Uint16(120);  // Type ID -- TODO: mEncoder->Id(GL_BIND_RENDERBUFFER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
...
inline void GlesSpy::glRenderbufferStorage(uint32_t target, uint32_t format, int32_t width,
    ...
    mEncoder->Uint16(121);  // Type ID -- TODO: mEncoder->Id(GL_RENDERBUFFER_STORAGE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(format));
    mEncoder->Int32(width);
...
inline void GlesSpy::glDeleteRenderbuffers(int32_t count, const RenderbufferId* renderbuffers) {
    ...
    mEncoder->Uint16(122);  // Type ID -- TODO: mEncoder->Id(GL_DELETE_RENDERBUFFERS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
    if (renderbuffers != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = count;
...
inline bool GlesSpy::glIsRenderbuffer(RenderbufferId renderbuffer) {
    ...
    mEncoder->Uint16(123);  // Type ID -- TODO: mEncoder->Id(GL_IS_RENDERBUFFER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(renderbuffer);
    mEncoder->Bool(result);
...
inline void GlesSpy::glGetRenderbufferParameteriv(uint32_t target, uint32_t parameter,
    ...
    mEncoder->Uint16(124);  // Type ID -- TODO: mEncoder->Id(GL_GET_RENDERBUFFER_PARAMETERIV_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    if (values != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glGenBuffers(int32_t count, BufferId* buffers) {
    ...
    mEncoder->Uint16(125);  // Type ID -- TODO: mEncoder->Id(GL_GEN_BUFFERS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
...
inline void GlesSpy::glBindBuffer(uint32_t target, BufferId buffer) {
    ...
    mEncoder->Uint16(126);  // Type ID -- TODO: mEncoder->Id(GL_BIND_BUFFER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
...
inline void GlesSpy::glBufferData(uint32_t target, int32_t size, BufferDataPointer data,
    ...
    mEncoder->Uint16(127);  // Type ID -- TODO: mEncoder->Id(GL_BUFFER_DATA_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(size);
    mEncoder->Uint64(reinterpret_cast<uint64_t>(data));
...
inline void GlesSpy::glBufferSubData(uint32_t target, int32_t offset, int32_t size,
    ...
    mEncoder->Uint16(128);  // Type ID -- TODO: mEncoder->Id(GL_BUFFER_SUB_DATA_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
...
inline void GlesSpy::glDeleteBuffers(int32_t count, const BufferId* buffers) {
    ...
    mEncoder->Uint16(129);  // Type ID -- TODO: mEncoder->Id(GL_DELETE_BUFFERS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
    if (buffers != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = count;
...
inline bool GlesSpy::glIsBuffer(BufferId buffer) {
    ...
    mEncoder->Uint16(130);  // Type ID -- TODO: mEncoder->Id(GL_IS_BUFFER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(buffer);
    mEncoder->Bool(result);
...
inline void GlesSpy::glGetBufferParameteriv(uint32_t target, uint32_t parameter, int32_t* value) {
    ...
    mEncoder->Uint16(131);  // Type ID -- TODO: mEncoder->Id(GL_GET_BUFFER_PARAMETERIV_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    mEncoder->Int32(value ? (*value) : int32_t{});
}
...
inline ShaderId GlesSpy::glCreateShader(uint32_t type) {
    ...
    mEncoder->Uint16(132);  // Type ID -- TODO: mEncoder->Id(GL_CREATE_SHADER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(type));
    mEncoder->Uint32(result);
...
inline void GlesSpy::glDeleteShader(ShaderId shader) {
    ...
    mEncoder->Uint16(133);  // Type ID -- TODO: mEncoder->Id(GL_DELETE_SHADER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(shader);
}
...
inline void GlesSpy::glShaderSource(ShaderId shader, int32_t count, const char** source,
    ...
    mEncoder->Uint16(134);  // Type ID -- TODO: mEncoder->Id(GL_SHADER_SOURCE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(shader);
    mEncoder->Int32(count);
...
inline void GlesSpy::glShaderBinary(int32_t count, const ShaderId* shaders, uint32_t binary_format,
    ...
    mEncoder->Uint16(135);  // Type ID -- TODO: mEncoder->Id(GL_SHADER_BINARY_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
...
inline void GlesSpy::glGetShaderInfoLog(ShaderId shader, int32_t buffer_length,
    ...
    mEncoder->Uint16(136);  // Type ID -- TODO: mEncoder->Id(GL_GET_SHADER_INFO_LOG_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(shader);
    mEncoder->Int32(buffer_length);
    mEncoder->Int32(string_length_written ? (*string_length_written) : int32_t{});
...
inline void GlesSpy::glGetShaderSource(ShaderId shader, int32_t buffer_length,
    ...
    mEncoder->Uint16(137);  // Type ID -- TODO: mEncoder->Id(GL_GET_SHADER_SOURCE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(shader);
    mEncoder->Int32(buffer_length);
    mEncoder->Int32(string_length_written ? (*string_length_written) : int32_t{});
...
inline void GlesSpy::glReleaseShaderCompiler() {
    ...
    mEncoder->Uint16(138);  // Type ID -- TODO: mEncoder->Id(GL_RELEASE_SHADER_COMPILER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
}
...
inline void GlesSpy::glCompileShader(ShaderId shader) {
    ...
    mEncoder->Uint16(139);  // Type ID -- TODO: mEncoder->Id(GL_COMPILE_SHADER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(shader);
}
...
inline bool GlesSpy::glIsShader(ShaderId shader) {
    ...
    mEncoder->Uint16(140);  // Type ID -- TODO: mEncoder->Id(GL_IS_SHADER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(shader);
    mEncoder->Bool(result);
...
inline ProgramId GlesSpy::glCreateProgram() {
    ...
    mEncoder->Uint16(141);  // Type ID -- TODO: mEncoder->Id(GL_CREATE_PROGRAM_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(result);
...
inline void GlesSpy::glDeleteProgram(ProgramId program) {
    ...
    mEncoder->Uint16(142);  // Type ID -- TODO: mEncoder->Id(GL_DELETE_PROGRAM_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(program);
}
...
inline void GlesSpy::glAttachShader(ProgramId program, ShaderId shader) {
    ...
    mEncoder->Uint16(143);  // Type ID -- TODO: mEncoder->Id(GL_ATTACH_SHADER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->Uint32(shader);
}
...
inline void GlesSpy::glDetachShader(ProgramId program, ShaderId shader) {
    ...
    mEncoder->Uint16(144);  // Type ID -- TODO: mEncoder->Id(GL_DETACH_SHADER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->Uint32(shader);
}
...
inline void GlesSpy::glGetAttachedShaders(ProgramId program, int32_t buffer_length,
    ...
    mEncoder->Uint16(145);  // Type ID -- TODO: mEncoder->Id(GL_GET_ATTACHED_SHADERS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->Int32(buffer_length);
    mEncoder->Int32(shaders_length_written ? (*shaders_length_written) : int32_t{});
    if (shaders != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glLinkProgram(ProgramId program) {
    ...
    mEncoder->Uint16(146);  // Type ID -- TODO: mEncoder->Id(GL_LINK_PROGRAM_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(program);
}
...
inline void GlesSpy::glGetProgramInfoLog(ProgramId program, int32_t buffer_length,
    ...
    mEncoder->Uint16(147);  // Type ID -- TODO: mEncoder->Id(GL_GET_PROGRAM_INFO_LOG_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->Int32(buffer_length);
    mEncoder->Int32(string_length_written ? (*string_length_written) : int32_t{});
...
inline void GlesSpy::glUseProgram(ProgramId program) {
    ...
    mEncoder->Uint16(148);  // Type ID -- TODO: mEncoder->Id(GL_USE_PROGRAM_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(program);
}
...
inline bool GlesSpy::glIsProgram(ProgramId program) {
    ...
    mEncoder->Uint16(149);  // Type ID -- TODO: mEncoder->Id(GL_IS_PROGRAM_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(program);
    mEncoder->Bool(result);
...
inline void GlesSpy::glValidateProgram(ProgramId program) {
    ...
    mEncoder->Uint16(150);  // Type ID -- TODO: mEncoder->Id(GL_VALIDATE_PROGRAM_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(program);
}
...
inline void GlesSpy::glClearColor(float r, float g, float b, float a) {
    ...
    mEncoder->Uint16(151);  // Type ID -- TODO: mEncoder->Id(GL_CLEAR_COLOR_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Float32(r);
    mEncoder->Float32(g);
    mEncoder->Float32(b);
...
inline void GlesSpy::glClearDepthf(float depth) {
    ...
    mEncoder->Uint16(152);  // Type ID -- TODO: mEncoder->Id(GL_CLEAR_DEPTHF_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glClearStencil(int32_t stencil) {
    ...
    mEncoder->Uint16(153);  // Type ID -- TODO: mEncoder->Id(GL_CLEAR_STENCIL_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glClear(uint32_t mask) {
    ...
    mEncoder->Uint16(154);  // Type ID -- TODO: mEncoder->Id(GL_CLEAR_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glCullFace(uint32_t mode) {
    ...
    mEncoder->Uint16(155);  // Type ID -- TODO: mEncoder->Id(GL_CULL_FACE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glPolygonOffset(float scale_factor, float units) {
    ...
    mEncoder->Uint16(156);  // Type ID -- TODO: mEncoder->Id(GL_POLYGON_OFFSET_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glLineWidth(float width) {
    ...
    mEncoder->Uint16(157);  // Type ID -- TODO: mEncoder->Id(GL_LINE_WIDTH_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glSampleCoverage(float value, bool invert) {
    ...
    mEncoder->Uint16(158);  // Type ID -- TODO: mEncoder->Id(GL_SAMPLE_COVERAGE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Float32(value);
...
inline void GlesSpy::glHint(uint32_t target, uint32_t mode) {
    ...
    mEncoder->Uint16(159);  // Type ID -- TODO: mEncoder->Id(GL_HINT_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(mode));
}
...
inline void GlesSpy::glFramebufferRenderbuffer(uint32_t framebuffer_target,
    ...
    mEncoder->Uint16(160);  // Type ID -- TODO: mEncoder->Id(GL_FRAMEBUFFER_RENDERBUFFER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glFramebufferTexture2D(uint32_t framebuffer_target,
    ...
    mEncoder->Uint16(161);  // Type ID -- TODO: mEncoder->Id(GL_FRAMEBUFFER_TEXTURE2D_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(framebuffer_target));
    mEncoder->Uint32(static_cast<uint32_t>(framebuffer_attachment));
...
inline void GlesSpy::glGetFramebufferAttachmentParameteriv(uint32_t framebuffer_target,
    ...
    mEncoder->Uint16(
            162);  // Type ID -- TODO: mEncoder->Id(GL_GET_FRAMEBUFFER_ATTACHMENT_PARAMETERIV_ID);
    mEncoder->Uint32(0);  // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(framebuffer_target));
...
inline void GlesSpy::glDrawElements(uint32_t draw_mode, int32_t element_count,
    ...
    mEncoder->Uint16(163);  // Type ID -- TODO: mEncoder->Id(GL_DRAW_ELEMENTS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glDrawArrays(uint32_t draw_mode, int32_t first_index, int32_t index_count) {
    ...
    mEncoder->Uint16(164);  // Type ID -- TODO: mEncoder->Id(GL_DRAW_ARRAYS_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(draw_mode));
...
inline void GlesSpy::glFlush() {
    ...
    mEncoder->Uint16(165);  // Type ID -- TODO: mEncoder->Id(GL_FLUSH_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
}
...
inline void GlesSpy::glFinish() {
    ...
    mEncoder->Uint16(166);  // Type ID -- TODO: mEncoder->Id(GL_FINISH_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
}
...
inline void GlesSpy::glGetBooleanv(uint32_t param, bool* values) {
    ...
    mEncoder->Uint16(167);  // Type ID -- TODO: mEncoder->Id(GL_GET_BOOLEANV_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glGetFloatv(uint32_t param, float* values) {
    ...
    mEncoder->Uint16(168);  // Type ID -- TODO: mEncoder->Id(GL_GET_FLOATV_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(param));
    if (values != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = mState.stateVariableSize(param);
...
inline void GlesSpy::glGetIntegerv(uint32_t param, int32_t* values) {
    ...
    mEncoder->Uint16(169);  // Type ID -- TODO: mEncoder->Id(GL_GET_INTEGERV_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(param));
    if (values != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = mState.stateVariableSize(param);
...
inline char* GlesSpy::glGetString(uint32_t param) {
    ...
    mEncoder->Uint16(170);  // Type ID -- TODO: mEncoder->Id(GL_GET_STRING_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(param));
...
inline void GlesSpy::glEnable(uint32_t capability) {
    ...
    mEncoder->Uint16(171);  // Type ID -- TODO: mEncoder->Id(GL_ENABLE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glDisable(uint32_t capability) {
    ...
    mEncoder->Uint16(172);  // Type ID -- TODO: mEncoder->Id(GL_DISABLE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(capability));
}
...
inline bool GlesSpy::glIsEnabled(uint32_t capability) {
    ...
    mEncoder->Uint16(173);  // Type ID -- TODO: mEncoder->Id(GL_IS_ENABLED_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(capability));
    mEncoder->Bool(result);
...
inline void* GlesSpy::glMapBufferRange(uint32_t target, int32_t offset, int32_t length,
    ...
    mEncoder->Uint16(174);  // Type ID -- TODO: mEncoder->Id(GL_MAP_BUFFER_RANGE_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(offset);
    mEncoder->Int32(length);
...
inline void GlesSpy::glUnmapBuffer(uint32_t target) {
    ...
    mEncoder->Uint16(175);  // Type ID -- TODO: mEncoder->Id(GL_UNMAP_BUFFER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
}
...
inline void GlesSpy::glInvalidateFramebuffer(uint32_t target, int32_t count,
    ...
    mEncoder->Uint16(176);  // Type ID -- TODO: mEncoder->Id(GL_INVALIDATE_FRAMEBUFFER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Int32(count);
    if (attachments != nullptr) {  // TODO: This check should not be necessary!
...
inline void GlesSpy::glRenderbufferStorageMultisample(uint32_t target, int32_t samples,
    ...
    mEncoder->Uint16(
            177);         // Type ID -- TODO: mEncoder->Id(GL_RENDERBUFFER_STORAGE_MULTISAMPLE_ID);
    mEncoder->Uint32(0);  // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
...
inline void GlesSpy::glBlitFramebuffer(int32_t srcX0, int32_t srcY0, int32_t srcX1, int32_t srcY1,
    ...
    mEncoder->Uint16(178);  // Type ID -- TODO: mEncoder->Id(GL_BLIT_FRAMEBUFFER_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
...
inline void GlesSpy::glGenQueries(int32_t count, QueryId* queries) {
    ...
    mEncoder->Uint16(179);  // Type ID -- TODO: mEncoder->Id(GL_GEN_QUERIES_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
...
inline void GlesSpy::glBeginQuery(uint32_t target, QueryId query) {
    ...
    mEncoder->Uint16(180);  // Type ID -- TODO: mEncoder->Id(GL_BEGIN_QUERY_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
...
inline void GlesSpy::glEndQuery(uint32_t target) {
    ...
    mEncoder->Uint16(181);  // Type ID -- TODO: mEncoder->Id(GL_END_QUERY_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
}
...
inline void GlesSpy::glDeleteQueries(int32_t count, const QueryId* queries) {
    ...
    mEncoder->Uint16(182);  // Type ID -- TODO: mEncoder->Id(GL_DELETE_QUERIES_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
    if (queries != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = count;
...
inline bool GlesSpy::glIsQuery(QueryId query) {
    ...
    mEncoder->Uint16(183);  // Type ID -- TODO: mEncoder->Id(GL_IS_QUERY_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(query);
    mEncoder->Bool(result);
...
inline void GlesSpy::glGetQueryiv(uint32_t target, uint32_t parameter, int32_t* value) {
    ...
    mEncoder->Uint16(184);  // Type ID -- TODO: mEncoder->Id(GL_GET_QUERYIV_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    mEncoder->Int32(value ? (*value) : int32_t{});
...
inline void GlesSpy::glGetQueryObjectuiv(QueryId query, uint32_t parameter, uint32_t* value) {
    ...
    mEncoder->Uint16(185);  // Type ID -- TODO: mEncoder->Id(GL_GET_QUERY_OBJECTUIV_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(query);
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    mEncoder->Uint32(value ? (*value) : uint32_t{});
}
...
inline void GlesSpy::glGenQueriesEXT(int32_t count, QueryId* queries) {
    ...
    mEncoder->Uint16(186);  // Type ID -- TODO: mEncoder->Id(GL_GEN_QUERIES_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
    if (queries != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = count;
...
inline void GlesSpy::glBeginQueryEXT(uint32_t target, QueryId query) {
    ...
    mEncoder->Uint16(187);  // Type ID -- TODO: mEncoder->Id(GL_BEGIN_QUERY_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(query);
}
...
inline void GlesSpy::glEndQueryEXT(uint32_t target) {
    ...
    mEncoder->Uint16(188);  // Type ID -- TODO: mEncoder->Id(GL_END_QUERY_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
}
...
inline void GlesSpy::glDeleteQueriesEXT(int32_t count, const QueryId* queries) {
    ...
    mEncoder->Uint16(189);  // Type ID -- TODO: mEncoder->Id(GL_DELETE_QUERIES_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Int32(count);
    if (queries != nullptr) {  // TODO: This check should not be necessary!
        int32_t count_ = count;
...
inline bool GlesSpy::glIsQueryEXT(QueryId query) {
    ...
    mEncoder->Uint16(190);  // Type ID -- TODO: mEncoder->Id(GL_IS_QUERY_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(query);
    mEncoder->Bool(result);
...
inline void GlesSpy::glQueryCounterEXT(QueryId query, uint32_t target) {
    ...
    mEncoder->Uint16(191);  // Type ID -- TODO: mEncoder->Id(GL_QUERY_COUNTER_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(query);
    mEncoder->Uint32(static_cast<uint32_t>(target));
}
...
inline void GlesSpy::glGetQueryivEXT(uint32_t target, uint32_t parameter, int32_t* value) {
    ...
    mEncoder->Uint16(192);  // Type ID -- TODO: mEncoder->Id(GL_GET_QUERYIV_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(static_cast<uint32_t>(target));
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    mEncoder->Int32(value ? (*value) : int32_t{});
...
inline void GlesSpy::glGetQueryObjectivEXT(QueryId query, uint32_t parameter, int32_t* value) {
    ...
    mEncoder->Uint16(193);  // Type ID -- TODO: mEncoder->Id(GL_GET_QUERY_OBJECTIV_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(query);
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    mEncoder->Int32(value ? (*value) : int32_t{});
...
inline void GlesSpy::glGetQueryObjectuivEXT(QueryId query, uint32_t parameter, uint32_t* value) {
    ...
    mEncoder->Uint16(194);  // Type ID -- TODO: mEncoder->Id(GL_GET_QUERY_OBJECTUIV_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(query);
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    mEncoder->Uint32(value ? (*value) : uint32_t{});
...
inline void GlesSpy::glGetQueryObjecti64vEXT(QueryId query, uint32_t parameter, int64_t* value) {
    ...
    mEncoder->Uint16(195);  // Type ID -- TODO: mEncoder->Id(GL_GET_QUERY_OBJECTI64V_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(query);
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    mEncoder->Int64(value ? (*value) : int64_t{});
}
...
inline void GlesSpy::glGetQueryObjectui64vEXT(QueryId query, uint32_t parameter, uint64_t* value) {
    ...
    mEncoder->Uint16(196);  // Type ID -- TODO: mEncoder->Id(GL_GET_QUERY_OBJECTUI64V_E_X_T_ID);
    mEncoder->Uint32(0);    // TODO: ContextID
    mEncoder->Uint32(query);
    mEncoder->Uint32(static_cast<uint32_t>(parameter));
    mEncoder->Uint64(value ? (*value) : uint64_t{});
}
