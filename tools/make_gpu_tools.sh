...
go build    -x -i -o $GPU_BUILD_ROOT/bin/embed $GPU_RELATIVE_SOURCE_PATH/tools/embed
...
go build    -x -i -o $GPU_BUILD_ROOT/bin/codergen $GPU_RELATIVE_SOURCE_PATH/binary/codergen
go generate -x       $GPU_RELATIVE_SOURCE_PATH/replay/protocol
go generate -x       $GPU_RELATIVE_SOURCE_PATH/rpc
go build    -x -i -o $GPU_BUILD_ROOT/bin/rpcapi $GPU_RELATIVE_SOURCE_PATH/rpc/rpcapi
go generate -x       $GPU_RELATIVE_SOURCE_PATH/rpc/test
go generate -x       $GPU_RELATIVE_SOURCE_PATH/service
go build    -x -i -o $GPU_BUILD_ROOT/bin/apic $GPU_RELATIVE_SOURCE_PATH/api/apic
...
go build    -x -i -o $GPU_BUILD_ROOT/bin/gazer $GPU_RELATIVE_SOURCE_PATH/server/cmd
